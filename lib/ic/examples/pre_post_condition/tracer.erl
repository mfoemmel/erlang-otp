...
%% 
%% Description:
%%    This file contains an example of pre and post conditions for the corba backend.
%%
...
pre(M, F, [State, I]) when integer(I) ->
    ...
    ok;
pre(M, F, A) -> %% Just an silly example to get an exception case
