...
%% returns type code
tc() -> {tk_struct,"IDL:mnesia/CheckpointDef:1.0",
                   "CheckpointDef",
                   [{"cpName",{tk_string,0}},
...
%% returns id
id() -> "IDL:mnesia/CheckpointDef:1.0".

%% returns name
name() -> "mnesia_CheckpointDef".
