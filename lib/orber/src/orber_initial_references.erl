...
%% Temporary definition. Remove when we don't want to support the old versions
%% of stubs/skeletons generated by IC.
-ic_compiled("4_2").
...
%% This case is simply a work-around. When we choose to no longer support
%% the old style of stubs/skeletons generated by IC this must be deleted.
