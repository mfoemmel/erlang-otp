...
oe_register() ->
    ...
    orber_ifr:'InterfaceDef_create_operation'(_OE_3, "IDL:StackModule/StackFactory/destroy_stack:1.0", "destroy_stack", "1.0", orber_ifr:'Repository_create_idltype'(OE_IFR, tk_void), 'OP_NORMAL', [#parameterdescription{name="s", type={tk_objref,
                                      "IDL:StackModule/Stack:1.0",
