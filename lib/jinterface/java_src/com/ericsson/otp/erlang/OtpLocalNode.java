...
public class OtpLocalNode extends AbstractNode {
  ...
  /**
   * Create an Erlang {@link OtpErlangPid pid}. Erlang pids are based
  ...
  /**
   * Create an Erlang {@link OtpErlangPort port}. Erlang ports are
  ...
  /**
   * Create an Erlang {@link OtpErlangRef reference}. Erlang
