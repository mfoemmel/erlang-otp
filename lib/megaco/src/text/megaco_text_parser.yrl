...
contextAuditProperties -> 'COMMA' contextAuditProperty contextAuditProperties  : ['$2' | '$3'] .
...
actionReply          -> 'CtxToken' 'EQUAL' contextID 'LBRKT' actionReplyBody 'RBRKT'
			    : setelement(#'ActionReply'.contextId, '$5', '$3') .

actionReplyBody      -> errorDescriptor               :  #'ActionReply'{errorDescriptor = '$1'} .
actionReplyBody      -> commandReply commandReplyList : merge_action_reply(['$1' | '$2']) .
...
commandReplyList     -> 'COMMA' commandReply commandReplyList  : ['$2' | '$3'] .
...
auditOther              -> terminationID 
			       : {auditResult, #'AuditResult'{terminationID          = '$1',
...
auditReturnParameter -> auditItem                 : {auditItem, '$1'} .
...
auditItem            -> 'MuxToken'            : muxToken .
auditItem            -> 'ModemToken'          : modemToken .
auditItem            -> 'MediaToken'          : mediaToken .
auditItem            -> 'SignalsToken'        : signalsToken.
auditItem            -> 'EventBufferToken'    : eventBufferToken.
auditItem            -> 'DigitMapToken'       : digitMapToken .
auditItem            -> 'StatsToken'          : statsToken .
auditItem            -> 'EventsToken'         : eventsToken .
auditItem            -> 'ObservedEventsToken' : observedEventsToken .
auditItem            -> 'PackagesToken'       : packagesToken .
...
domainAddress        -> 'LSBRKT' safeToken 'RSBRKT' 'COLON' portNumber optSep
                               : ensure_domainAddress('$2', '$5') .
domainAddress        -> 'LSBRKT' safeToken 'RSBRKT'
...
eventParameters      -> 'COMMA' eventParameter eventParameters : ['$2' | '$3'] .
...
modemDescriptor      -> 'ModemToken' 'EQUAL' modemType optParmValues
			    :  #'ModemDescriptor'{mtl = ['$3'],
						  mpl = '$4'} .

%% at-most-once of each modem type exept for extensionParameter
modemDescriptor      -> 'ModemToken' 'LSBRKT' modemType modemTypeList 'RSBRKT' optParmValues
...
optParmValues 	     -> 'LBRKT' propertyParm parmValues 'RBRKT' : ['$2' | '$3'] .
optParmValues 	     -> '$empty' : [] .
       
parmValues    	     -> 'COMMA' propertyParm parmValues :  ['$2' | '$3'] .
parmValues    	     -> '$empty' : [] .
...
serviceChangeReplyDescriptor -> 'ServicesToken'
                                'LBRKT' servChgReplyParm servChgReplyParms 'RBRKT'
                                    : merge_ServiceChangeResParm('$3', '$4') .

servChgReplyParms    -> 'COMMA' servChgReplyParm servChgReplyParms
                            : merge_ServiceChangeResParm('$2', '$3') .
servChgReplyParms    -> '$empty' :  #'ServiceChangeResParm'{} .
...
timeStamp            -> safeToken : ensure_timeStamp('$1') .
...
-include("megaco_text_parser.hrl").
