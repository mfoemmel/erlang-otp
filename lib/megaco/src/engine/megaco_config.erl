...
conn_info(CH, Item) 
  when is_record(CH, megaco_conn_handle) and (Item /= cancel) ->
    case Item of
        conn_handle ->
            CH;
        mid ->
...
incr_trans_id_counter(ConnHandle, Incr) when is_integer(Incr) and (Incr > 0) ->
