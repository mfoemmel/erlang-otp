...
%% attribute number 1 with type Externaltypereference927megaco_per_bin_drv_media_gateway_control_prev3aMId
'enc_MId'(Tmpval1)
end,
case element(3,Val1) of
asn1_NOVALUE -> [];
...
%% attribute number 2 with type Externaltypereference928megaco_per_bin_drv_media_gateway_control_prev3aServiceChangeAddress
...
%% attribute number 10 with type Externaltypereference910megaco_per_bin_drv_media_gateway_control_prev3aAuditDescriptor
...
%% attribute number 2 with type Externaltypereference755megaco_per_bin_drv_media_gateway_control_prev3aEventDM
'enc_EventDM'(Tmpval2)
end,
case element(4,Val1) of
asn1_NOVALUE -> [];
...
%% attribute number 2 with type Externaltypereference401megaco_per_bin_drv_media_gateway_control_prev3aIndAudPropertyGroup
...
%% attribute number 1 with type Externaltypereference376megaco_per_bin_drv_media_gateway_control_prev3aIndAudLocalControlDescriptor
...
%% attribute number 2 with type Externaltypereference377megaco_per_bin_drv_media_gateway_control_prev3aIndAudLocalRemoteDescriptor
...
%% attribute number 4 with type Externaltypereference380megaco_per_bin_drv_media_gateway_control_prev3aIndAudStatisticsDescriptor
...
%% attribute number 1 with type Externaltypereference359megaco_per_bin_drv_media_gateway_control_prev3aIndAudTerminationStateDescriptor
