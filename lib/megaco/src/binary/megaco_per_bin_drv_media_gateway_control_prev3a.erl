...
%% attribute number 1 with type Externaltypereference966megaco_per_bin_drv_media_gateway_control_prev3aNonStandardIdentifier
...
%% attribute number 2 with type Externaltypereference961megaco_per_bin_drv_media_gateway_control_prev3aValue
'enc_Value'(Tmpval2)
end].
...
%% attribute number 1 with type Externaltypereference922megaco_per_bin_drv_media_gateway_control_prev3aMId
'enc_MId'(Tmpval1)
end,
case element(3,Val1) of
asn1_NOVALUE -> [];
...
%% attribute number 2 with type Externaltypereference923megaco_per_bin_drv_media_gateway_control_prev3aServiceChangeAddress
...
%% attribute number 4 with type Externaltypereference925megaco_per_bin_drv_media_gateway_control_prev3aServiceChangeProfile
...
%% attribute number 5 with type Externaltypereference926megaco_per_bin_drv_media_gateway_control_prev3aTimeNotation
...
%% attribute number 2 with type Externaltypereference885megaco_per_bin_drv_media_gateway_control_prev3aServiceChangeAddress
...
%% attribute number 4 with type Externaltypereference887megaco_per_bin_drv_media_gateway_control_prev3aServiceChangeProfile
'enc_ServiceChangeProfile'(Tmpval4)
end,

%% attribute number 5 with type Externaltypereference888megaco_per_bin_drv_media_gateway_control_prev3aValue
...
%% attribute number 7 with type Externaltypereference901megaco_per_bin_drv_media_gateway_control_prev3aMId
'enc_MId'(Tmpval6)
end,
...
%% attribute number 8 with type Externaltypereference902megaco_per_bin_drv_media_gateway_control_prev3aTimeNotation
...
%% attribute number 9 with type Externaltypereference903megaco_per_bin_drv_media_gateway_control_prev3aNonStandardData
...
%% attribute number 10 with type Externaltypereference905megaco_per_bin_drv_media_gateway_control_prev3aAuditDescriptor
...
%% attribute number 2 with type Externaltypereference862megaco_per_bin_drv_media_gateway_control_prev3aDigitMapValue
...
%% attribute number 3 with type Externaltypereference842megaco_per_bin_drv_media_gateway_control_prev3aNonStandardData
...
%% attribute number 2 with type Externaltypereference822megaco_per_bin_drv_media_gateway_control_prev3aValue
...
%% attribute number 2 with type Externaltypereference750megaco_per_bin_drv_media_gateway_control_prev3aEventDM
'enc_EventDM'(Tmpval2)
end,
case element(4,Val1) of
asn1_NOVALUE -> [];
...
%% attribute number 3 with type Externaltypereference751megaco_per_bin_drv_media_gateway_control_prev3aSignalsDescriptor
...
%% attribute number 3 with type Externaltypereference742megaco_per_bin_drv_media_gateway_control_prev3aSecondRequestedActions
...
%% attribute number 2 with type Externaltypereference719megaco_per_bin_drv_media_gateway_control_prev3aEventDM
'enc_EventDM'(Tmpval2)
end,
case element(4,Val1) of
asn1_NOVALUE -> [];
...
%% attribute number 3 with type Externaltypereference720megaco_per_bin_drv_media_gateway_control_prev3aSecondEventsDescriptor
...
%% attribute number 4 with type Externaltypereference721megaco_per_bin_drv_media_gateway_control_prev3aSignalsDescriptor
...
%% attribute number 3 with type Externaltypereference711megaco_per_bin_drv_media_gateway_control_prev3aRequestedActions
...
%% attribute number 3 with type Externaltypereference682megaco_per_bin_drv_media_gateway_control_prev3aNonStandardData
'enc_NonStandardData'(Tmpval1)
end].
...
%% attribute number 1 with type Externaltypereference564megaco_per_bin_drv_media_gateway_control_prev3aLocalControlDescriptor
...
%% attribute number 2 with type Externaltypereference565megaco_per_bin_drv_media_gateway_control_prev3aLocalRemoteDescriptor
...
%% attribute number 3 with type Externaltypereference566megaco_per_bin_drv_media_gateway_control_prev3aLocalRemoteDescriptor
...
%% attribute number 4 with type Externaltypereference568megaco_per_bin_drv_media_gateway_control_prev3aStatisticsDescriptor
...
%% attribute number 2 with type Externaltypereference559megaco_per_bin_drv_media_gateway_control_prev3aStreamParms
...
%% attribute number 1 with type Externaltypereference547megaco_per_bin_drv_media_gateway_control_prev3aTerminationStateDescriptor
...
[
?RT_PER:setext(false), 
%% attribute number 1 with type Externaltypereference518megaco_per_bin_drv_media_gateway_control_prev3aTerminationIDList
'enc_TerminationIDList'(element(2,Val1)),

%% attribute number 2 with type Externaltypereference519megaco_per_bin_drv_media_gateway_control_prev3aServiceChangeResult
...
[
?RT_PER:setext(false), 
%% attribute number 1 with type Externaltypereference511megaco_per_bin_drv_media_gateway_control_prev3aTerminationIDList
'enc_TerminationIDList'(element(2,Val1)),

%% attribute number 2 with type Externaltypereference512megaco_per_bin_drv_media_gateway_control_prev3aServiceChangeParm
...
%% attribute number 2 with type Externaltypereference497megaco_per_bin_drv_media_gateway_control_prev3aValue
'enc_Value'(element(3,Val1)),
case element(4,Val1) of
asn1_NOVALUE -> [];
Tmpval3 ->
...
%% attribute number 4 with type Externaltypereference488megaco_per_bin_drv_media_gateway_control_prev3aTimeNotation
...
%% attribute number 1 with type Externaltypereference472megaco_per_bin_drv_media_gateway_control_prev3aTerminationIDList
'enc_TerminationIDList'(element(2,Val1)),
case element(3,Val1) of
asn1_NOVALUE -> [];
Tmpval1 ->

%% attribute number 2 with type Externaltypereference473megaco_per_bin_drv_media_gateway_control_prev3aErrorDescriptor
...
%% attribute number 1 with type Externaltypereference464megaco_per_bin_drv_media_gateway_control_prev3aTerminationIDList
'enc_TerminationIDList'(element(2,Val1)),

%% attribute number 2 with type Externaltypereference465megaco_per_bin_drv_media_gateway_control_prev3aObservedEventsDescriptor
'enc_ObservedEventsDescriptor'(element(3,Val1)),
case element(4,Val1) of
asn1_NOVALUE -> [];
Tmpval1 ->

%% attribute number 3 with type Externaltypereference466megaco_per_bin_drv_media_gateway_control_prev3aErrorDescriptor
'enc_ErrorDescriptor'(Tmpval1)
end].
...
%% attribute number 2 with type Externaltypereference435megaco_per_bin_drv_media_gateway_control_prev3aIndAudSignal
...
%% attribute number 2 with type Externaltypereference396megaco_per_bin_drv_media_gateway_control_prev3aIndAudPropertyGroup
...
%% attribute number 1 with type Externaltypereference371megaco_per_bin_drv_media_gateway_control_prev3aIndAudLocalControlDescriptor
...
%% attribute number 2 with type Externaltypereference372megaco_per_bin_drv_media_gateway_control_prev3aIndAudLocalRemoteDescriptor
...
%% attribute number 3 with type Externaltypereference373megaco_per_bin_drv_media_gateway_control_prev3aIndAudLocalRemoteDescriptor
...
%% attribute number 4 with type Externaltypereference375megaco_per_bin_drv_media_gateway_control_prev3aIndAudStatisticsDescriptor
...
%% attribute number 2 with type Externaltypereference366megaco_per_bin_drv_media_gateway_control_prev3aIndAudStreamParms
...
%% attribute number 1 with type Externaltypereference354megaco_per_bin_drv_media_gateway_control_prev3aIndAudTerminationStateDescriptor
...
%% attribute number 1 with type Externaltypereference297megaco_per_bin_drv_media_gateway_control_prev3aTerminationID
'enc_TerminationID'(element(2,Val1)),

%% attribute number 2 with type Externaltypereference298megaco_per_bin_drv_media_gateway_control_prev3aTerminationAudit
...
[
?RT_PER:setext(false), 
%% attribute number 1 with type Externaltypereference281megaco_per_bin_drv_media_gateway_control_prev3aTerminationID
'enc_TerminationID'(element(2,Val1)),

%% attribute number 2 with type Externaltypereference282megaco_per_bin_drv_media_gateway_control_prev3aAuditDescriptor
...
%% attribute number 1 with type Externaltypereference274megaco_per_bin_drv_media_gateway_control_prev3aTerminationIDList
'enc_TerminationIDList'(element(2,Val1)),
case element(3,Val1) of
asn1_NOVALUE -> [];
Tmpval1 ->

%% attribute number 2 with type Externaltypereference275megaco_per_bin_drv_media_gateway_control_prev3aAuditDescriptor
...
%% attribute number 1 with type Externaltypereference267megaco_per_bin_drv_media_gateway_control_prev3aTerminationIDList
'enc_TerminationIDList'(element(2,Val1)),
case element(3,Val1) of
asn1_NOVALUE -> [];
Tmpval1 ->

%% attribute number 2 with type Externaltypereference268megaco_per_bin_drv_media_gateway_control_prev3aTerminationAudit
...
[
?RT_PER:setext(false), 
%% attribute number 1 with type Externaltypereference243megaco_per_bin_drv_media_gateway_control_prev3aTerminationIDList
'enc_TerminationIDList'(element(2,Val1)),
...
%% attribute number 1 with type Externaltypereference229megaco_per_bin_drv_media_gateway_control_prev3aTerminationID
'enc_TerminationID'(element(2,Val1)),

%% attribute number 2 with type Externaltypereference230megaco_per_bin_drv_media_gateway_control_prev3aTerminationID
...
%% attribute number 1 with type Externaltypereference193megaco_per_bin_drv_media_gateway_control_prev3aCommand
...
%% attribute number 2 with type Externaltypereference166megaco_per_bin_drv_media_gateway_control_prev3aErrorDescriptor
'enc_ErrorDescriptor'(Tmpval1)
end,
case element(4,Val1) of
asn1_NOVALUE -> [];
...
%% attribute number 3 with type Externaltypereference167megaco_per_bin_drv_media_gateway_control_prev3aContextRequest
...
%% attribute number 2 with type Externaltypereference158megaco_per_bin_drv_media_gateway_control_prev3aContextRequest
...
%% attribute number 3 with type Externaltypereference159megaco_per_bin_drv_media_gateway_control_prev3aContextAttrAuditRequest
