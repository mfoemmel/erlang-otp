...
%% attribute number 1 with type Externaltypereference900megaco_per_bin_drv_media_gateway_control_v1MId
'enc_MId'(Tmpval1)
end,
case element(3,Val1) of
asn1_NOVALUE -> [];
...
%% attribute number 2 with type Externaltypereference901megaco_per_bin_drv_media_gateway_control_v1ServiceChangeAddress
...
%% attribute number 2 with type Externaltypereference756megaco_per_bin_drv_media_gateway_control_v1EventDM
'enc_EventDM'(Tmpval2)
end,
case element(4,Val1) of
asn1_NOVALUE -> [];
