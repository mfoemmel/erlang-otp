%% Generated by the Erlang ASN.1 BER-compiler version, utilizing bit-syntax:1.4.5
...
%% attribute number 1 with type Externaltypereference1038megaco_per_bin_drv_media_gateway_control_prev3cNonStandardIdentifier
...
%% attribute number 2 with type Externaltypereference1030megaco_per_bin_drv_media_gateway_control_prev3cValue
'enc_Value'(Tmpval2)
end].
...
'failover' -> [0,?RT_PER:encode_integer([{'ValueRange',{0,5}}], 0)];
'forced' -> [0,?RT_PER:encode_integer([{'ValueRange',{0,5}}], 1)];
'graceful' -> [0,?RT_PER:encode_integer([{'ValueRange',{0,5}}], 2)];
'restart' -> [0,?RT_PER:encode_integer([{'ValueRange',{0,5}}], 3)];
'disconnected' -> [0,?RT_PER:encode_integer([{'ValueRange',{0,5}}], 4)];
'handOff' -> [0,?RT_PER:encode_integer([{'ValueRange',{0,5}}], 5)];
{asn1_enum,EnumV} when integer(EnumV), EnumV > 5 -> [1,?RT_PER:encode_small_number(EnumV)];
...
%% attribute number 1 with type Externaltypereference990megaco_per_bin_drv_media_gateway_control_prev3cMId
'enc_MId'(Tmpval1)
end,
case element(3,Val1) of
asn1_NOVALUE -> [];
...
%% attribute number 2 with type Externaltypereference991megaco_per_bin_drv_media_gateway_control_prev3cServiceChangeAddress
...
%% attribute number 4 with type Externaltypereference993megaco_per_bin_drv_media_gateway_control_prev3cServiceChangeProfile
...
%% attribute number 5 with type Externaltypereference994megaco_per_bin_drv_media_gateway_control_prev3cTimeNotation
...
case (case element(2,Val1) of {_,_}->element(2,element(2,Val1));_->element(2,Val1) end) of
'failover' -> [0,?RT_PER:encode_integer([{'ValueRange',{0,5}}], 0)];
'forced' -> [0,?RT_PER:encode_integer([{'ValueRange',{0,5}}], 1)];
'graceful' -> [0,?RT_PER:encode_integer([{'ValueRange',{0,5}}], 2)];
'restart' -> [0,?RT_PER:encode_integer([{'ValueRange',{0,5}}], 3)];
...
%% attribute number 2 with type Externaltypereference953megaco_per_bin_drv_media_gateway_control_prev3cServiceChangeAddress
...
%% attribute number 4 with type Externaltypereference955megaco_per_bin_drv_media_gateway_control_prev3cServiceChangeProfile
'enc_ServiceChangeProfile'(Tmpval4)
end,

%% attribute number 5 with type Externaltypereference956megaco_per_bin_drv_media_gateway_control_prev3cValue
...
%% attribute number 7 with type Externaltypereference969megaco_per_bin_drv_media_gateway_control_prev3cMId
'enc_MId'(Tmpval6)
end,
...
%% attribute number 8 with type Externaltypereference970megaco_per_bin_drv_media_gateway_control_prev3cTimeNotation
...
%% attribute number 9 with type Externaltypereference971megaco_per_bin_drv_media_gateway_control_prev3cNonStandardData
...
%% attribute number 10 with type Externaltypereference973megaco_per_bin_drv_media_gateway_control_prev3cAuditDescriptor
...
_Opt4 when _Opt4 > 0 ->?RT_PER:decode_constrained_number(Bytes7,{0,4294967295},4294967296);
...
%% attribute number 2 with type Externaltypereference930megaco_per_bin_drv_media_gateway_control_prev3cDigitMapValue
...
%% attribute number 3 with type Externaltypereference910megaco_per_bin_drv_media_gateway_control_prev3cNonStandardData
...
%% attribute number 2 with type Externaltypereference891megaco_per_bin_drv_media_gateway_control_prev3cValue
...
_Opt4 when _Opt4 > 0 ->?RT_PER:decode_bit_string(Bytes6,[],[{onTimeOut,0},{onInterruptByEvent,1},{onInterruptByNewSignalDescr,2},{otherReason,3},{onIteration,4}]);
0 ->{asn1_NOVALUE,Bytes6}
...
%% attribute number 2 with type Externaltypereference816megaco_per_bin_drv_media_gateway_control_prev3cEventDM
'enc_EventDM'(Tmpval2)
end,
case element(4,Val1) of
asn1_NOVALUE -> [];
...
%% attribute number 3 with type Externaltypereference817megaco_per_bin_drv_media_gateway_control_prev3cSignalsDescriptor
...
%% attribute number 4 with type Externaltypereference819megaco_per_bin_drv_media_gateway_control_prev3cNotifyBehaviour
...
%% attribute number 3 with type Externaltypereference808megaco_per_bin_drv_media_gateway_control_prev3cSecondRequestedActions
...
%% attribute number 2 with type Externaltypereference783megaco_per_bin_drv_media_gateway_control_prev3cEventDM
'enc_EventDM'(Tmpval2)
end,
case element(4,Val1) of
asn1_NOVALUE -> [];
...
%% attribute number 3 with type Externaltypereference784megaco_per_bin_drv_media_gateway_control_prev3cSecondEventsDescriptor
...
%% attribute number 4 with type Externaltypereference785megaco_per_bin_drv_media_gateway_control_prev3cSignalsDescriptor
...
%% attribute number 5 with type Externaltypereference787megaco_per_bin_drv_media_gateway_control_prev3cNotifyBehaviour
...
%% attribute number 1 with type Externaltypereference767megaco_per_bin_drv_media_gateway_control_prev3cSecondEventsDescriptor
...
%% attribute number 2 with type Externaltypereference768megaco_per_bin_drv_media_gateway_control_prev3cSignalsDescriptor
...
%% attribute number 3 with type Externaltypereference760megaco_per_bin_drv_media_gateway_control_prev3cRequestedActions
...
'enc_MuxType'(Val) ->
case (case Val of {_,_}->element(2,Val);_->Val end) of
'h221' -> [0,?RT_PER:encode_integer([{'ValueRange',{0,3}}], 0)];
'h223' -> [0,?RT_PER:encode_integer([{'ValueRange',{0,3}}], 1)];
'h226' -> [0,?RT_PER:encode_integer([{'ValueRange',{0,3}}], 2)];
'v76' -> [0,?RT_PER:encode_integer([{'ValueRange',{0,3}}], 3)];
'nx64k' -> [1,?RT_PER:encode_small_number(0)];
{asn1_enum,EnumV} when integer(EnumV), EnumV > 3 -> [1,?RT_PER:encode_small_number(EnumV)];
EnumVal -> exit({error,{asn1, {enumerated_not_in_range, EnumVal}}})
end.
...
%% attribute number 3 with type Externaltypereference731megaco_per_bin_drv_media_gateway_control_prev3cNonStandardData
'enc_NonStandardData'(Tmpval1)
end].
...
'enc_ServiceState'(Val) ->
case (case Val of {_,_}->element(2,Val);_->Val end) of
'test' -> [0,?RT_PER:encode_integer([{'ValueRange',{0,2}}], 0)];
'outOfSvc' -> [0,?RT_PER:encode_integer([{'ValueRange',{0,2}}], 1)];
'inSvc' -> [0,?RT_PER:encode_integer([{'ValueRange',{0,2}}], 2)];
{asn1_enum,EnumV} when integer(EnumV), EnumV > 2 -> [1,?RT_PER:encode_small_number(EnumV)];
EnumVal -> exit({error,{asn1, {enumerated_not_in_range, EnumVal}}})
end.
...
'enc_EventBufferControl'(Val) ->
case (case Val of {_,_}->element(2,Val);_->Val end) of
'off' -> [0,?RT_PER:encode_integer([{'ValueRange',{0,1}}], 0)];
'lockStep' -> [0,?RT_PER:encode_integer([{'ValueRange',{0,1}}], 1)];
{asn1_enum,EnumV} when integer(EnumV), EnumV > 1 -> [1,?RT_PER:encode_small_number(EnumV)];
EnumVal -> exit({error,{asn1, {enumerated_not_in_range, EnumVal}}})
end.
...
'enc_StreamMode'(Val) ->
case (case Val of {_,_}->element(2,Val);_->Val end) of
'sendOnly' -> [0,?RT_PER:encode_integer([{'ValueRange',{0,4}}], 0)];
'recvOnly' -> [0,?RT_PER:encode_integer([{'ValueRange',{0,4}}], 1)];
'sendRecv' -> [0,?RT_PER:encode_integer([{'ValueRange',{0,4}}], 2)];
'inactive' -> [0,?RT_PER:encode_integer([{'ValueRange',{0,4}}], 3)];
'loopBack' -> [0,?RT_PER:encode_integer([{'ValueRange',{0,4}}], 4)];
{asn1_enum,EnumV} when integer(EnumV), EnumV > 4 -> [1,?RT_PER:encode_small_number(EnumV)];
EnumVal -> exit({error,{asn1, {enumerated_not_in_range, EnumVal}}})
end.
...
%% attribute number 1 with type Externaltypereference613megaco_per_bin_drv_media_gateway_control_prev3cLocalControlDescriptor
...
%% attribute number 2 with type Externaltypereference614megaco_per_bin_drv_media_gateway_control_prev3cLocalRemoteDescriptor
...
%% attribute number 3 with type Externaltypereference615megaco_per_bin_drv_media_gateway_control_prev3cLocalRemoteDescriptor
...
%% attribute number 4 with type Externaltypereference617megaco_per_bin_drv_media_gateway_control_prev3cStatisticsDescriptor
...
%% attribute number 2 with type Externaltypereference608megaco_per_bin_drv_media_gateway_control_prev3cStreamParms
...
%% attribute number 1 with type Externaltypereference596megaco_per_bin_drv_media_gateway_control_prev3cTerminationStateDescriptor
...
[
?RT_PER:setext(false), 
%% attribute number 1 with type Externaltypereference568megaco_per_bin_drv_media_gateway_control_prev3cTerminationIDList
'enc_TerminationIDList'(element(2,Val1)),

%% attribute number 2 with type Externaltypereference569megaco_per_bin_drv_media_gateway_control_prev3cServiceChangeResult
...
[
?RT_PER:setext(false), 
%% attribute number 1 with type Externaltypereference561megaco_per_bin_drv_media_gateway_control_prev3cTerminationIDList
'enc_TerminationIDList'(element(2,Val1)),

%% attribute number 2 with type Externaltypereference562megaco_per_bin_drv_media_gateway_control_prev3cServiceChangeParm
...
%% attribute number 2 with type Externaltypereference547megaco_per_bin_drv_media_gateway_control_prev3cValue
'enc_Value'(element(3,Val1)),
case element(4,Val1) of
asn1_NOVALUE -> [];
Tmpval3 ->
...
%% attribute number 4 with type Externaltypereference538megaco_per_bin_drv_media_gateway_control_prev3cTimeNotation
...
%% attribute number 1 with type Externaltypereference522megaco_per_bin_drv_media_gateway_control_prev3cTerminationIDList
'enc_TerminationIDList'(element(2,Val1)),
case element(3,Val1) of
asn1_NOVALUE -> [];
Tmpval1 ->

%% attribute number 2 with type Externaltypereference523megaco_per_bin_drv_media_gateway_control_prev3cErrorDescriptor
...
%% attribute number 1 with type Externaltypereference514megaco_per_bin_drv_media_gateway_control_prev3cTerminationIDList
'enc_TerminationIDList'(element(2,Val1)),

%% attribute number 2 with type Externaltypereference515megaco_per_bin_drv_media_gateway_control_prev3cObservedEventsDescriptor
'enc_ObservedEventsDescriptor'(element(3,Val1)),
case element(4,Val1) of
asn1_NOVALUE -> [];
Tmpval1 ->

%% attribute number 3 with type Externaltypereference516megaco_per_bin_drv_media_gateway_control_prev3cErrorDescriptor
'enc_ErrorDescriptor'(Tmpval1)
end].
...
%% attribute number 2 with type Externaltypereference484megaco_per_bin_drv_media_gateway_control_prev3cIndAudSignal
...
?RT_PER:encode_open_type(dummy,?RT_PER:complete(case (case Tmpval3 of {_,_}->element(2,Tmpval3);_->Tmpval3 end) of
'test' -> [0,?RT_PER:encode_integer([{'ValueRange',{0,2}}], 0)];
'outOfSvc' -> [0,?RT_PER:encode_integer([{'ValueRange',{0,2}}], 1)];
'inSvc' -> [0,?RT_PER:encode_integer([{'ValueRange',{0,2}}], 2)];
{asn1_enum,EnumV} when integer(EnumV), EnumV > 2 -> [1,?RT_PER:encode_small_number(EnumV)];
...
%% attribute number 2 with type Externaltypereference442megaco_per_bin_drv_media_gateway_control_prev3cIndAudPropertyGroup
...
%% attribute number 2 with type Externaltypereference434megaco_per_bin_drv_media_gateway_control_prev3cPropertyParm
...
?RT_PER:encode_open_type(dummy,?RT_PER:complete(case (case Tmpval5 of {_,_}->element(2,Tmpval5);_->Tmpval5 end) of
'sendOnly' -> [0,?RT_PER:encode_integer([{'ValueRange',{0,4}}], 0)];
'recvOnly' -> [0,?RT_PER:encode_integer([{'ValueRange',{0,4}}], 1)];
'sendRecv' -> [0,?RT_PER:encode_integer([{'ValueRange',{0,4}}], 2)];
'inactive' -> [0,?RT_PER:encode_integer([{'ValueRange',{0,4}}], 3)];
...
%% attribute number 1 with type Externaltypereference411megaco_per_bin_drv_media_gateway_control_prev3cIndAudLocalControlDescriptor
...
%% attribute number 2 with type Externaltypereference412megaco_per_bin_drv_media_gateway_control_prev3cIndAudLocalRemoteDescriptor
...
%% attribute number 3 with type Externaltypereference413megaco_per_bin_drv_media_gateway_control_prev3cIndAudLocalRemoteDescriptor
...
%% attribute number 4 with type Externaltypereference415megaco_per_bin_drv_media_gateway_control_prev3cIndAudStatisticsDescriptor
...
%% attribute number 2 with type Externaltypereference406megaco_per_bin_drv_media_gateway_control_prev3cIndAudStreamParms
...
%% attribute number 1 with type Externaltypereference394megaco_per_bin_drv_media_gateway_control_prev3cIndAudTerminationStateDescriptor
...
[
?RT_PER:setext(false), 
%% attribute number 1 with type Externaltypereference338megaco_per_bin_drv_media_gateway_control_prev3cTerminationIDList
'enc_TerminationIDList'(element(2,Val1)),

%% attribute number 2 with type Externaltypereference339megaco_per_bin_drv_media_gateway_control_prev3cTerminationAudit
...
%% attribute number 1 with type Externaltypereference332megaco_per_bin_drv_media_gateway_control_prev3cTerminationID
'enc_TerminationID'(element(2,Val1)),

%% attribute number 2 with type Externaltypereference333megaco_per_bin_drv_media_gateway_control_prev3cTerminationAudit
'enc_TerminationAudit'(element(3,Val1))].
...
[
?RT_PER:setext(Extensions =/= []), 
%% attribute number 1 with type Externaltypereference312megaco_per_bin_drv_media_gateway_control_prev3cTerminationID
'enc_TerminationID'(element(2,Val1)),

%% attribute number 2 with type Externaltypereference313megaco_per_bin_drv_media_gateway_control_prev3cAuditDescriptor
...
%% attribute number 3 with type Externaltypereference315megaco_per_bin_drv_media_gateway_control_prev3cTerminationIDList
...
%% attribute number 1 with type Externaltypereference305megaco_per_bin_drv_media_gateway_control_prev3cTerminationIDList
'enc_TerminationIDList'(element(2,Val1)),
case element(3,Val1) of
asn1_NOVALUE -> [];
Tmpval1 ->

%% attribute number 2 with type Externaltypereference306megaco_per_bin_drv_media_gateway_control_prev3cAuditDescriptor
...
%% attribute number 1 with type Externaltypereference298megaco_per_bin_drv_media_gateway_control_prev3cTerminationIDList
'enc_TerminationIDList'(element(2,Val1)),
case element(3,Val1) of
asn1_NOVALUE -> [];
Tmpval1 ->

%% attribute number 2 with type Externaltypereference299megaco_per_bin_drv_media_gateway_control_prev3cTerminationAudit
...
[
?RT_PER:setext(false), 
%% attribute number 1 with type Externaltypereference274megaco_per_bin_drv_media_gateway_control_prev3cTerminationIDList
'enc_TerminationIDList'(element(2,Val1)),
...
[
?RT_PER:setext(Extensions =/= []), 
%% attribute number 1 with type Externaltypereference251megaco_per_bin_drv_media_gateway_control_prev3cTerminationID
'enc_TerminationID'(element(2,Val1)),

%% attribute number 2 with type Externaltypereference252megaco_per_bin_drv_media_gateway_control_prev3cTerminationID
...
%% attribute number 5 with type ENUMERATED
?RT_PER:encode_open_type(dummy,?RT_PER:complete(case (case Tmpval6 of {_,_}->element(2,Tmpval6);_->Tmpval6 end) of
'onewayexternal' -> [0,?RT_PER:encode_integer([{'ValueRange',{0,1}}], 0)];
'onewayboth' -> [0,?RT_PER:encode_integer([{'ValueRange',{0,1}}], 1)];
{asn1_enum,EnumV} when integer(EnumV), EnumV > 1 -> [1,?RT_PER:encode_small_number(EnumV)];
EnumVal -> exit({error,{asn1, {enumerated_not_in_range, EnumVal}}})
end))
end].
...
%% attribute number 1 with type Externaltypereference215megaco_per_bin_drv_media_gateway_control_prev3cCommand
...
%% attribute number 9 with type Externaltypereference202megaco_per_bin_drv_media_gateway_control_prev3cSelectLogic
...
%% attribute number 2 with type Externaltypereference166megaco_per_bin_drv_media_gateway_control_prev3cErrorDescriptor
'enc_ErrorDescriptor'(Tmpval1)
end,
case element(4,Val1) of
asn1_NOVALUE -> [];
...
%% attribute number 3 with type Externaltypereference167megaco_per_bin_drv_media_gateway_control_prev3cContextRequest
...
%% attribute number 2 with type Externaltypereference158megaco_per_bin_drv_media_gateway_control_prev3cContextRequest
...
%% attribute number 3 with type Externaltypereference159megaco_per_bin_drv_media_gateway_control_prev3cContextAttrAuditRequest
...
%% attribute number 2 with type IA5String
{Term2,Bytes3} = case Opt band (1 bsl 0) of
_Opt1 when _Opt1 > 0 ->?RT_PER:decode_known_multiplier_string('IA5String',no,8,{0,127,notab},Bytes2);
0 ->{asn1_NOVALUE,Bytes2}
