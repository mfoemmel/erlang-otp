...
%%     AsnMod   = ?V1_ASN1_MOD, 
%%     TransMod = ?V1_TRANS_MOD,
%%     megaco_binary_encoder:encode_action_request(EC, ActReqs,
%% 						AsnMod, TransMod, 
%% 						io_list);
...
version_of([] = EC, Binary) ->
    ...
    megaco_binary_encoder:version_of(EC, Binary, dynamic, 
				     AsnModV1, AsnModV2);
...
decode_message([] = EC, dynamic, Binary) ->
    AsnModV1 = ?V1_ASN1_MOD, 
    AsnModV2 = ?V2_ASN1_MOD, 
    megaco_binary_encoder:decode_message_dynamic(EC, Binary, 
