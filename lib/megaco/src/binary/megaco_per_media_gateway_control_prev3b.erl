...
%% attribute number 1 with type Externaltypereference966megaco_per_media_gateway_control_prev3bNonStandardIdentifier
...
%% attribute number 2 with type Externaltypereference961megaco_per_media_gateway_control_prev3bValue
'enc_Value'(Tmpval1)
end].
...
%% attribute number 1 with type Externaltypereference922megaco_per_media_gateway_control_prev3bMId
'enc_MId'(Tmpval1)
end,
...
%% attribute number 2 with type Externaltypereference923megaco_per_media_gateway_control_prev3bServiceChangeAddress
...
%% attribute number 4 with type Externaltypereference925megaco_per_media_gateway_control_prev3bServiceChangeProfile
...
%% attribute number 5 with type Externaltypereference926megaco_per_media_gateway_control_prev3bTimeNotation
...
%% attribute number 2 with type Externaltypereference885megaco_per_media_gateway_control_prev3bServiceChangeAddress
...
%% attribute number 4 with type Externaltypereference887megaco_per_media_gateway_control_prev3bServiceChangeProfile
'enc_ServiceChangeProfile'(Tmpval3)
end,

%% attribute number 5 with type Externaltypereference888megaco_per_media_gateway_control_prev3bValue
...
%% attribute number 7 with type Externaltypereference901megaco_per_media_gateway_control_prev3bMId
'enc_MId'(Tmpval5)
end,
...
%% attribute number 8 with type Externaltypereference902megaco_per_media_gateway_control_prev3bTimeNotation
...
%% attribute number 2 with type Externaltypereference822megaco_per_media_gateway_control_prev3bValue
...
%% attribute number 2 with type Externaltypereference750megaco_per_media_gateway_control_prev3bEventDM
'enc_EventDM'(Tmpval2)
end,
...
%% attribute number 3 with type Externaltypereference751megaco_per_media_gateway_control_prev3bSignalsDescriptor
...
%% attribute number 3 with type Externaltypereference742megaco_per_media_gateway_control_prev3bSecondRequestedActions
...
%% attribute number 2 with type Externaltypereference719megaco_per_media_gateway_control_prev3bEventDM
'enc_EventDM'(Tmpval2)
end,
...
%% attribute number 3 with type Externaltypereference720megaco_per_media_gateway_control_prev3bSecondEventsDescriptor
...
%% attribute number 4 with type Externaltypereference721megaco_per_media_gateway_control_prev3bSignalsDescriptor
...
%% attribute number 3 with type Externaltypereference711megaco_per_media_gateway_control_prev3bRequestedActions
...
%% attribute number 3 with type Externaltypereference682megaco_per_media_gateway_control_prev3bNonStandardData
'enc_NonStandardData'(Tmpval1)
end].
...
%% attribute number 1 with type Externaltypereference564megaco_per_media_gateway_control_prev3bLocalControlDescriptor
...
%% attribute number 2 with type Externaltypereference565megaco_per_media_gateway_control_prev3bLocalRemoteDescriptor
...
%% attribute number 3 with type Externaltypereference566megaco_per_media_gateway_control_prev3bLocalRemoteDescriptor
...
%% attribute number 4 with type Externaltypereference568megaco_per_media_gateway_control_prev3bStatisticsDescriptor
...
%% attribute number 2 with type Externaltypereference559megaco_per_media_gateway_control_prev3bStreamParms
...
%% attribute number 1 with type Externaltypereference547megaco_per_media_gateway_control_prev3bTerminationStateDescriptor
...
[
?RT_PER:setext(false), 
%% attribute number 1 with type Externaltypereference518megaco_per_media_gateway_control_prev3bTerminationIDList
'enc_TerminationIDList'(?RT_PER:cindex(2,Val1,terminationID)),

%% attribute number 2 with type Externaltypereference519megaco_per_media_gateway_control_prev3bServiceChangeResult
...
[
?RT_PER:setext(false), 
%% attribute number 1 with type Externaltypereference511megaco_per_media_gateway_control_prev3bTerminationIDList
'enc_TerminationIDList'(?RT_PER:cindex(2,Val1,terminationID)),

%% attribute number 2 with type Externaltypereference512megaco_per_media_gateway_control_prev3bServiceChangeParm
...
%% attribute number 2 with type Externaltypereference497megaco_per_media_gateway_control_prev3bValue
'enc_Value'(?RT_PER:cindex(3,Val1,value)),
case ?RT_PER:cindex(4,Val1,extraInfo) of
asn1_NOVALUE -> [];
Tmpval1 ->
...
%% attribute number 4 with type Externaltypereference488megaco_per_media_gateway_control_prev3bTimeNotation
...
%% attribute number 1 with type Externaltypereference472megaco_per_media_gateway_control_prev3bTerminationIDList
'enc_TerminationIDList'(?RT_PER:cindex(2,Val1,terminationID)),
case ?RT_PER:cindex(3,Val1,errorDescriptor) of
asn1_NOVALUE -> [];
Tmpval1 ->

%% attribute number 2 with type Externaltypereference473megaco_per_media_gateway_control_prev3bErrorDescriptor
...
%% attribute number 1 with type Externaltypereference464megaco_per_media_gateway_control_prev3bTerminationIDList
'enc_TerminationIDList'(?RT_PER:cindex(2,Val1,terminationID)),

%% attribute number 2 with type Externaltypereference465megaco_per_media_gateway_control_prev3bObservedEventsDescriptor
'enc_ObservedEventsDescriptor'(?RT_PER:cindex(3,Val1,observedEventsDescriptor)),
case ?RT_PER:cindex(4,Val1,errorDescriptor) of
asn1_NOVALUE -> [];
Tmpval1 ->

%% attribute number 3 with type Externaltypereference466megaco_per_media_gateway_control_prev3bErrorDescriptor
'enc_ErrorDescriptor'(Tmpval1)
end].
...
%% attribute number 2 with type Externaltypereference435megaco_per_media_gateway_control_prev3bIndAudSignal
...
%% attribute number 2 with type Externaltypereference396megaco_per_media_gateway_control_prev3bIndAudPropertyGroup
...
%% attribute number 1 with type Externaltypereference371megaco_per_media_gateway_control_prev3bIndAudLocalControlDescriptor
...
%% attribute number 2 with type Externaltypereference372megaco_per_media_gateway_control_prev3bIndAudLocalRemoteDescriptor
...
%% attribute number 3 with type Externaltypereference373megaco_per_media_gateway_control_prev3bIndAudLocalRemoteDescriptor
...
%% attribute number 4 with type Externaltypereference375megaco_per_media_gateway_control_prev3bIndAudStatisticsDescriptor
...
%% attribute number 2 with type Externaltypereference366megaco_per_media_gateway_control_prev3bIndAudStreamParms
...
%% attribute number 1 with type Externaltypereference354megaco_per_media_gateway_control_prev3bIndAudTerminationStateDescriptor
...
%% attribute number 1 with type Externaltypereference297megaco_per_media_gateway_control_prev3bTerminationID
'enc_TerminationID'(?RT_PER:cindex(2,Val1,terminationID)),

%% attribute number 2 with type Externaltypereference298megaco_per_media_gateway_control_prev3bTerminationAudit
...
[
?RT_PER:setext(false), 
%% attribute number 1 with type Externaltypereference281megaco_per_media_gateway_control_prev3bTerminationID
'enc_TerminationID'(?RT_PER:cindex(2,Val1,terminationID)),

%% attribute number 2 with type Externaltypereference282megaco_per_media_gateway_control_prev3bAuditDescriptor
...
%% attribute number 1 with type Externaltypereference274megaco_per_media_gateway_control_prev3bTerminationIDList
'enc_TerminationIDList'(?RT_PER:cindex(2,Val1,terminationID)),
case ?RT_PER:cindex(3,Val1,auditDescriptor) of
asn1_NOVALUE -> [];
Tmpval1 ->

%% attribute number 2 with type Externaltypereference275megaco_per_media_gateway_control_prev3bAuditDescriptor
...
%% attribute number 1 with type Externaltypereference267megaco_per_media_gateway_control_prev3bTerminationIDList
'enc_TerminationIDList'(?RT_PER:cindex(2,Val1,terminationID)),
case ?RT_PER:cindex(3,Val1,terminationAudit) of
asn1_NOVALUE -> [];
Tmpval1 ->

%% attribute number 2 with type Externaltypereference268megaco_per_media_gateway_control_prev3bTerminationAudit
...
[
?RT_PER:setext(false), 
%% attribute number 1 with type Externaltypereference243megaco_per_media_gateway_control_prev3bTerminationIDList
'enc_TerminationIDList'(?RT_PER:cindex(2,Val1,terminationID)),
...
%% attribute number 1 with type Externaltypereference229megaco_per_media_gateway_control_prev3bTerminationID
'enc_TerminationID'(?RT_PER:cindex(2,Val1,terminationFrom)),

%% attribute number 2 with type Externaltypereference230megaco_per_media_gateway_control_prev3bTerminationID
...
%% attribute number 1 with type Externaltypereference193megaco_per_media_gateway_control_prev3bCommand
...
%% attribute number 2 with type Externaltypereference166megaco_per_media_gateway_control_prev3bErrorDescriptor
'enc_ErrorDescriptor'(Tmpval1)
end,
...
%% attribute number 3 with type Externaltypereference167megaco_per_media_gateway_control_prev3bContextRequest
...
%% attribute number 2 with type Externaltypereference158megaco_per_media_gateway_control_prev3bContextRequest
...
%% attribute number 3 with type Externaltypereference159megaco_per_media_gateway_control_prev3bContextAttrAuditRequest
