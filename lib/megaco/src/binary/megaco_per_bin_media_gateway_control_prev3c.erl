...
%% attribute number 1 with type Externaltypereference1038megaco_per_bin_media_gateway_control_prev3cNonStandardIdentifier
...
%% attribute number 2 with type Externaltypereference1030megaco_per_bin_media_gateway_control_prev3cValue
'enc_Value'(Tmpval1)
end].
...
%% attribute number 1 with type Externaltypereference990megaco_per_bin_media_gateway_control_prev3cMId
'enc_MId'(Tmpval1)
end,
...
%% attribute number 2 with type Externaltypereference991megaco_per_bin_media_gateway_control_prev3cServiceChangeAddress
...
%% attribute number 4 with type Externaltypereference993megaco_per_bin_media_gateway_control_prev3cServiceChangeProfile
...
%% attribute number 5 with type Externaltypereference994megaco_per_bin_media_gateway_control_prev3cTimeNotation
...
%% attribute number 2 with type Externaltypereference953megaco_per_bin_media_gateway_control_prev3cServiceChangeAddress
...
%% attribute number 4 with type Externaltypereference955megaco_per_bin_media_gateway_control_prev3cServiceChangeProfile
'enc_ServiceChangeProfile'(Tmpval3)
end,

%% attribute number 5 with type Externaltypereference956megaco_per_bin_media_gateway_control_prev3cValue
...
%% attribute number 7 with type Externaltypereference969megaco_per_bin_media_gateway_control_prev3cMId
'enc_MId'(Tmpval5)
end,
...
%% attribute number 8 with type Externaltypereference970megaco_per_bin_media_gateway_control_prev3cTimeNotation
...
%% attribute number 9 with type Externaltypereference971megaco_per_bin_media_gateway_control_prev3cNonStandardData
...
%% attribute number 10 with type Externaltypereference973megaco_per_bin_media_gateway_control_prev3cAuditDescriptor
...
%% attribute number 2 with type Externaltypereference930megaco_per_bin_media_gateway_control_prev3cDigitMapValue
...
%% attribute number 3 with type Externaltypereference910megaco_per_bin_media_gateway_control_prev3cNonStandardData
...
%% attribute number 2 with type Externaltypereference891megaco_per_bin_media_gateway_control_prev3cValue
...
%% attribute number 2 with type Externaltypereference816megaco_per_bin_media_gateway_control_prev3cEventDM
'enc_EventDM'(Tmpval2)
end,
...
%% attribute number 3 with type Externaltypereference817megaco_per_bin_media_gateway_control_prev3cSignalsDescriptor
...
%% attribute number 4 with type Externaltypereference819megaco_per_bin_media_gateway_control_prev3cNotifyBehaviour
...
%% attribute number 3 with type Externaltypereference808megaco_per_bin_media_gateway_control_prev3cSecondRequestedActions
...
%% attribute number 2 with type Externaltypereference783megaco_per_bin_media_gateway_control_prev3cEventDM
'enc_EventDM'(Tmpval2)
end,
...
%% attribute number 3 with type Externaltypereference784megaco_per_bin_media_gateway_control_prev3cSecondEventsDescriptor
...
%% attribute number 4 with type Externaltypereference785megaco_per_bin_media_gateway_control_prev3cSignalsDescriptor
...
%% attribute number 5 with type Externaltypereference787megaco_per_bin_media_gateway_control_prev3cNotifyBehaviour
...
%% attribute number 1 with type Externaltypereference767megaco_per_bin_media_gateway_control_prev3cSecondEventsDescriptor
...
%% attribute number 2 with type Externaltypereference768megaco_per_bin_media_gateway_control_prev3cSignalsDescriptor
...
%% attribute number 3 with type Externaltypereference760megaco_per_bin_media_gateway_control_prev3cRequestedActions
...
%% attribute number 3 with type Externaltypereference731megaco_per_bin_media_gateway_control_prev3cNonStandardData
'enc_NonStandardData'(Tmpval1)
end].
...
%% attribute number 1 with type Externaltypereference613megaco_per_bin_media_gateway_control_prev3cLocalControlDescriptor
...
%% attribute number 2 with type Externaltypereference614megaco_per_bin_media_gateway_control_prev3cLocalRemoteDescriptor
...
%% attribute number 3 with type Externaltypereference615megaco_per_bin_media_gateway_control_prev3cLocalRemoteDescriptor
...
%% attribute number 4 with type Externaltypereference617megaco_per_bin_media_gateway_control_prev3cStatisticsDescriptor
...
%% attribute number 2 with type Externaltypereference608megaco_per_bin_media_gateway_control_prev3cStreamParms
...
%% attribute number 1 with type Externaltypereference596megaco_per_bin_media_gateway_control_prev3cTerminationStateDescriptor
...
[
?RT_PER:setext(false), 
%% attribute number 1 with type Externaltypereference568megaco_per_bin_media_gateway_control_prev3cTerminationIDList
'enc_TerminationIDList'(?RT_PER:cindex(2,Val1,terminationID)),

%% attribute number 2 with type Externaltypereference569megaco_per_bin_media_gateway_control_prev3cServiceChangeResult
...
[
?RT_PER:setext(false), 
%% attribute number 1 with type Externaltypereference561megaco_per_bin_media_gateway_control_prev3cTerminationIDList
'enc_TerminationIDList'(?RT_PER:cindex(2,Val1,terminationID)),

%% attribute number 2 with type Externaltypereference562megaco_per_bin_media_gateway_control_prev3cServiceChangeParm
...
%% attribute number 2 with type Externaltypereference547megaco_per_bin_media_gateway_control_prev3cValue
'enc_Value'(?RT_PER:cindex(3,Val1,value)),
case ?RT_PER:cindex(4,Val1,extraInfo) of
asn1_NOVALUE -> [];
Tmpval1 ->
...
%% attribute number 4 with type Externaltypereference538megaco_per_bin_media_gateway_control_prev3cTimeNotation
...
%% attribute number 1 with type Externaltypereference522megaco_per_bin_media_gateway_control_prev3cTerminationIDList
'enc_TerminationIDList'(?RT_PER:cindex(2,Val1,terminationID)),
case ?RT_PER:cindex(3,Val1,errorDescriptor) of
asn1_NOVALUE -> [];
Tmpval1 ->

%% attribute number 2 with type Externaltypereference523megaco_per_bin_media_gateway_control_prev3cErrorDescriptor
...
%% attribute number 1 with type Externaltypereference514megaco_per_bin_media_gateway_control_prev3cTerminationIDList
'enc_TerminationIDList'(?RT_PER:cindex(2,Val1,terminationID)),

%% attribute number 2 with type Externaltypereference515megaco_per_bin_media_gateway_control_prev3cObservedEventsDescriptor
'enc_ObservedEventsDescriptor'(?RT_PER:cindex(3,Val1,observedEventsDescriptor)),
case ?RT_PER:cindex(4,Val1,errorDescriptor) of
asn1_NOVALUE -> [];
Tmpval1 ->

%% attribute number 3 with type Externaltypereference516megaco_per_bin_media_gateway_control_prev3cErrorDescriptor
'enc_ErrorDescriptor'(Tmpval1)
end].
...
%% attribute number 2 with type Externaltypereference484megaco_per_bin_media_gateway_control_prev3cIndAudSignal
...
%% attribute number 2 with type Externaltypereference442megaco_per_bin_media_gateway_control_prev3cIndAudPropertyGroup
...
%% attribute number 2 with type Externaltypereference434megaco_per_bin_media_gateway_control_prev3cPropertyParm
...
%% attribute number 1 with type Externaltypereference411megaco_per_bin_media_gateway_control_prev3cIndAudLocalControlDescriptor
...
%% attribute number 2 with type Externaltypereference412megaco_per_bin_media_gateway_control_prev3cIndAudLocalRemoteDescriptor
...
%% attribute number 3 with type Externaltypereference413megaco_per_bin_media_gateway_control_prev3cIndAudLocalRemoteDescriptor
...
%% attribute number 4 with type Externaltypereference415megaco_per_bin_media_gateway_control_prev3cIndAudStatisticsDescriptor
...
%% attribute number 2 with type Externaltypereference406megaco_per_bin_media_gateway_control_prev3cIndAudStreamParms
...
%% attribute number 1 with type Externaltypereference394megaco_per_bin_media_gateway_control_prev3cIndAudTerminationStateDescriptor
...
[
?RT_PER:setext(false), 
%% attribute number 1 with type Externaltypereference338megaco_per_bin_media_gateway_control_prev3cTerminationIDList
'enc_TerminationIDList'(?RT_PER:cindex(2,Val1,terminationIDList)),

%% attribute number 2 with type Externaltypereference339megaco_per_bin_media_gateway_control_prev3cTerminationAudit
...
%% attribute number 1 with type Externaltypereference332megaco_per_bin_media_gateway_control_prev3cTerminationID
'enc_TerminationID'(?RT_PER:cindex(2,Val1,terminationID)),

%% attribute number 2 with type Externaltypereference333megaco_per_bin_media_gateway_control_prev3cTerminationAudit
'enc_TerminationAudit'(?RT_PER:cindex(3,Val1,terminationAuditResult))].
...
[
?RT_PER:setext(Extensions =/= []), 
%% attribute number 1 with type Externaltypereference312megaco_per_bin_media_gateway_control_prev3cTerminationID
'enc_TerminationID'(?RT_PER:cindex(2,Val1,terminationID)),

%% attribute number 2 with type Externaltypereference313megaco_per_bin_media_gateway_control_prev3cAuditDescriptor
...
%% attribute number 3 with type Externaltypereference315megaco_per_bin_media_gateway_control_prev3cTerminationIDList
...
%% attribute number 1 with type Externaltypereference305megaco_per_bin_media_gateway_control_prev3cTerminationIDList
'enc_TerminationIDList'(?RT_PER:cindex(2,Val1,terminationID)),
case ?RT_PER:cindex(3,Val1,auditDescriptor) of
asn1_NOVALUE -> [];
Tmpval1 ->

%% attribute number 2 with type Externaltypereference306megaco_per_bin_media_gateway_control_prev3cAuditDescriptor
...
%% attribute number 1 with type Externaltypereference298megaco_per_bin_media_gateway_control_prev3cTerminationIDList
'enc_TerminationIDList'(?RT_PER:cindex(2,Val1,terminationID)),
case ?RT_PER:cindex(3,Val1,terminationAudit) of
asn1_NOVALUE -> [];
Tmpval1 ->

%% attribute number 2 with type Externaltypereference299megaco_per_bin_media_gateway_control_prev3cTerminationAudit
...
[
?RT_PER:setext(false), 
%% attribute number 1 with type Externaltypereference274megaco_per_bin_media_gateway_control_prev3cTerminationIDList
'enc_TerminationIDList'(?RT_PER:cindex(2,Val1,terminationID)),
...
[
?RT_PER:setext(Extensions =/= []), 
%% attribute number 1 with type Externaltypereference251megaco_per_bin_media_gateway_control_prev3cTerminationID
'enc_TerminationID'(?RT_PER:cindex(2,Val1,terminationFrom)),

%% attribute number 2 with type Externaltypereference252megaco_per_bin_media_gateway_control_prev3cTerminationID
...
%% attribute number 5 with type ENUMERATED
?RT_PER:encode_open_type(dummy,?RT_PER:complete(case (case Tmpval2 of {_,_}->element(2,Tmpval2);_->Tmpval2 end) of
...
%% attribute number 1 with type Externaltypereference215megaco_per_bin_media_gateway_control_prev3cCommand
...
%% attribute number 9 with type Externaltypereference202megaco_per_bin_media_gateway_control_prev3cSelectLogic
...
%% attribute number 2 with type Externaltypereference166megaco_per_bin_media_gateway_control_prev3cErrorDescriptor
'enc_ErrorDescriptor'(Tmpval1)
end,
...
%% attribute number 3 with type Externaltypereference167megaco_per_bin_media_gateway_control_prev3cContextRequest
...
%% attribute number 2 with type Externaltypereference158megaco_per_bin_media_gateway_control_prev3cContextRequest
...
%% attribute number 3 with type Externaltypereference159megaco_per_bin_media_gateway_control_prev3cContextAttrAuditRequest
