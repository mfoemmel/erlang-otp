...
%%-------------------------------------------------
   {EncBytes8,EncLen8} =  case ?RT_BER:cindex(9,Val,direction) of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
            case (case ?RT_BER:cindex(9,Val,direction) of {asn1_enum,_}->?RT_BER:cindex(9,Val,direction);{_,_}->element(2,?RT_BER:cindex(9,Val,direction));_->?RT_BER:cindex(9,Val,direction) end) of
...
{asn1_enum,Enumval8} -> ?RT_BER:encode_enumerated(Enumval8,[{tag,128,7,'IMPLICIT',0}]);
...
%%-------------------------------------------------
   {EncBytes4,EncLen4} =  case ?RT_BER:cindex(5,Val,serviceStateSel) of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
            case (case ?RT_BER:cindex(5,Val,serviceStateSel) of {asn1_enum,_}->?RT_BER:cindex(5,Val,serviceStateSel);{_,_}->element(2,?RT_BER:cindex(5,Val,serviceStateSel));_->?RT_BER:cindex(5,Val,serviceStateSel) end) of
...
{asn1_enum,Enumval3} -> ?RT_BER:encode_enumerated(Enumval3,[{tag,128,3,'IMPLICIT',0}]);
Enumval4 -> exit({error,{asn1, {enumerated_not_in_range,Enumval4}}})
end
       end,
...
%%-------------------------------------------------
   {EncBytes5,EncLen5} =  case ?RT_BER:cindex(6,Val,streamModeSel) of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
            case (case ?RT_BER:cindex(6,Val,streamModeSel) of {asn1_enum,_}->?RT_BER:cindex(6,Val,streamModeSel);{_,_}->element(2,?RT_BER:cindex(6,Val,streamModeSel));_->?RT_BER:cindex(6,Val,streamModeSel) end) of
...
{asn1_enum,Enumval4} -> ?RT_BER:encode_enumerated(Enumval4,[{tag,128,4,'IMPLICIT',0}]);
...
%%-------------------------------------------------
   {EncBytes5,EncLen5} =  case ?RT_BER:cindex(6,Val,topologyDirectionExtension) of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
            case (case ?RT_BER:cindex(6,Val,topologyDirectionExtension) of {asn1_enum,_}->?RT_BER:cindex(6,Val,topologyDirectionExtension);{_,_}->element(2,?RT_BER:cindex(6,Val,topologyDirectionExtension));_->?RT_BER:cindex(6,Val,topologyDirectionExtension) end) of
onewayexternal -> ?RT_BER:encode_enumerated(0,[{tag,128,4,'IMPLICIT',0}]);
onewayboth -> ?RT_BER:encode_enumerated(1,[{tag,128,4,'IMPLICIT',0}]);
{asn1_enum,Enumval3} -> ?RT_BER:encode_enumerated(Enumval3,[{tag,128,4,'IMPLICIT',0}]);
Enumval4 -> exit({error,{asn1, {enumerated_not_in_range,Enumval4}}})
end
       end,
