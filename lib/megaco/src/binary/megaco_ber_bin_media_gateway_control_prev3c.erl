...
%%-------------------------------------------------
   {EncBytes1,EncLen1} = case (case Cindex1 of {asn1_enum,_}->Cindex1;{_,_}->element(2,Cindex1);_->Cindex1 end) of
...
{asn1_enum,Enumval1} -> ?RT_BER:encode_enumerated(Enumval1,[<<128>>]);
Enumval2 -> exit({error,{asn1, {enumerated_not_in_range,Enumval2}}})
end,
...
{asn1_enum,Enumval1} -> ?RT_BER:encode_enumerated(Enumval1,[<<10>>]);
Enumval2 -> exit({error,{asn1, {enumerated_not_in_range,Enumval2}}})
end,
...
%%-------------------------------------------------
   {EncBytes3,EncLen3} =  case Cindex3 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
            case (case Cindex3 of {asn1_enum,_}->Cindex3;{_,_}->element(2,Cindex3);_->Cindex3 end) of
brief -> ?RT_BER:encode_enumerated(0,[<<130>>]);
onOff -> ?RT_BER:encode_enumerated(1,[<<130>>]);
timeOut -> ?RT_BER:encode_enumerated(2,[<<130>>]);
{asn1_enum,Enumval3} -> ?RT_BER:encode_enumerated(Enumval3,[<<130>>]);
...
%%-------------------------------------------------
   {EncBytes8,EncLen8} =  case Cindex8 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
            case (case Cindex8 of {asn1_enum,_}->Cindex8;{_,_}->element(2,Cindex8);_->Cindex8 end) of
internal -> ?RT_BER:encode_enumerated(0,[<<135>>]);
external -> ?RT_BER:encode_enumerated(1,[<<135>>]);
both -> ?RT_BER:encode_enumerated(3,[<<135>>]);
{asn1_enum,Enumval8} -> ?RT_BER:encode_enumerated(Enumval8,[<<135>>]);
...
%%-------------------------------------------------
   {EncBytes2,EncLen2} =  case Cindex2 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
            case (case Cindex2 of {asn1_enum,_}->Cindex2;{_,_}->element(2,Cindex2);_->Cindex2 end) of
off -> ?RT_BER:encode_enumerated(0,[<<129>>]);
lockStep -> ?RT_BER:encode_enumerated(1,[<<129>>]);
{asn1_enum,Enumval1} -> ?RT_BER:encode_enumerated(Enumval1,[<<129>>]);
Enumval2 -> exit({error,{asn1, {enumerated_not_in_range,Enumval2}}})
end
       end,
...
%%-------------------------------------------------
   {EncBytes1,EncLen1} =  case Cindex1 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
            case (case Cindex1 of {asn1_enum,_}->Cindex1;{_,_}->element(2,Cindex1);_->Cindex1 end) of
...
%%-------------------------------------------------
   {EncBytes4,EncLen4} =  case Cindex4 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
            case (case Cindex4 of {asn1_enum,_}->Cindex4;{_,_}->element(2,Cindex4);_->Cindex4 end) of
test -> ?RT_BER:encode_enumerated(0,[<<131>>]);
outOfSvc -> ?RT_BER:encode_enumerated(1,[<<131>>]);
inSvc -> ?RT_BER:encode_enumerated(2,[<<131>>]);
{asn1_enum,Enumval3} -> ?RT_BER:encode_enumerated(Enumval3,[<<131>>]);
Enumval4 -> exit({error,{asn1, {enumerated_not_in_range,Enumval4}}})
end
       end,
...
%%-------------------------------------------------
   {EncBytes5,EncLen5} =  case Cindex5 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
            case (case Cindex5 of {asn1_enum,_}->Cindex5;{_,_}->element(2,Cindex5);_->Cindex5 end) of
...
{asn1_enum,Enumval4} -> ?RT_BER:encode_enumerated(Enumval4,[<<132>>]);
...
%%-------------------------------------------------
   {EncBytes3,EncLen3} = case (case Cindex3 of {_,_}->element(2,Cindex3);_->Cindex3 end) of
...
{asn1_enum,Enumval3} -> ?RT_BER:encode_enumerated(Enumval3,[<<132>>]);
Enumval4 -> exit({error,{asn1, {enumerated_not_in_range,Enumval4}}})
end
       end,
