...
%% attribute number 1 with type Externaltypereference990megaco_per_bin_drv_media_gateway_control_v3MId
'enc_MId'(Tmpval1)
end,
case element(3,Val1) of
asn1_NOVALUE -> [];
...
%% attribute number 2 with type Externaltypereference991megaco_per_bin_drv_media_gateway_control_v3ServiceChangeAddress
...
%% attribute number 10 with type Externaltypereference973megaco_per_bin_drv_media_gateway_control_v3AuditDescriptor
...
%% attribute number 2 with type Externaltypereference816megaco_per_bin_drv_media_gateway_control_v3EventDM
'enc_EventDM'(Tmpval2)
end,
case element(4,Val1) of
asn1_NOVALUE -> [];
...
%% attribute number 4 with type Externaltypereference819megaco_per_bin_drv_media_gateway_control_v3NotifyBehaviour
...
%% attribute number 3 with type Externaltypereference808megaco_per_bin_drv_media_gateway_control_v3SecondRequestedActions
...
%% attribute number 1 with type Externaltypereference767megaco_per_bin_drv_media_gateway_control_v3SecondEventsDescriptor
...
%% attribute number 2 with type Externaltypereference442megaco_per_bin_drv_media_gateway_control_v3IndAudPropertyGroup
...
%% attribute number 2 with type Externaltypereference434megaco_per_bin_drv_media_gateway_control_v3PropertyParm
...
%% attribute number 1 with type Externaltypereference411megaco_per_bin_drv_media_gateway_control_v3IndAudLocalControlDescriptor
...
%% attribute number 2 with type Externaltypereference412megaco_per_bin_drv_media_gateway_control_v3IndAudLocalRemoteDescriptor
...
%% attribute number 4 with type Externaltypereference415megaco_per_bin_drv_media_gateway_control_v3IndAudStatisticsDescriptor
...
%% attribute number 1 with type Externaltypereference394megaco_per_bin_drv_media_gateway_control_v3IndAudTerminationStateDescriptor
...
%% attribute number 3 with type NULL
{Term3,Bytes5} = case Opt band (1 bsl 0) of
_Opt1 when _Opt1 > 0 ->?RT_PER:decode_null(Bytes4);
0 ->{asn1_NOVALUE,Bytes4}
