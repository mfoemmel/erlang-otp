...
#define ScaleText TkScaleText
void			ScaleText _ANSI_ARGS_((Tk_Canvas canvas,
...
#define TranslateText TkTranslateText
void			TranslateText _ANSI_ARGS_((Tk_Canvas canvas,
