...
static double		RectToPoint _ANSI_ARGS_((Tk_Canvas canvas,
			    Tk_Item *itemPtr, double *pointPtr));
#define ScaleRectOval TkScaleRectOval
void			ScaleRectOval _ANSI_ARGS_((Tk_Canvas canvas,
			    Tk_Item *itemPtr, double originX, double originY,
			    double scaleX, double scaleY));
#define TranslateRectOval TkTranslateRectOval
void			TranslateRectOval _ANSI_ARGS_((Tk_Canvas canvas,
