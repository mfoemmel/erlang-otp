...
#define ScaleLine TkScaleLine
void			ScaleLine _ANSI_ARGS_((Tk_Canvas canvas,
			    Tk_Item *itemPtr, double originX, double originY,
			    double scaleX, double scaleY));
#define TranslateLine TkTranslateLine
void			TranslateLine _ANSI_ARGS_((Tk_Canvas canvas,
