    ...
    char **argv;		/* Argument strings. */
{
	...
	Tcl_AppendResult(interp, "wrong # args: should be \"", argv[0],
		" ?volumePercent? ?-displayof window?\"", (char *) NULL);
	return TCL_ERROR;
    }
    ...
    char **argv;		/* Argument strings. */
{
	...
	return TCL_OK;
    } else if ((c == 'b') && (strncmp(argv[1], "bell", length) == 0)
	    && (length >= 2)) {
	return Tk_BellCmd(clientData, interp, argc-1, argv+1);
    } else if ((c == 'b') && (strncmp(argv[1], "bind", length) == 0)
	    && (length >= 4)) {
	return Tk_BindCmd(clientData, interp, argc-1, argv+1);
    } else if ((c == 'b') && (strncmp(argv[1], "bindtags", length) == 0)
	    && (length >= 4)) {
	return Tk_BindtagsCmd(clientData, interp, argc-1, argv+1);
    } else if ((c == 'b') && (strncmp(argv[1], "button", length) == 0)
	    && (length >= 2)) {
	return Tk_ButtonCmd(clientData, interp, argc-1, argv+1);
    } else if ((c == 'c') && (strncmp(argv[1], "clipboard", length) == 0)
	    && (length >= 2)) {
	return Tk_ClipboardCmd(clientData, interp, argc-1, argv+1);
    } else if ((c == 'c') && (strncmp(argv[1], "canvas", length) == 0)
	    && (length >= 2)) {
	return Tk_CanvasCmd(clientData, interp, argc-1, argv+1);
    } else if ((c == 'c') && (strncmp(argv[1], "checkbutton", length) == 0)
	    && (length >= 3)) {
	return Tk_CheckbuttonCmd(clientData, interp, argc-1, argv+1);
    } else if ((c == 'c') && (strncmp(argv[1], "chooseColor", length) == 0)
	    && (length >= 3)) {
	return Tk_ChooseColorCmd(clientData, interp, argc-1, argv+1);
    } else if ((c == 'd') && (strncmp(argv[1], "destroy", length) == 0)) {
	return Tk_DestroyCmd(clientData, interp, argc-1, argv+1);
    } else if ((c == 'e') && (strncmp(argv[1], "entry", length) == 0)) {
	return Tk_EntryCmd(clientData, interp, argc-1, argv+1);
    } else if ((c == 'f') && (strncmp(argv[1], "focus", length) == 0)
	    && (length >= 2)) {
	return Tk_FocusCmd(clientData, interp, argc-1, argv+1);
    } else if ((c == 'f') && (strncmp(argv[1], "frame", length) == 0)
	    && (length >= 2)) {
	return Tk_FrameCmd(clientData, interp, argc-1, argv+1);
    } else if ((c == 'g') && (strncmp(argv[1], "getOpenFile", length) == 0)
	    && (length >= 4)) {
	return Tk_GetOpenFileCmd(clientData, interp, argc-1, argv+1);
    } else if ((c == 'g') && (strncmp(argv[1], "getSaveFile", length) == 0)
	    && (length >= 4)) {
	return Tk_GetSaveFileCmd(clientData, interp, argc-1, argv+1);
    } else if ((c == 'g') && (strncmp(argv[1], "grab", length) == 0)
	    && (length >= 3)) {
	return Tk_GrabCmd(clientData, interp, argc-1, argv+1);
    } else if ((c == 'g') && (strncmp(argv[1], "grid", length) == 0)
	    && (length >= 3)) {
	return Tk_GridCmd(clientData, interp, argc-1, argv+1);
    } else if ((c == 'i') && (strncmp(argv[1], "image", length) == 0)) {
	return Tk_ImageCmd(clientData, interp, argc-1, argv+1);
    } else if ((c == 'l') && (strncmp(argv[1], "label", length) == 0)
	    && (length >= 2)) {
	return Tk_LabelCmd(clientData, interp, argc-1, argv+1);
    } else if ((c == 'l') && (strncmp(argv[1], "listbox", length) == 0)
	    && (length >= 2)) {
	return Tk_ListboxCmd(clientData, interp, argc-1, argv+1);
    } else if ((c == 'l') && (strncmp(argv[1], "lower", length) == 0)
	    && (length >= 2)) {
	return Tk_LowerCmd(clientData, interp, argc-1, argv+1);
    } else if ((c == 'm') && (strncmp(argv[1], "menu", length) == 0)
	    && (length >= 4)) {
	return Tk_MenuCmd(clientData, interp, argc-1, argv+1);
    } else if ((c == 'm') && (strncmp(argv[1], "menubutton", length) == 0)
	    && (length >= 4)) {
	return Tk_MenubuttonCmd(clientData, interp, argc-1, argv+1);
    } else if ((c == 'm') && (strncmp(argv[1], "messagebox", length) == 0)
	    && (length >= 8)) {
	return Tk_MessageBoxCmd(clientData, interp, argc-1, argv+1);
    } else if ((c == 'm') && (strncmp(argv[1], "message", length) == 0)
	    && (length >= 3)) {
	return Tk_MessageCmd(clientData, interp, argc-1, argv+1);
    } else if ((c == 'o') && (strncmp(argv[1], "option", length) == 0)
	    && (length >= 2)) {
	return Tk_OptionCmd(clientData, interp, argc-1, argv+1);
    } else if ((c == 'p') && (strncmp(argv[1], "pack", length) == 0)
	    && (length >= 2)) {
	return Tk_PackCmd(clientData, interp, argc-1, argv+1);
    } else if ((c == 'p') && (strncmp(argv[1], "place", length) == 0)
	    && (length >= 2)) {
	return Tk_PlaceCmd(clientData, interp, argc-1, argv+1);
    } else if ((c == 'r') && (strncmp(argv[1], "raise", length) == 0)
	    && (length >= 3)) {
	return Tk_RaiseCmd(clientData, interp, argc-1, argv+1);
    } else if ((c == 'r') && (strncmp(argv[1], "radiobutton", length) == 0)
	    && (length >= 3)) {
	return Tk_RadiobuttonCmd(clientData, interp, argc-1, argv+1);
    } else if ((c == 's') && (strncmp(argv[1], "scale", length) == 0)
	    && (length >= 3)) {
	return Tk_ScaleCmd(clientData, interp, argc-1, argv+1);
    } else if ((c == 's') && (strncmp(argv[1], "scrollbar", length) == 0)
	    && (length >= 3)) {
	return Tk_ScrollbarCmd(clientData, interp, argc-1, argv+1);
    } else if ((c == 's') && (strncmp(argv[1], "selection", length) == 0)
	    && (length >= 2)) {
	return Tk_SelectionCmd(clientData, interp, argc-1, argv+1);
    } else if ((c == 't') && (strncmp(argv[1], "text", length) == 0)
	    && (length >= 3)) {
	return Tk_TextCmd(clientData, interp, argc-1, argv+1);
    } else if ((c == 't') && (strncmp(argv[1], "tkwait", length) == 0)
	    && (length >= 3)) {
	return Tk_TkwaitCmd(clientData, interp, argc-1, argv+1);
    } else if ((c == 't') && (strncmp(argv[1], "toplevel", length) == 0)
	    && (length >= 3)) {
	return Tk_ToplevelCmd(clientData, interp, argc-1, argv+1);
    } else if ((c == 'w') && (strncmp(argv[1], "winfo", length) == 0)
	    && (length >= 2)) {
	return Tk_WinfoCmd(clientData, interp, argc-1, argv+1);
    } else if ((c == 'w') && (strncmp(argv[1], "wm", length) == 0)
	    && (length >= 2)) {
	return Tk_WmCmd(clientData, interp, argc-1, argv+1);
    }
    Tcl_AppendResult(interp, "bad option \"", argv[1],
	    "\": must be appname, bell, bind, bindtags, button, ",
	    "canvas, checkbutton, chooseColor, clipboard, destroy, ",
	    "entry, focus, frame, grab, getOpenFile, getSaveFile, ",
	    "grid, image, label, listbox, lower, menu, menubutton, ",
	    "message, messageBox, option, pack, place, radiobutton, ",
	    "raise, scale, scrollbar, selection, text, tkwait, toplevel, ",
	    "winfo, or wm", (char *) NULL);
    return TCL_ERROR;
}

/*
    ...
    char **argv;		/* Argument strings. */
{
	...
	if (Tcl_TraceVar(interp, argv[2],
		...
		(Tcl_VarTraceProc *) WaitVariableProc, (ClientData) &done)
		!= TCL_OK) {
	    return TCL_ERROR;
	}
	done = 0;
 ...
 *	It is only here for binary compatibility with Tcl7.6.
 *
 * Results:
 *	A standard Tcl result.
 *
...
#   undef Tk_UpdateCmd
#endif
int		Tcl_UpdateCmd _ANSI_ARGS_((ClientData clientData,
			    Tcl_Interp *interp, int argc, char **argv));
int		Tk_UpdateCmd _ANSI_ARGS_((ClientData clientData,
			    Tcl_Interp *interp, int argc, char **argv));
...
Tk_UpdateCmd(clientData, interp, argc, argv)
    ...
    char **argv;		/* Argument strings. */
{
    return Tcl_UpdateCmd(clientData, interp, argc, argv);
}

/*
 *----------------------------------------------------------------------
...
#define SETUP(name) \
	...
	Tcl_Command cmd;
	SETUP("command");
	cmd = Itk_GetWidgetCommand(window);
	if (cmd != NULL) {
	    Tcl_AppendResult(interp, Tcl_GetCommandPath(interp,cmd), (char*)NULL);
	}
    ...
    } else if ((c == 'm') && (strncmp(argv[1], "megawidget", length) == 0)
	    && (length >= 2)) {
	SETUP("megawidget");
	tkwin = Itk_GetMegaWidget(window);
	if (tkwin != NULL) {
	    Tcl_AppendResult(interp, Tk_PathName(tkwin), (char*)NULL);
	}
	...
	Tcl_AppendResult(interp, "bad option \"", argv[1],
		...
		"class, colormapfull, command, containing, depth, exists, ",
		"fpixels, geometry, height, ",
		"id, interps, ismapped, manager, megawidget, name, parent, pathname, ",
