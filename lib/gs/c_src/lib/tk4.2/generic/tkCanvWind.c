...
#define ScaleWinItem TkScaleWinItem
void			ScaleWinItem _ANSI_ARGS_((Tk_Canvas canvas,
			    Tk_Item *itemPtr, double originX, double originY,
			    double scaleX, double scaleY));
#define TranslateWinItem TktranslateWinItem
void			TranslateWinItem _ANSI_ARGS_((Tk_Canvas canvas,
