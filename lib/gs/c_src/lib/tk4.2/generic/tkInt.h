...
EXTERN int		TkDeleteCommand2 _ANSI_ARGS_((Tcl_Interp *interp,
			    Tcl_Command cmd));
#define Tcl_DeleteCommand2(a,b) TkDeleteCommand2(a,b)
...
EXTERN void		TkGetButtPoints _ANSI_ARGS_((double p1[], double p2[],
			    ...
			    double m2[]));
EXTERN char *		TkGetCommandPath _ANSI_ARGS_((Tcl_Interp *interp,
			    Tcl_Command cmd));
#define Tcl_GetCommandPath(a,b) TkGetCommandPath(a,b)
...
EXTERN void		TkGetServerInfo _ANSI_ARGS_((Tcl_Interp *interp,
			    Tk_Window tkwin));
extern int		tkGetSendSerial _ANSI_ARGS_((void));
...
EXTERN int		TkInitInternal _ANSI_ARGS_((Tcl_Interp *interp,
			    int value));
...
EXTERN int		TkLoadLib _ANSI_ARGS_((Tcl_Interp *interp,
			    CONST char *libName, CONST char *libVersion,
			    VOID **handlePtr, char **symbols, int num));
EXTERN void		TkLoadFailed _ANSI_ARGS_((VOID **handlePtr));
...
EXTERN void		TkpGetWindowId _ANSI_ARGS_((Tcl_Interp *interp,
		            Tk_Window window));
EXTERN int		TkPhotoPutBlock _ANSI_ARGS_((Tk_PhotoHandle handle,
