    ...
    Button *butPtr;		/* Info about button widget. */
{
	...
	Tcl_UntraceVar(butPtr->interp, butPtr->textVarName,
		...
		(Tcl_VarTraceProc *) ButtonTextVarProc, (ClientData) butPtr);
    }
	...
	Tcl_UntraceVar(butPtr->interp, butPtr->selVarName,
		TCL_GLOBAL_ONLY|TCL_TRACE_WRITES|TCL_TRACE_UNSETS,
		(Tcl_VarTraceProc *) ButtonVarProc, (ClientData) butPtr);
    }
    ...
    XEvent *eventPtr;		/* Information about event. */
{
	...
	if (butPtr->tkwin != NULL) {
	    ...
	    butPtr->tkwin = NULL;
	    Tcl_DeleteCommand2(butPtr->interp, butPtr->widgetCmd);
	}
    ...
    int flags;			/* Information about what happened. */
{
	...
	if ((flags & TCL_TRACE_DESTROYED) && !(flags & TCL_INTERP_DESTROYED)) {
	    Tcl_TraceVar(interp, butPtr->selVarName,
		    TCL_GLOBAL_ONLY|TCL_TRACE_WRITES|TCL_TRACE_UNSETS,
		    (Tcl_VarTraceProc *) ButtonVarProc, clientData);
	}
	goto redisplay;
    }
    ...
    int flags;			/* Information about what happened. */
{
	...
	if ((flags & TCL_TRACE_DESTROYED) && !(flags & TCL_INTERP_DESTROYED)) {
	    ...
	    Tcl_TraceVar(interp, butPtr->textVarName,
		    TCL_GLOBAL_ONLY|TCL_TRACE_WRITES|TCL_TRACE_UNSETS,
		    (Tcl_VarTraceProc *) ButtonTextVarProc, clientData);
	}
	return (char *) NULL;
    }
