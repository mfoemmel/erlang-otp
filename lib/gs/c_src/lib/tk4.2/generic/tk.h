...
#define Tk_MainLoop		Tcl_MainLoop
...
#define Tk_UpdateCmd		Tcl_UpdateCmd

/*
 *--------------------------------------------------------------
 *
...
EXTERN int		Tk_GetAnchor _ANSI_ARGS_((Tcl_Interp *interp,
			    CONST char *string, Tk_Anchor *anchorPtr));
...
EXTERN int		Tk_GetJoinStyle _ANSI_ARGS_((Tcl_Interp *interp,
			    CONST char *string, int *joinPtr));
EXTERN int		Tk_GetJustify _ANSI_ARGS_((Tcl_Interp *interp,
			    CONST char *string, Tk_Justify *justifyPtr));
...
EXTERN int		Tk_GetPixels _ANSI_ARGS_((Tcl_Interp *interp,
			    Tk_Window tkwin, CONST char *string, int *intPtr));
...
EXTERN int		Tk_GetScreenMM _ANSI_ARGS_((Tcl_Interp *interp,
			    Tk_Window tkwin, CONST char *string, double *doublePtr));
...
EXTERN Visual *		Tk_GetVisual _ANSI_ARGS_((Tcl_Interp *interp,
			    Tk_Window tkwin, CONST char *string, int *depthPtr,
...
EXTERN int		Tk_InitStandAlone _ANSI_ARGS_((Tcl_Interp *interp));
