...
#define ScalePolygon TkScalePolygon
void			ScalePolygon _ANSI_ARGS_((Tk_Canvas canvas,
			    Tk_Item *itemPtr, double originX, double originY,
			    double scaleX, double scaleY));
#define TranslatePolygon TkTranslatePolygon
void			TranslatePolygon _ANSI_ARGS_((Tk_Canvas canvas,
