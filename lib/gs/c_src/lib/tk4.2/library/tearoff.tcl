...
proc tkTearOffMenu w {
	...
	Menubutton {
	    wm title $menu [[winfo_command $parent] cget -text]
	}
	Menu {
	    wm title $menu [[winfo_command $parent] entrycget active -label]
	}
    }

    [winfo_command $menu] configure -tearoff 0
    [winfo_command $menu] post [winfo x $w] [winfo y $w]
