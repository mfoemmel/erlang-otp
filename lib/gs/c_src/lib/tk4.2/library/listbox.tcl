...
bind Listbox <1> {
    if [winfo exists %W] {
	tkListboxBeginSelect %W [[winfo_command %W] index @%x,%y]
    }
}
...
bind Listbox <B1-Motion> {
    set tkPriv(x) %x
    set tkPriv(y) %y
    tkListboxMotion %W [[winfo_command %W] index @%x,%y]
}
bind Listbox <ButtonRelease-1> {
    tkCancelRepeat
    [winfo_command %W] activate @%x,%y
}
bind Listbox <Shift-1> {
    tkListboxBeginExtend %W [[winfo_command %W] index @%x,%y]
}
bind Listbox <Control-1> {
    tkListboxBeginToggle %W [[winfo_command %W] index @%x,%y]
}
...
bind Listbox <Left> {
    [winfo_command %W] xview scroll -1 units
}
bind Listbox <Control-Left> {
    [winfo_command %W] xview scroll -1 pages
}
bind Listbox <Right> {
    [winfo_command %W] xview scroll 1 units
}
...
bind Listbox <Prior> {
    [winfo_command %W] yview scroll -1 pages
    [winfo_command %W] activate @0,0
}
bind Listbox <Next> {
    [winfo_command %W] yview scroll 1 pages
    [winfo_command %W] activate @0,0
...
bind Listbox <Home> {
    [winfo_command %W] xview moveto 0
}
bind Listbox <End> {
    [winfo_command %W] xview moveto 1
}
bind Listbox <Control-Home> {
    [winfo_command %W] activate 0
    [winfo_command %W] see 0
    [winfo_command %W] selection clear 0 end
    [winfo_command %W] selection set 0
}
bind Listbox <Shift-Control-Home> {
    tkListboxDataExtend %W 0
}
bind Listbox <Control-End> {
    [winfo_command %W] activate end
    [winfo_command %W] see end
    [winfo_command %W] selection clear 0 end
    [winfo_command %W] selection set end
}
bind Listbox <Shift-Control-End> {
    tkListboxDataExtend %W [[winfo_command %W] index end]
}
bind Listbox <<Copy>> {
...
bind Listbox <space> {
    tkListboxBeginSelect %W [[winfo_command %W] index active]
}
bind Listbox <Select> {
    tkListboxBeginSelect %W [[winfo_command %W] index active]
}
bind Listbox <Control-Shift-space> {
    tkListboxBeginExtend %W [[winfo_command %W] index active]
}
...
bind Listbox <Control-backslash> {
    if {[[winfo_command %W] cget -selectmode] != "browse"} {
	[winfo_command %W] selection clear 0 end
    }
}
