 ...
 */
void
TkpXpmAllocTmpBuffer(masterPtr, instancePtr, imagePtr, maskPtr)
 ...
 */
void
TkpXpmSetPixel(instancePtr, image, mask, x, y, colorPtr, isTranspPtr)
    PixmapInstance * instancePtr;
    XImage * image;
    XImage * mask;
    int x;
...
void
TkpXpmFreeInstanceData(instancePtr, delete)
