...
EXTERN void		TkWinXInit _ANSI_ARGS_((HINSTANCE));
    ...
    int nCmdShow;
{
    ...
    /*
     * Call TkWinXInit in case we are linked to the standalone
     * library instead of the dll.  It's safe to always do this
     * since TkWinXInit keeps of whether or not it's already been
     * called.
     */
