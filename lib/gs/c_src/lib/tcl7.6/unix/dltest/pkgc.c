...
static int	Pkgc_SubCmd _ANSI_ARGS_((ClientData dummy1,
		    Tcl_Interp *interp, int argc, char **argv));
static int	Pkgc_UnsafeCmd _ANSI_ARGS_((ClientData dummy1,
...
#else
Pkgc_SubCmd(dummy1, interp, argc, argv)
    ClientData dummy1;			/* Not used. */
    Tcl_Interp *interp;			/* Current interpreter. */
    int argc;				/* Number of arguments. */
    char **argv;			/* Argument strings. */
...
#else
Pkgc_UnsafeCmd(dummy1, interp, dummy2, dummy3)
    ClientData dummy1;			/* Not used. */
    Tcl_Interp *interp;			/* Current interpreter. */
    int dummy2;				/* Not used. */
    char **dummy3;			/* Not used. */
