...
static CmdInfo builtInCmds[] = {
    ...
    {"code",		(Tcl_CmdProc *) NULL},
    {"delete",		(Tcl_CmdProc *) NULL},
    {"ensemble",	(Tcl_CmdProc *) NULL},
    {"import",		(Tcl_CmdProc *) NULL},
    {"namespace",	(Tcl_CmdProc *) NULL},
    {"public",		(Tcl_CmdProc *) NULL},
    {"private",		(Tcl_CmdProc *) NULL},
    {"scope",		(Tcl_CmdProc *) NULL},
    {"@scope",		(Tcl_CmdProc *) NULL},
    {"variable",	(Tcl_CmdProc *) NULL},
