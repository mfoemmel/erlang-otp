...
EXTERN int		Tcl_CreateAlias _ANSI_ARGS_((Tcl_Interp *slave,
			    CONST char *slaveCmd, Tcl_Interp *target,
        		    CONST char *targetCmd, int argc, char **argv));
...
EXTERN int		Tcl_ExprBoolean _ANSI_ARGS_((Tcl_Interp *interp,
			    CONST char *string, int *ptr));
EXTERN int		Tcl_ExprDouble _ANSI_ARGS_((Tcl_Interp *interp,
			    CONST char *string, double *ptr));
EXTERN int		Tcl_ExprLong _ANSI_ARGS_((Tcl_Interp *interp,
			    CONST char *string, long *ptr));
...
EXTERN int		Tcl_GlobalEval _ANSI_ARGS_((Tcl_Interp *interp,
			    CONST char *command));
EXTERN int		Tcl_HasNamespaces _ANSI_ARGS_((Tcl_Interp *interp));
...
EXTERN void Itcl_ParseNamespPath _ANSI_ARGS_((CONST char *name, char **head,
    char **tail));
...
typedef int (Itcl_CmdEnforcerProc) _ANSI_ARGS_((Tcl_Interp* interp,
    CONST char* name, Tcl_Command* cmdPtr));

typedef int (Itcl_VarEnforcerProc) _ANSI_ARGS_((Tcl_Interp* interp,
    CONST char* name, Tcl_Var* varPtr, int flags));
 ...
 */
EXTERN CONST char* Tcl_GetVariableName _ANSI_ARGS_((Tcl_Interp *interp,
    Tcl_Var var));
...
EXTERN int Itcl_CreateNamesp _ANSI_ARGS_((Tcl_Interp* interp, CONST char* name,
...
EXTERN int Itcl_UplevelEval _ANSI_ARGS_((Tcl_Interp* interp, CONST char* cmd));
EXTERN int Itcl_NamespEval _ANSI_ARGS_((Tcl_Interp* interp,
    Itcl_Namespace ns, CONST char* cmd));
...
EXTERN CONST char* Itcl_GetNamespName _ANSI_ARGS_((Itcl_Namespace ns));
EXTERN CONST char* Itcl_GetNamespPath _ANSI_ARGS_((Itcl_Namespace ns));
...
EXTERN int Itcl_FindNamesp _ANSI_ARGS_((Tcl_Interp* interp,
    CONST char* path, int flags, Itcl_Namespace* rnsPtr));
EXTERN int Itcl_FindCommand _ANSI_ARGS_((Tcl_Interp* interp,
    CONST char* path, int flags, Tcl_Command *rcmd));
EXTERN int Itcl_FindVariable _ANSI_ARGS_((Tcl_Interp* interp,
    CONST char* path, int flags, Tcl_Var *rvar));
...
EXTERN void Itcl_ScopedValSet _ANSI_ARGS_((Itcl_ScopedVal* sval,
    CONST char *valStr, Itcl_Namespace valNs));
...
EXTERN int Itcl_ScopedValDecode _ANSI_ARGS_((Tcl_Interp* interp,
    CONST char* mesg, Itcl_ScopedVal* sval));
EXTERN int Itcl_ScopedValDecodeList _ANSI_ARGS_((Tcl_Interp* interp,
    CONST char* mesg, Itcl_List* svlist));
...
EXTERN int Itcl_AddEnsembleOption _ANSI_ARGS_((Tcl_Interp* interp,
    CONST char* ensName, CONST char* optName, int minArgs, int maxArgs,
    CONST char* usage, Tcl_CmdProc* proc, ClientData cdata,
    Tcl_CmdDeleteProc* dproc));
EXTERN int Itcl_GetEnsembleOption _ANSI_ARGS_((Tcl_Interp* interp,
    CONST char* ensName, CONST char* optName, Tcl_CmdInfo* cinfo));
EXTERN int Itcl_IsEnsemble _ANSI_ARGS_((Tcl_CmdInfo* cinfo));
EXTERN CONST char* Itcl_EnsembleInvoc _ANSI_ARGS_((void));
EXTERN CONST char* Itcl_EnsembleUsage _ANSI_ARGS_((void));
