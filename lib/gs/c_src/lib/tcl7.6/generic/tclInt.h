...
#define NUM_REGEXPS 5
    ...
    char *termPtr;		/* Character just after the last one in
				 ...
				 * returning. */
    CONST char *scriptFile;	/* NULL means there is no nested source
 ...
 *			been carried out.
 * HAS_NAMESPACES:	Set if this interpreter has Itcl-compatible
 *			namespaces.
 */
...
EXTERN void		TclConsoleCreate _ANSI_ARGS_((void));
EXTERN int		TclConsoleInit _ANSI_ARGS_((Tcl_Interp *interp));
EXTERN void		TclConsolePrint _ANSI_ARGS_((Tcl_Interp *interp,
...
EXTERN int		TclFindElement _ANSI_ARGS_((Tcl_Interp *interp,
			    CONST char *list, char **elementPtr,
...
EXTERN int		TclGetFrame _ANSI_ARGS_((Tcl_Interp *interp,
			    CONST char *string, CallFrame **framePtrPtr));
...
EXTERN int		TclGetOpenMode _ANSI_ARGS_((Tcl_Interp *interp,
        		    CONST char *string, int *seekFlagPtr));
EXTERN char *		TclGetUserHome _ANSI_ARGS_((CONST char *name,
			    Tcl_DString *bufferPtr));
EXTERN int		TclGuessPackageName _ANSI_ARGS_((CONST char *fileName,
			    Tcl_DString *bufPtr));
...
EXTERN int		TclLoadFile _ANSI_ARGS_((Tcl_Interp *interp,
			    CONST char *fileName, CONST char *sym1,
...
EXTERN Tcl_File		TclOpenFile _ANSI_ARGS_((CONST char *fname, int mode));
...
EXTERN int		TclPreventAliasLoop _ANSI_ARGS_((Tcl_Interp *interp,
		            Tcl_Interp *cmdInterp, CONST char *cmdName,
...
EXTERN int		TclWriteFile _ANSI_ARGS_((Tcl_File file,
			    int shouldBlock, CONST char *buf, int toWrite));
...
EXTERN int	Tcl_SwitchCmd _ANSI_ARGS_((ClientData clientData,
		    Tcl_Interp *interp, int argc, char **argv));
EXTERN int	Tcl_TclCmd _ANSI_ARGS_((ClientData clientData,
		    Tcl_Interp *interp, int argc, char **argv));
...
EXTERN int	Tcl_UnsetCmd _ANSI_ARGS_((ClientData clientData,
		    Tcl_Interp *interp, int argc, char **argv));
EXTERN int	Tcl_UnstackCmd _ANSI_ARGS_((ClientData clientData,
		    Tcl_Interp *interp, int argc, char **argv));
