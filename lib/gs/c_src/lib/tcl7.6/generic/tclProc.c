    ...
    char **argv;			/* Argument strings. */
{
    ...
    Tcl_CreateCommand(interp, argv[1], TclInterpProc, (ClientData) procPtr,
	    ProcDeleteProc);
    ...
    CONST char *procName;	/* Name of desired procedure. */
{
    ...
    cmdPtr = (Command *) Tcl_FindCommand((Tcl_Interp *) iPtr, procName, 0);
    if ((cmdPtr == NULL) || (cmdPtr->proc != TclInterpProc)) {
	return NULL;
    }
