...
start() ->
    Terms = the_config(),
    DB=fill_ets(Terms),
    {ok,OutFd} = file:open("gtk_generic.hrl",write),
    put(stdout,OutFd),
...
gen_out_opts(DB) ->
    ...
    p("out_opts([Option|Options],Gtkid,TkW,DB,ExtraArg,S,P,C) -> \n"),
...
gen_out_type_case_clauses([Objtype|Objtypes],DB) ->
    ...
    p("Other -> \nhandle_external_opt_call([Option|Options],Gtkid,TkW,DB,ExtraArg,"
      "gtk_~p:option(Option,Gtkid,TkW,DB,ExtraArg),S,P,C)\n",[Objtype]),
    p("end;\n"),
...
gen_read_type_clauses([Objtype|Objtypes],DB) ->
    ...
    p("Other -> \nhandle_external_read(gtk_~p:read_option(Option,Gtkid,TkW,DB,ExtraArg))\n",[Objtype]),
    p("end;\n"),
...
gen_readopt_case_clauses([{Opt,Fun}|OptFuncs]) ->
    p("~p -> \n~p(Option,Gtkid,TkW,DB,ExtraArg);\n",[Opt,Fun]),
