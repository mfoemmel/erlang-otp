...
-export([init/1,
	 ...
	 set_upper_threshold/4,  %% Optional!
	 set_lower_threshold/4,  %% Optional!
	 remove_threshold/2,     %% Optional!
	 enable_threshold/2,     %% Optional!
	 disable_threshold/2     %% Optional!
	]).
