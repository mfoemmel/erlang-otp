...
oe_register() ->
    ...
    orber_ifr:'ModuleDef_create_enum'(_OE_1, "IDL:omg.org/CosTimerEvent/EventStatus:1.0", "EventStatus", "1.0", ["ESTimeSet","ESTimeCleared","ESTriggered",
   "ESFailedTrigger"]),
...
oe_dependency() ->
    ...
    {"/ldisk/daily_build/otp_prebuild_r12b.2008-02-05_20/otp_src_R12B-1/lib/cosTime/src/CosTimerEvent.idl",
