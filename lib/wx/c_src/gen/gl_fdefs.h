...
typedef void (APIENTRY * WXEGLDRAWARRAYSINSTANCEDARB)(GLenum,GLint,GLsizei,GLsizei);
WXE_EXTERN WXEGLDRAWARRAYSINSTANCEDARB weglDrawArraysInstancedARB;
typedef void (APIENTRY * WXEGLDRAWELEMENTSINSTANCEDARB)(GLenum,GLsizei,GLenum,const GLvoid *,GLsizei);
WXE_EXTERN WXEGLDRAWELEMENTSINSTANCEDARB weglDrawElementsInstancedARB;
...
typedef void (APIENTRY * WXEGLTEXBUFFERARB)(GLenum,GLenum,GLuint);
WXE_EXTERN WXEGLTEXBUFFERARB weglTexBufferARB;
