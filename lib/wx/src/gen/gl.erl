...
-export([accum/2,alphaFunc/2,areTexturesResident/1,arrayElement/1,'begin'/1,
  ...
  blendEquation/1,drawRangeElements/6,colorTable/6,colorTableParameterfv/3,
  colorTableParameteriv/3,copyColorTable/5,getColorTable/4,getColorTableParameterfv/2,
  getColorTableParameteriv/2,colorSubTable/6,copyColorSubTable/5,convolutionFilter1D/6,
  convolutionFilter2D/7,convolutionParameterf/3,convolutionParameterfv/3,
  convolutionParameteri/3,convolutionParameteriv/3,copyConvolutionFilter1D/5,
  copyConvolutionFilter2D/6,getConvolutionFilter/4,getConvolutionParameterfv/2,
  getConvolutionParameteriv/2,separableFilter2D/8,getHistogram/5,getHistogramParameterfv/2,
  getHistogramParameteriv/2,getMinmax/5,getMinmaxParameterfv/2,getMinmaxParameteriv/2,
  histogram/4,minmax/3,resetHistogram/1,resetMinmax/1,texImage3D/10,
  texSubImage3D/11,copyTexSubImage3D/9,activeTexture/1,clientActiveTexture/1,
  ...
  multTransposeMatrixd/1,sampleCoverage/2,compressedTexImage3D/9,compressedTexImage2D/8,
  compressedTexImage1D/7,compressedTexSubImage3D/11,compressedTexSubImage2D/9,
  compressedTexSubImage1D/7,getCompressedTexImage/3,blendFuncSeparate/4,
  fogCoordf/1,fogCoordfv/1,fogCoordd/1,fogCoorddv/1,fogCoordPointer/3,
  multiDrawArrays/3,pointParameterf/2,pointParameterfv/2,pointParameteri/2,
  pointParameteriv/2,secondaryColor3b/3,secondaryColor3bv/1,secondaryColor3d/3,
  secondaryColor3dv/1,secondaryColor3f/3,secondaryColor3fv/1,secondaryColor3i/3,
  secondaryColor3iv/1,secondaryColor3s/3,secondaryColor3sv/1,secondaryColor3ub/3,
  secondaryColor3ubv/1,secondaryColor3ui/3,secondaryColor3uiv/1,secondaryColor3us/3,
  secondaryColor3usv/1,secondaryColorPointer/4,windowPos2d/2,windowPos2dv/1,
  windowPos2f/2,windowPos2fv/1,windowPos2i/2,windowPos2iv/1,windowPos2s/2,
  windowPos2sv/1,windowPos3d/3,windowPos3dv/1,windowPos3f/3,windowPos3fv/1,
  windowPos3i/3,windowPos3iv/1,windowPos3s/3,windowPos3sv/1,genQueries/1,
  deleteQueries/1,isQuery/1,beginQuery/2,endQuery/1,getQueryiv/2,getQueryObjectiv/2,
  ...
  bindBufferBase/3,clampColor/2,beginConditionalRender/2,endConditionalRender/0,
  vertexAttribI1i/2,vertexAttribI2i/3,vertexAttribI3i/4,vertexAttribI4i/5,
  vertexAttribI1ui/2,vertexAttribI2ui/3,vertexAttribI3ui/4,vertexAttribI4ui/5,
  vertexAttribI1iv/2,vertexAttribI2iv/2,vertexAttribI3iv/2,vertexAttribI4iv/2,
  vertexAttribI1uiv/2,vertexAttribI2uiv/2,vertexAttribI3uiv/2,vertexAttribI4uiv/2,
  vertexAttribI4bv/2,vertexAttribI4sv/2,vertexAttribI4ubv/2,vertexAttribI4usv/2,
  vertexAttribIPointer/5,getVertexAttribIiv/2,getVertexAttribIuiv/2,
  getUniformuiv/2,bindFragDataLocation/3,getFragDataLocation/2,uniform1ui/2,
  uniform2ui/3,uniform3ui/4,uniform4ui/5,uniform1uiv/2,uniform2uiv/2,
  uniform3uiv/2,uniform4uiv/2,texParameterIiv/3,texParameterIuiv/3,
  getTexParameterIiv/2,getTexParameterIuiv/2,clearBufferiv/3,clearBufferuiv/3,
  clearBufferfv/3,clearBufferfi/4,getStringi/2,weightbvARB/1,weightsvARB/1,
  weightivARB/1,weightfvARB/1,weightdvARB/1,weightubvARB/1,weightusvARB/1,
  weightuivARB/1,vertexBlendARB/1,currentPaletteMatrixARB/1,matrixIndexubvARB/1,
  matrixIndexusvARB/1,matrixIndexuivARB/1,programStringARB/3,bindProgramARB/2,
  deleteProgramsARB/1,genProgramsARB/1,programEnvParameter4dARB/6,
  ...
  framebufferTextureFaceARB/5,vertexAttribDivisor/2,flushMappedBufferRange/3,
  texBufferARB/3,bindVertexArray/1,deleteVertexArrays/1,genVertexArrays/1,
  isVertexArray/1,resizeBuffersMESA/0,windowPos4dMESA/4,windowPos4dvMESA/1,
  windowPos4fMESA/4,windowPos4fvMESA/1,windowPos4iMESA/4,windowPos4ivMESA/1,
  windowPos4sMESA/4,windowPos4svMESA/1,depthBoundsEXT/2,stencilClearTagEXT/2]).
...
accum(Op,Value) ->
  wxe_util:cast(5017, <<Op:?GLenum,Value:?GLfloat>>).
...
alphaFunc(Func,Ref) ->
  wxe_util:cast(5018, <<Func:?GLenum,Ref:?GLclampf>>).
...
areTexturesResident(Textures) ->
  wxe_util:call(5019, <<(length(Textures)):?GLuint,
...
bindTexture(Target,Texture) ->
  wxe_util:cast(5022, <<Target:?GLenum,Texture:?GLuint>>).
...
bitmap(Width,Height,Xorig,Yorig,Xmove,Ymove,Bitmap) when  is_integer(Bitmap) ->
  wxe_util:cast(5023, <<Width:?GLsizei,Height:?GLsizei,Xorig:?GLfloat,Yorig:?GLfloat,Xmove:?GLfloat,Ymove:?GLfloat,Bitmap:?GLuint>>);
bitmap(Width,Height,Xorig,Yorig,Xmove,Ymove,Bitmap) ->
  wxe_util:send_bin(Bitmap),
  wxe_util:cast(5024, <<Width:?GLsizei,Height:?GLsizei,Xorig:?GLfloat,Yorig:?GLfloat,Xmove:?GLfloat,Ymove:?GLfloat>>).
...
clear(Mask) ->
  wxe_util:cast(5028, <<Mask:?GLbitfield>>).
...
clearAccum(Red,Green,Blue,Alpha) ->
  wxe_util:cast(5029, <<Red:?GLfloat,Green:?GLfloat,Blue:?GLfloat,Alpha:?GLfloat>>).
...
clipPlane(Plane,{E1,E2,E3,E4}) ->
  wxe_util:cast(5034, <<Plane:?GLenum,0:32,E1:?GLdouble,E2:?GLdouble,E3:?GLdouble,E4:?GLdouble>>).
...
color3b(Red,Green,Blue) ->
  wxe_util:cast(5035, <<Red:?GLbyte,Green:?GLbyte,Blue:?GLbyte>>).
...
color3d(Red,Green,Blue) ->
  wxe_util:cast(5036, <<Red:?GLdouble,Green:?GLdouble,Blue:?GLdouble>>).
...
color3f(Red,Green,Blue) ->
  wxe_util:cast(5037, <<Red:?GLfloat,Green:?GLfloat,Blue:?GLfloat>>).
...
color3i(Red,Green,Blue) ->
  wxe_util:cast(5038, <<Red:?GLint,Green:?GLint,Blue:?GLint>>).
...
color3s(Red,Green,Blue) ->
  wxe_util:cast(5039, <<Red:?GLshort,Green:?GLshort,Blue:?GLshort>>).
...
color3ub(Red,Green,Blue) ->
  wxe_util:cast(5040, <<Red:?GLubyte,Green:?GLubyte,Blue:?GLubyte>>).
...
color3ui(Red,Green,Blue) ->
  wxe_util:cast(5041, <<Red:?GLuint,Green:?GLuint,Blue:?GLuint>>).
...
color3us(Red,Green,Blue) ->
  wxe_util:cast(5042, <<Red:?GLushort,Green:?GLushort,Blue:?GLushort>>).
...
color4b(Red,Green,Blue,Alpha) ->
  wxe_util:cast(5043, <<Red:?GLbyte,Green:?GLbyte,Blue:?GLbyte,Alpha:?GLbyte>>).
...
color4d(Red,Green,Blue,Alpha) ->
  wxe_util:cast(5044, <<Red:?GLdouble,Green:?GLdouble,Blue:?GLdouble,Alpha:?GLdouble>>).
...
color4f(Red,Green,Blue,Alpha) ->
  wxe_util:cast(5045, <<Red:?GLfloat,Green:?GLfloat,Blue:?GLfloat,Alpha:?GLfloat>>).
...
color4i(Red,Green,Blue,Alpha) ->
  wxe_util:cast(5046, <<Red:?GLint,Green:?GLint,Blue:?GLint,Alpha:?GLint>>).
...
color4s(Red,Green,Blue,Alpha) ->
  wxe_util:cast(5047, <<Red:?GLshort,Green:?GLshort,Blue:?GLshort,Alpha:?GLshort>>).
...
color4ub(Red,Green,Blue,Alpha) ->
  wxe_util:cast(5048, <<Red:?GLubyte,Green:?GLubyte,Blue:?GLubyte,Alpha:?GLubyte>>).
...
color4ui(Red,Green,Blue,Alpha) ->
  wxe_util:cast(5049, <<Red:?GLuint,Green:?GLuint,Blue:?GLuint,Alpha:?GLuint>>).
...
color4us(Red,Green,Blue,Alpha) ->
  wxe_util:cast(5050, <<Red:?GLushort,Green:?GLushort,Blue:?GLushort,Alpha:?GLushort>>).
...
colorMask(Red,Green,Blue,Alpha) ->
  wxe_util:cast(5051, <<Red:?GLboolean,Green:?GLboolean,Blue:?GLboolean,Alpha:?GLboolean>>).
...
colorMaterial(Face,Mode) ->
  wxe_util:cast(5052, <<Face:?GLenum,Mode:?GLenum>>).
...
colorPointer(Size,Type,Stride,Pointer) when  is_integer(Pointer) ->
  wxe_util:cast(5053, <<Size:?GLint,Type:?GLenum,Stride:?GLsizei,Pointer:?GLuint>>);
colorPointer(Size,Type,Stride,Pointer) ->
  wxe_util:send_bin(Pointer),
  wxe_util:cast(5054, <<Size:?GLint,Type:?GLenum,Stride:?GLsizei>>).
...
copyPixels(X,Y,Width,Height,Type) ->
  wxe_util:cast(5055, <<X:?GLint,Y:?GLint,Width:?GLsizei,Height:?GLsizei,Type:?GLenum>>).
...
copyTexImage1D(Target,Level,InternalFormat,X,Y,Width,Border) ->
  wxe_util:cast(5056, <<Target:?GLenum,Level:?GLint,InternalFormat:?GLenum,X:?GLint,Y:?GLint,Width:?GLsizei,Border:?GLint>>).
...
copyTexImage2D(Target,Level,InternalFormat,X,Y,Width,Height,Border) ->
  wxe_util:cast(5057, <<Target:?GLenum,Level:?GLint,InternalFormat:?GLenum,X:?GLint,Y:?GLint,Width:?GLsizei,Height:?GLsizei,Border:?GLint>>).
...
copyTexSubImage1D(Target,Level,Xoffset,X,Y,Width) ->
  wxe_util:cast(5058, <<Target:?GLenum,Level:?GLint,Xoffset:?GLint,X:?GLint,Y:?GLint,Width:?GLsizei>>).
...
copyTexSubImage2D(Target,Level,Xoffset,Yoffset,X,Y,Width,Height) ->
  wxe_util:cast(5059, <<Target:?GLenum,Level:?GLint,Xoffset:?GLint,Yoffset:?GLint,X:?GLint,Y:?GLint,Width:?GLsizei,Height:?GLsizei>>).

%% @spec (Mode::enum()) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glCullFace.xml">external</a> documentation.
cullFace(Mode) ->
  wxe_util:cast(5060, <<Mode:?GLenum>>).
...
deleteLists(List,Range) ->
  wxe_util:cast(5061, <<List:?GLuint,Range:?GLsizei>>).
...
disableClientState(Array) ->
  wxe_util:cast(5067, <<Array:?GLenum>>).
...
drawElements(Mode,Count,Type,Indices) when  is_integer(Indices) ->
  wxe_util:cast(5070, <<Mode:?GLenum,Count:?GLsizei,Type:?GLenum,Indices:?GLuint>>);
drawElements(Mode,Count,Type,Indices) ->
  wxe_util:send_bin(Indices),
  wxe_util:cast(5071, <<Mode:?GLenum,Count:?GLsizei,Type:?GLenum>>).
...
drawPixels(Width,Height,Format,Type,Pixels) when  is_integer(Pixels) ->
  wxe_util:cast(5072, <<Width:?GLsizei,Height:?GLsizei,Format:?GLenum,Type:?GLenum,Pixels:?GLuint>>);
drawPixels(Width,Height,Format,Type,Pixels) ->
  wxe_util:send_bin(Pixels),
  wxe_util:cast(5073, <<Width:?GLsizei,Height:?GLsizei,Format:?GLenum,Type:?GLenum>>).

%% @spec (Flag::0|1) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glEdgeFlag.xml">external</a> documentation.
edgeFlag(Flag) ->
  wxe_util:cast(5074, <<Flag:?GLboolean>>).
...
edgeFlagPointer(Stride,Pointer) when  is_integer(Pointer) ->
  wxe_util:cast(5075, <<Stride:?GLsizei,Pointer:?GLuint>>);
edgeFlagPointer(Stride,Pointer) ->
  wxe_util:send_bin(Pointer),
  wxe_util:cast(5076, <<Stride:?GLsizei>>).
...
enableClientState(Array) ->
  wxe_util:cast(5078, <<Array:?GLenum>>).
...
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glEvalCoord.xml">external</a> documentation.
evalCoord2d(U,V) ->
  wxe_util:cast(5083, <<U:?GLdouble,V:?GLdouble>>).
...
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glEvalCoord.xml">external</a> documentation.
evalCoord2f(U,V) ->
  wxe_util:cast(5084, <<U:?GLfloat,V:?GLfloat>>).
...
feedbackBuffer(Size,Type,Buffer) ->
  ...
  wxe_util:call(5089, <<Size:?GLsizei,Type:?GLenum>>).
...
fogf(Pname,Param) ->
  wxe_util:cast(5092, <<Pname:?GLenum,Param:?GLfloat>>).

%% @spec (Pname::enum(),Params::{float()}) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glFog.xml">external</a> documentation.
fogfv(Pname,Params) ->
  wxe_util:cast(5093, <<Pname:?GLenum,(size(Params)):?GLuint,
      (<< <<C:?GLfloat>> ||C <- tuple_to_list(Params)>>)/binary,0:(((0+size(Params)) rem 2)*32)>>).

%% @spec (Pname::enum(),Param::integer()) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glFog.xml">external</a> documentation.
fogi(Pname,Param) ->
  wxe_util:cast(5094, <<Pname:?GLenum,Param:?GLint>>).

%% @spec (Pname::enum(),Params::{integer()}) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glFog.xml">external</a> documentation.
fogiv(Pname,Params) ->
  wxe_util:cast(5095, <<Pname:?GLenum,(size(Params)):?GLuint,
...
frontFace(Mode) ->
  wxe_util:cast(5096, <<Mode:?GLenum>>).
...
getLightfv(Light,Pname) ->
  wxe_util:call(5106, <<Light:?GLenum,Pname:?GLenum>>).

%% @spec (Light::enum(),Pname::enum()) -> {integer()}
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glGetLight.xml">external</a> documentation.
getLightiv(Light,Pname) ->
  wxe_util:call(5107, <<Light:?GLenum,Pname:?GLenum>>).
...
getMapdv(Target,Query,V) ->
  ...
  wxe_util:call(5108, <<Target:?GLenum,Query:?GLenum>>).

%% @spec (Target::enum(),Query::enum(),V::wx:wx_mem()) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glGetMap.xml">external</a> documentation.
getMapfv(Target,Query,V) ->
  wxe_util:send_bin(V#wx_mem.bin),
  wxe_util:call(5109, <<Target:?GLenum,Query:?GLenum>>).

%% @spec (Target::enum(),Query::enum(),V::wx:wx_mem()) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glGetMap.xml">external</a> documentation.
getMapiv(Target,Query,V) ->
  wxe_util:send_bin(V#wx_mem.bin),
  wxe_util:call(5110, <<Target:?GLenum,Query:?GLenum>>).
...
getMaterialfv(Face,Pname) ->
  wxe_util:call(5111, <<Face:?GLenum,Pname:?GLenum>>).

%% @spec (Face::enum(),Pname::enum()) -> {integer()}
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glGetMaterial.xml">external</a> documentation.
getMaterialiv(Face,Pname) ->
  wxe_util:call(5112, <<Face:?GLenum,Pname:?GLenum>>).
...
getPixelMapfv(Map,Values) ->
  ...
  wxe_util:call(5113, <<Map:?GLenum>>).

%% @spec (Map::enum(),Values::wx:wx_mem()) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glGetPixelMap.xml">external</a> documentation.
getPixelMapuiv(Map,Values) ->
  wxe_util:send_bin(Values#wx_mem.bin),
  wxe_util:call(5114, <<Map:?GLenum>>).

%% @spec (Map::enum(),Values::wx:wx_mem()) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glGetPixelMap.xml">external</a> documentation.
getPixelMapusv(Map,Values) ->
  wxe_util:send_bin(Values#wx_mem.bin),
  wxe_util:call(5115, <<Map:?GLenum>>).
...
getString(Name) ->
  wxe_util:call(5117, <<Name:?GLenum>>).
...
getTexEnvfv(Target,Pname) ->
  wxe_util:call(5118, <<Target:?GLenum,Pname:?GLenum>>).

%% @spec (Target::enum(),Pname::enum()) -> {integer()}
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glGetTexEnv.xml">external</a> documentation.
getTexEnviv(Target,Pname) ->
  wxe_util:call(5119, <<Target:?GLenum,Pname:?GLenum>>).
...
getTexGendv(Coord,Pname) ->
  wxe_util:call(5120, <<Coord:?GLenum,Pname:?GLenum>>).

%% @spec (Coord::enum(),Pname::enum()) -> {float()}
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glGetTexGen.xml">external</a> documentation.
getTexGenfv(Coord,Pname) ->
  wxe_util:call(5121, <<Coord:?GLenum,Pname:?GLenum>>).

%% @spec (Coord::enum(),Pname::enum()) -> {integer()}
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glGetTexGen.xml">external</a> documentation.
getTexGeniv(Coord,Pname) ->
  wxe_util:call(5122, <<Coord:?GLenum,Pname:?GLenum>>).
...
getTexImage(Target,Level,Format,Type,Pixels) ->
  ...
  wxe_util:call(5123, <<Target:?GLenum,Level:?GLint,Format:?GLenum,Type:?GLenum>>).
...
getTexLevelParameterfv(Target,Level,Pname) ->
  wxe_util:call(5124, <<Target:?GLenum,Level:?GLint,Pname:?GLenum>>).

%% @spec (Target::enum(),Level::integer(),Pname::enum()) -> {integer()}
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glGetTexLevelParameter.xml">external</a> documentation.
getTexLevelParameteriv(Target,Level,Pname) ->
  wxe_util:call(5125, <<Target:?GLenum,Level:?GLint,Pname:?GLenum>>).
...
indexPointer(Type,Stride,Pointer) when  is_integer(Pointer) ->
  wxe_util:cast(5130, <<Type:?GLenum,Stride:?GLsizei,Pointer:?GLuint>>);
indexPointer(Type,Stride,Pointer) ->
  wxe_util:send_bin(Pointer),
  wxe_util:cast(5131, <<Type:?GLenum,Stride:?GLsizei>>).

%% @spec (C::float()) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glIndex.xml">external</a> documentation.
indexd(C) ->
  wxe_util:cast(5132, <<C:?GLdouble>>).
...
lightf(Light,Pname,Param) ->
  wxe_util:cast(5147, <<Light:?GLenum,Pname:?GLenum,Param:?GLfloat>>).

%% @spec (Light::enum(),Pname::enum(),Params::{float()}) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glLight.xml">external</a> documentation.
lightfv(Light,Pname,Params) ->
  wxe_util:cast(5148, <<Light:?GLenum,Pname:?GLenum,(size(Params)):?GLuint,
      (<< <<C:?GLfloat>> ||C <- tuple_to_list(Params)>>)/binary,0:(((1+size(Params)) rem 2)*32)>>).

%% @spec (Light::enum(),Pname::enum(),Param::integer()) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glLight.xml">external</a> documentation.
lighti(Light,Pname,Param) ->
  wxe_util:cast(5149, <<Light:?GLenum,Pname:?GLenum,Param:?GLint>>).

%% @spec (Light::enum(),Pname::enum(),Params::{integer()}) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glLight.xml">external</a> documentation.
lightiv(Light,Pname,Params) ->
  wxe_util:cast(5150, <<Light:?GLenum,Pname:?GLenum,(size(Params)):?GLuint,
...
loadMatrixd({M1,M2,M3,M4,M5,M6,M7,M8,M9,M10,M11,M12,M13,M14,M15,M16}) ->
  wxe_util:cast(5155, <<M1:?GLdouble,M2:?GLdouble,M3:?GLdouble,M4:?GLdouble,M5:?GLdouble,M6:?GLdouble,M7:?GLdouble,M8:?GLdouble,M9:?GLdouble,M10:?GLdouble,M11:?GLdouble,M12:?GLdouble,M13:?GLdouble,M14:?GLdouble,M15:?GLdouble,M16:?GLdouble>>).

%% @spec (M::{float()}) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glLoadMatrix.xml">external</a> documentation.
loadMatrixf({M1,M2,M3,M4,M5,M6,M7,M8,M9,M10,M11,M12,M13,M14,M15,M16}) ->
  wxe_util:cast(5156, <<M1:?GLfloat,M2:?GLfloat,M3:?GLfloat,M4:?GLfloat,M5:?GLfloat,M6:?GLfloat,M7:?GLfloat,M8:?GLfloat,M9:?GLfloat,M10:?GLfloat,M11:?GLfloat,M12:?GLfloat,M13:?GLfloat,M14:?GLfloat,M15:?GLfloat,M16:?GLfloat>>).

%% @spec (Name::integer()) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glLoadName.xml">external</a> documentation.
loadName(Name) ->
  wxe_util:cast(5157, <<Name:?GLuint>>).

%% @spec (Opcode::enum()) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glLogicOp.xml">external</a> documentation.
logicOp(Opcode) ->
  wxe_util:cast(5158, <<Opcode:?GLenum>>).
...
map1d(Target,U1,U2,Stride,Order,Points) ->
  ...
  wxe_util:cast(5159, <<Target:?GLenum,0:32,U1:?GLdouble,U2:?GLdouble,Stride:?GLint,Order:?GLint>>).

%% @spec (Target::enum(),U1::float(),U2::float(),Stride::integer(),Order::integer(),Points::binary()) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glMap.xml">external</a> documentation.
map1f(Target,U1,U2,Stride,Order,Points) ->
  wxe_util:send_bin(Points),
  wxe_util:cast(5160, <<Target:?GLenum,U1:?GLfloat,U2:?GLfloat,Stride:?GLint,Order:?GLint>>).
...
map2d(Target,U1,U2,Ustride,Uorder,V1,V2,Vstride,Vorder,Points) ->
  wxe_util:send_bin(Points),
  wxe_util:cast(5161, <<Target:?GLenum,0:32,U1:?GLdouble,U2:?GLdouble,Ustride:?GLint,Uorder:?GLint,V1:?GLdouble,V2:?GLdouble,Vstride:?GLint,Vorder:?GLint>>).

%% @spec (Target::enum(),U1::float(),U2::float(),Ustride::integer(),Uorder::integer(),V1::float(),V2::float(),Vstride::integer(),Vorder::integer(),Points::binary()) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glMap.xml">external</a> documentation.
map2f(Target,U1,U2,Ustride,Uorder,V1,V2,Vstride,Vorder,Points) ->
  wxe_util:send_bin(Points),
  wxe_util:cast(5162, <<Target:?GLenum,U1:?GLfloat,U2:?GLfloat,Ustride:?GLint,Uorder:?GLint,V1:?GLfloat,V2:?GLfloat,Vstride:?GLint,Vorder:?GLint>>).
...
mapGrid1d(Un,U1,U2) ->
  wxe_util:cast(5163, <<Un:?GLint,0:32,U1:?GLdouble,U2:?GLdouble>>).

%% @spec (Un::integer(),U1::float(),U2::float()) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glMapGrid.xml">external</a> documentation.
mapGrid1f(Un,U1,U2) ->
  wxe_util:cast(5164, <<Un:?GLint,U1:?GLfloat,U2:?GLfloat>>).

%% @spec (Un::integer(),U1::float(),U2::float(),Vn::integer(),V1::float(),V2::float()) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glMapGrid.xml">external</a> documentation.
mapGrid2d(Un,U1,U2,Vn,V1,V2) ->
  wxe_util:cast(5165, <<Un:?GLint,0:32,U1:?GLdouble,U2:?GLdouble,Vn:?GLint,0:32,V1:?GLdouble,V2:?GLdouble>>).

%% @spec (Un::integer(),U1::float(),U2::float(),Vn::integer(),V1::float(),V2::float()) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glMapGrid.xml">external</a> documentation.
mapGrid2f(Un,U1,U2,Vn,V1,V2) ->
  wxe_util:cast(5166, <<Un:?GLint,U1:?GLfloat,U2:?GLfloat,Vn:?GLint,V1:?GLfloat,V2:?GLfloat>>).
...
multMatrixd({M1,M2,M3,M4,M5,M6,M7,M8,M9,M10,M11,M12,M13,M14,M15,M16}) ->
  wxe_util:cast(5172, <<M1:?GLdouble,M2:?GLdouble,M3:?GLdouble,M4:?GLdouble,M5:?GLdouble,M6:?GLdouble,M7:?GLdouble,M8:?GLdouble,M9:?GLdouble,M10:?GLdouble,M11:?GLdouble,M12:?GLdouble,M13:?GLdouble,M14:?GLdouble,M15:?GLdouble,M16:?GLdouble>>).

%% @spec (M::{float()}) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glMultMatrix.xml">external</a> documentation.
multMatrixf({M1,M2,M3,M4,M5,M6,M7,M8,M9,M10,M11,M12,M13,M14,M15,M16}) ->
  wxe_util:cast(5173, <<M1:?GLfloat,M2:?GLfloat,M3:?GLfloat,M4:?GLfloat,M5:?GLfloat,M6:?GLfloat,M7:?GLfloat,M8:?GLfloat,M9:?GLfloat,M10:?GLfloat,M11:?GLfloat,M12:?GLfloat,M13:?GLfloat,M14:?GLfloat,M15:?GLfloat,M16:?GLfloat>>).
...
newList(List,Mode) ->
  wxe_util:cast(5174, <<List:?GLuint,Mode:?GLenum>>).
...
normal3b(Nx,Ny,Nz) ->
  wxe_util:cast(5175, <<Nx:?GLbyte,Ny:?GLbyte,Nz:?GLbyte>>).
...
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glNormal.xml">external</a> documentation.
normal3d(Nx,Ny,Nz) ->
  wxe_util:cast(5176, <<Nx:?GLdouble,Ny:?GLdouble,Nz:?GLdouble>>).
...
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glNormal.xml">external</a> documentation.
normal3f(Nx,Ny,Nz) ->
  wxe_util:cast(5177, <<Nx:?GLfloat,Ny:?GLfloat,Nz:?GLfloat>>).
...
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glNormal.xml">external</a> documentation.
normal3i(Nx,Ny,Nz) ->
  wxe_util:cast(5178, <<Nx:?GLint,Ny:?GLint,Nz:?GLint>>).
...
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glNormal.xml">external</a> documentation.
normal3s(Nx,Ny,Nz) ->
  wxe_util:cast(5179, <<Nx:?GLshort,Ny:?GLshort,Nz:?GLshort>>).
...
normalPointer(Type,Stride,Pointer) when  is_integer(Pointer) ->
  wxe_util:cast(5180, <<Type:?GLenum,Stride:?GLsizei,Pointer:?GLuint>>);
normalPointer(Type,Stride,Pointer) ->
  wxe_util:send_bin(Pointer),
  wxe_util:cast(5181, <<Type:?GLenum,Stride:?GLsizei>>).

%% @spec (Left::float(),Right::float(),Bottom::float(),Top::float(),ZNear::float(),ZFar::float()) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glOrtho.xml">external</a> documentation.
ortho(Left,Right,Bottom,Top,ZNear,ZFar) ->
  wxe_util:cast(5182, <<Left:?GLdouble,Right:?GLdouble,Bottom:?GLdouble,Top:?GLdouble,ZNear:?GLdouble,ZFar:?GLdouble>>).

%% @spec (Token::float()) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glPassThrough.xml">external</a> documentation.
passThrough(Token) ->
  wxe_util:cast(5183, <<Token:?GLfloat>>).
...
pixelMapfv(Map,Mapsize,Values) ->
  ...
  wxe_util:cast(5184, <<Map:?GLenum,Mapsize:?GLsizei>>).

%% @spec (Map::enum(),Mapsize::integer(),Values::binary()) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glPixelMap.xml">external</a> documentation.
pixelMapuiv(Map,Mapsize,Values) ->
  wxe_util:send_bin(Values),
  wxe_util:cast(5185, <<Map:?GLenum,Mapsize:?GLsizei>>).

%% @spec (Map::enum(),Mapsize::integer(),Values::binary()) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glPixelMap.xml">external</a> documentation.
pixelMapusv(Map,Mapsize,Values) ->
  wxe_util:send_bin(Values),
  wxe_util:cast(5186, <<Map:?GLenum,Mapsize:?GLsizei>>).

%% @spec (Pname::enum(),Param::float()) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glPixelStore.xml">external</a> documentation.
pixelStoref(Pname,Param) ->
  wxe_util:cast(5187, <<Pname:?GLenum,Param:?GLfloat>>).

%% @spec (Pname::enum(),Param::integer()) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glPixelStore.xml">external</a> documentation.
pixelStorei(Pname,Param) ->
  wxe_util:cast(5188, <<Pname:?GLenum,Param:?GLint>>).

%% @spec (Pname::enum(),Param::float()) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glPixelTransfer.xml">external</a> documentation.
pixelTransferf(Pname,Param) ->
  wxe_util:cast(5189, <<Pname:?GLenum,Param:?GLfloat>>).

%% @spec (Pname::enum(),Param::integer()) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glPixelTransfer.xml">external</a> documentation.
pixelTransferi(Pname,Param) ->
  wxe_util:cast(5190, <<Pname:?GLenum,Param:?GLint>>).
...
polygonOffset(Factor,Units) ->
  wxe_util:cast(5194, <<Factor:?GLfloat,Units:?GLfloat>>).
...
prioritizeTextures(Textures,Priorities) ->
  wxe_util:cast(5200, <<(length(Textures)):?GLuint,
...
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glRasterPos.xml">external</a> documentation.
rasterPos2f(X,Y) ->
  wxe_util:cast(5206, <<X:?GLfloat,Y:?GLfloat>>).
...
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glRasterPos.xml">external</a> documentation.
rasterPos2i(X,Y) ->
  wxe_util:cast(5207, <<X:?GLint,Y:?GLint>>).
...
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glRasterPos.xml">external</a> documentation.
rasterPos2s(X,Y) ->
  wxe_util:cast(5208, <<X:?GLshort,Y:?GLshort>>).
...
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glRasterPos.xml">external</a> documentation.
rasterPos3d(X,Y,Z) ->
  wxe_util:cast(5209, <<X:?GLdouble,Y:?GLdouble,Z:?GLdouble>>).
...
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glRasterPos.xml">external</a> documentation.
rasterPos3f(X,Y,Z) ->
  wxe_util:cast(5210, <<X:?GLfloat,Y:?GLfloat,Z:?GLfloat>>).
...
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glRasterPos.xml">external</a> documentation.
rasterPos3i(X,Y,Z) ->
  wxe_util:cast(5211, <<X:?GLint,Y:?GLint,Z:?GLint>>).
...
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glRasterPos.xml">external</a> documentation.
rasterPos3s(X,Y,Z) ->
  wxe_util:cast(5212, <<X:?GLshort,Y:?GLshort,Z:?GLshort>>).
...
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glRasterPos.xml">external</a> documentation.
rasterPos4d(X,Y,Z,W) ->
  wxe_util:cast(5213, <<X:?GLdouble,Y:?GLdouble,Z:?GLdouble,W:?GLdouble>>).
...
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glRasterPos.xml">external</a> documentation.
rasterPos4f(X,Y,Z,W) ->
  wxe_util:cast(5214, <<X:?GLfloat,Y:?GLfloat,Z:?GLfloat,W:?GLfloat>>).
...
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glRasterPos.xml">external</a> documentation.
rasterPos4i(X,Y,Z,W) ->
  wxe_util:cast(5215, <<X:?GLint,Y:?GLint,Z:?GLint,W:?GLint>>).
...
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glRasterPos.xml">external</a> documentation.
rasterPos4s(X,Y,Z,W) ->
  wxe_util:cast(5216, <<X:?GLshort,Y:?GLshort,Z:?GLshort,W:?GLshort>>).
...
readBuffer(Mode) ->
  wxe_util:cast(5217, <<Mode:?GLenum>>).
...
readPixels(X,Y,Width,Height,Format,Type,Pixels) ->
  wxe_util:send_bin(Pixels#wx_mem.bin),
  wxe_util:call(5218, <<X:?GLint,Y:?GLint,Width:?GLsizei,Height:?GLsizei,Format:?GLenum,Type:?GLenum>>).
...
rectd(X1,Y1,X2,Y2) ->
  wxe_util:cast(5219, <<X1:?GLdouble,Y1:?GLdouble,X2:?GLdouble,Y2:?GLdouble>>).

%% @spec (V1::{float()},V2::{float()}) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glRect.xml">external</a> documentation.
rectdv({V1,V2},{V1,V2}) ->
  wxe_util:cast(5220, <<V1:?GLdouble,V2:?GLdouble,V1:?GLdouble,V2:?GLdouble>>).

%% @spec (X1::float(),Y1::float(),X2::float(),Y2::float()) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glRect.xml">external</a> documentation.
rectf(X1,Y1,X2,Y2) ->
  wxe_util:cast(5221, <<X1:?GLfloat,Y1:?GLfloat,X2:?GLfloat,Y2:?GLfloat>>).

%% @spec (V1::{float()},V2::{float()}) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glRect.xml">external</a> documentation.
rectfv({V1,V2},{V1,V2}) ->
  wxe_util:cast(5222, <<V1:?GLfloat,V2:?GLfloat,V1:?GLfloat,V2:?GLfloat>>).

%% @spec (X1::integer(),Y1::integer(),X2::integer(),Y2::integer()) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glRect.xml">external</a> documentation.
recti(X1,Y1,X2,Y2) ->
  wxe_util:cast(5223, <<X1:?GLint,Y1:?GLint,X2:?GLint,Y2:?GLint>>).

%% @spec (V1::{integer()},V2::{integer()}) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glRect.xml">external</a> documentation.
rectiv({V1,V2},{V1,V2}) ->
  wxe_util:cast(5224, <<V1:?GLint,V2:?GLint,V1:?GLint,V2:?GLint>>).

%% @spec (X1::integer(),Y1::integer(),X2::integer(),Y2::integer()) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glRect.xml">external</a> documentation.
rects(X1,Y1,X2,Y2) ->
  wxe_util:cast(5225, <<X1:?GLshort,Y1:?GLshort,X2:?GLshort,Y2:?GLshort>>).

%% @spec (V1::{integer()},V2::{integer()}) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glRect.xml">external</a> documentation.
rectsv({V1,V2},{V1,V2}) ->
  wxe_util:cast(5226, <<V1:?GLshort,V2:?GLshort,V1:?GLshort,V2:?GLshort>>).

%% @spec (Mode::enum()) -> integer()
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glRenderMode.xml">external</a> documentation.
renderMode(Mode) ->
  wxe_util:call(5227, <<Mode:?GLenum>>).
...
rotated(Angle,X,Y,Z) ->
  wxe_util:cast(5228, <<Angle:?GLdouble,X:?GLdouble,Y:?GLdouble,Z:?GLdouble>>).

%% @spec (Angle::float(),X::float(),Y::float(),Z::float()) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glRotate.xml">external</a> documentation.
rotatef(Angle,X,Y,Z) ->
  wxe_util:cast(5229, <<Angle:?GLfloat,X:?GLfloat,Y:?GLfloat,Z:?GLfloat>>).

%% @spec (X::float(),Y::float(),Z::float()) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glScale.xml">external</a> documentation.
scaled(X,Y,Z) ->
  wxe_util:cast(5230, <<X:?GLdouble,Y:?GLdouble,Z:?GLdouble>>).

%% @spec (X::float(),Y::float(),Z::float()) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glScale.xml">external</a> documentation.
scalef(X,Y,Z) ->
  wxe_util:cast(5231, <<X:?GLfloat,Y:?GLfloat,Z:?GLfloat>>).
...
scissor(X,Y,Width,Height) ->
  wxe_util:cast(5232, <<X:?GLint,Y:?GLint,Width:?GLsizei,Height:?GLsizei>>).
...
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glTexCoord.xml">external</a> documentation.
texCoord2d(S,T) ->
  wxe_util:cast(5242, <<S:?GLdouble,T:?GLdouble>>).
...
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glTexCoord.xml">external</a> documentation.
texCoord2f(S,T) ->
  wxe_util:cast(5243, <<S:?GLfloat,T:?GLfloat>>).
...
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glTexCoord.xml">external</a> documentation.
texCoord2i(S,T) ->
  wxe_util:cast(5244, <<S:?GLint,T:?GLint>>).
...
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glTexCoord.xml">external</a> documentation.
texCoord2s(S,T) ->
  wxe_util:cast(5245, <<S:?GLshort,T:?GLshort>>).
...
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glTexCoord.xml">external</a> documentation.
texCoord3d(S,T,R) ->
  wxe_util:cast(5246, <<S:?GLdouble,T:?GLdouble,R:?GLdouble>>).
...
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glTexCoord.xml">external</a> documentation.
texCoord3f(S,T,R) ->
  wxe_util:cast(5247, <<S:?GLfloat,T:?GLfloat,R:?GLfloat>>).
...
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glTexCoord.xml">external</a> documentation.
texCoord3i(S,T,R) ->
  wxe_util:cast(5248, <<S:?GLint,T:?GLint,R:?GLint>>).
...
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glTexCoord.xml">external</a> documentation.
texCoord3s(S,T,R) ->
  wxe_util:cast(5249, <<S:?GLshort,T:?GLshort,R:?GLshort>>).
...
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glTexCoord.xml">external</a> documentation.
texCoord4d(S,T,R,Q) ->
  wxe_util:cast(5250, <<S:?GLdouble,T:?GLdouble,R:?GLdouble,Q:?GLdouble>>).
...
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glTexCoord.xml">external</a> documentation.
texCoord4f(S,T,R,Q) ->
  wxe_util:cast(5251, <<S:?GLfloat,T:?GLfloat,R:?GLfloat,Q:?GLfloat>>).
...
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glTexCoord.xml">external</a> documentation.
texCoord4i(S,T,R,Q) ->
  wxe_util:cast(5252, <<S:?GLint,T:?GLint,R:?GLint,Q:?GLint>>).
...
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glTexCoord.xml">external</a> documentation.
texCoord4s(S,T,R,Q) ->
  wxe_util:cast(5253, <<S:?GLshort,T:?GLshort,R:?GLshort,Q:?GLshort>>).
...
texCoordPointer(Size,Type,Stride,Pointer) when  is_integer(Pointer) ->
  wxe_util:cast(5254, <<Size:?GLint,Type:?GLenum,Stride:?GLsizei,Pointer:?GLuint>>);
texCoordPointer(Size,Type,Stride,Pointer) ->
  wxe_util:send_bin(Pointer),
  wxe_util:cast(5255, <<Size:?GLint,Type:?GLenum,Stride:?GLsizei>>).
...
texEnvf(Target,Pname,Param) ->
  wxe_util:cast(5256, <<Target:?GLenum,Pname:?GLenum,Param:?GLfloat>>).
...
texEnvfv(Target,Pname,Params) ->
  wxe_util:cast(5257, <<Target:?GLenum,Pname:?GLenum,(size(Params)):?GLuint,
      (<< <<C:?GLfloat>> ||C <- tuple_to_list(Params)>>)/binary,0:(((1+size(Params)) rem 2)*32)>>).
...
texEnvi(Target,Pname,Param) ->
  wxe_util:cast(5258, <<Target:?GLenum,Pname:?GLenum,Param:?GLint>>).

%% @spec (Target::enum(),Pname::enum(),Params::{integer()}) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glTexEnv.xml">external</a> documentation.
texEnviv(Target,Pname,Params) ->
  wxe_util:cast(5259, <<Target:?GLenum,Pname:?GLenum,(size(Params)):?GLuint,
      (<< <<C:?GLint>> ||C <- tuple_to_list(Params)>>)/binary,0:(((1+size(Params)) rem 2)*32)>>).
...
texGend(Coord,Pname,Param) ->
  wxe_util:cast(5260, <<Coord:?GLenum,Pname:?GLenum,Param:?GLdouble>>).

%% @spec (Coord::enum(),Pname::enum(),Params::{float()}) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glTexGen.xml">external</a> documentation.
texGendv(Coord,Pname,Params) ->
  wxe_util:cast(5261, <<Coord:?GLenum,Pname:?GLenum,(size(Params)):?GLuint,0:32,
      (<< <<C:?GLdouble>> ||C <- tuple_to_list(Params)>>)/binary>>).

%% @spec (Coord::enum(),Pname::enum(),Param::float()) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glTexGen.xml">external</a> documentation.
texGenf(Coord,Pname,Param) ->
  wxe_util:cast(5262, <<Coord:?GLenum,Pname:?GLenum,Param:?GLfloat>>).

%% @spec (Coord::enum(),Pname::enum(),Params::{float()}) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glTexGen.xml">external</a> documentation.
texGenfv(Coord,Pname,Params) ->
  wxe_util:cast(5263, <<Coord:?GLenum,Pname:?GLenum,(size(Params)):?GLuint,
      (<< <<C:?GLfloat>> ||C <- tuple_to_list(Params)>>)/binary,0:(((1+size(Params)) rem 2)*32)>>).

%% @spec (Coord::enum(),Pname::enum(),Param::integer()) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glTexGen.xml">external</a> documentation.
texGeni(Coord,Pname,Param) ->
  wxe_util:cast(5264, <<Coord:?GLenum,Pname:?GLenum,Param:?GLint>>).

%% @spec (Coord::enum(),Pname::enum(),Params::{integer()}) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glTexGen.xml">external</a> documentation.
texGeniv(Coord,Pname,Params) ->
  wxe_util:cast(5265, <<Coord:?GLenum,Pname:?GLenum,(size(Params)):?GLuint,
      (<< <<C:?GLint>> ||C <- tuple_to_list(Params)>>)/binary,0:(((1+size(Params)) rem 2)*32)>>).
...
texImage1D(Target,Level,Internalformat,Width,Border,Format,Type,Pixels) when  is_integer(Pixels) ->
  wxe_util:cast(5266, <<Target:?GLenum,Level:?GLint,Internalformat:?GLint,Width:?GLsizei,Border:?GLint,Format:?GLenum,Type:?GLenum,Pixels:?GLuint>>);
texImage1D(Target,Level,Internalformat,Width,Border,Format,Type,Pixels) ->
  wxe_util:send_bin(Pixels),
  wxe_util:cast(5267, <<Target:?GLenum,Level:?GLint,Internalformat:?GLint,Width:?GLsizei,Border:?GLint,Format:?GLenum,Type:?GLenum>>).
...
texImage2D(Target,Level,Internalformat,Width,Height,Border,Format,Type,Pixels) when  is_integer(Pixels) ->
  wxe_util:cast(5268, <<Target:?GLenum,Level:?GLint,Internalformat:?GLint,Width:?GLsizei,Height:?GLsizei,Border:?GLint,Format:?GLenum,Type:?GLenum,Pixels:?GLuint>>);
texImage2D(Target,Level,Internalformat,Width,Height,Border,Format,Type,Pixels) ->
  wxe_util:send_bin(Pixels),
  wxe_util:cast(5269, <<Target:?GLenum,Level:?GLint,Internalformat:?GLint,Width:?GLsizei,Height:?GLsizei,Border:?GLint,Format:?GLenum,Type:?GLenum>>).

%% @spec (Target::enum(),Pname::enum(),Param::float()) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glTexParameter.xml">external</a> documentation.
texParameterf(Target,Pname,Param) ->
  wxe_util:cast(5270, <<Target:?GLenum,Pname:?GLenum,Param:?GLfloat>>).

%% @spec (Target::enum(),Pname::enum(),Params::{float()}) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glTexParameter.xml">external</a> documentation.
texParameterfv(Target,Pname,Params) ->
  wxe_util:cast(5271, <<Target:?GLenum,Pname:?GLenum,(size(Params)):?GLuint,
      (<< <<C:?GLfloat>> ||C <- tuple_to_list(Params)>>)/binary,0:(((1+size(Params)) rem 2)*32)>>).

%% @spec (Target::enum(),Pname::enum(),Param::integer()) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glTexParameter.xml">external</a> documentation.
texParameteri(Target,Pname,Param) ->
  wxe_util:cast(5272, <<Target:?GLenum,Pname:?GLenum,Param:?GLint>>).

%% @spec (Target::enum(),Pname::enum(),Params::{integer()}) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glTexParameter.xml">external</a> documentation.
texParameteriv(Target,Pname,Params) ->
  wxe_util:cast(5273, <<Target:?GLenum,Pname:?GLenum,(size(Params)):?GLuint,
      (<< <<C:?GLint>> ||C <- tuple_to_list(Params)>>)/binary,0:(((1+size(Params)) rem 2)*32)>>).
...
texSubImage1D(Target,Level,Xoffset,Width,Format,Type,Pixels) when  is_integer(Pixels) ->
  wxe_util:cast(5274, <<Target:?GLenum,Level:?GLint,Xoffset:?GLint,Width:?GLsizei,Format:?GLenum,Type:?GLenum,Pixels:?GLuint>>);
texSubImage1D(Target,Level,Xoffset,Width,Format,Type,Pixels) ->
  wxe_util:send_bin(Pixels),
  wxe_util:cast(5275, <<Target:?GLenum,Level:?GLint,Xoffset:?GLint,Width:?GLsizei,Format:?GLenum,Type:?GLenum>>).
...
texSubImage2D(Target,Level,Xoffset,Yoffset,Width,Height,Format,Type,Pixels) when  is_integer(Pixels) ->
  wxe_util:cast(5276, <<Target:?GLenum,Level:?GLint,Xoffset:?GLint,Yoffset:?GLint,Width:?GLsizei,Height:?GLsizei,Format:?GLenum,Type:?GLenum,Pixels:?GLuint>>);
texSubImage2D(Target,Level,Xoffset,Yoffset,Width,Height,Format,Type,Pixels) ->
  wxe_util:send_bin(Pixels),
  wxe_util:cast(5277, <<Target:?GLenum,Level:?GLint,Xoffset:?GLint,Yoffset:?GLint,Width:?GLsizei,Height:?GLsizei,Format:?GLenum,Type:?GLenum>>).

%% @spec (X::float(),Y::float(),Z::float()) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glTranslate.xml">external</a> documentation.
translated(X,Y,Z) ->
  wxe_util:cast(5278, <<X:?GLdouble,Y:?GLdouble,Z:?GLdouble>>).

%% @spec (X::float(),Y::float(),Z::float()) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glTranslate.xml">external</a> documentation.
translatef(X,Y,Z) ->
  wxe_util:cast(5279, <<X:?GLfloat,Y:?GLfloat,Z:?GLfloat>>).

%% @spec (X::float(),Y::float()) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glVertex.xml">external</a> documentation.
vertex2d(X,Y) ->
  wxe_util:cast(5280, <<X:?GLdouble,Y:?GLdouble>>).
...
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glVertex.xml">external</a> documentation.
vertex2f(X,Y) ->
  wxe_util:cast(5281, <<X:?GLfloat,Y:?GLfloat>>).
...
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glVertex.xml">external</a> documentation.
vertex2i(X,Y) ->
  wxe_util:cast(5282, <<X:?GLint,Y:?GLint>>).
...
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glVertex.xml">external</a> documentation.
vertex2s(X,Y) ->
  wxe_util:cast(5283, <<X:?GLshort,Y:?GLshort>>).
...
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glVertex.xml">external</a> documentation.
vertex3d(X,Y,Z) ->
  wxe_util:cast(5284, <<X:?GLdouble,Y:?GLdouble,Z:?GLdouble>>).
...
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glVertex.xml">external</a> documentation.
vertex3f(X,Y,Z) ->
  wxe_util:cast(5285, <<X:?GLfloat,Y:?GLfloat,Z:?GLfloat>>).
...
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glVertex.xml">external</a> documentation.
vertex3i(X,Y,Z) ->
  wxe_util:cast(5286, <<X:?GLint,Y:?GLint,Z:?GLint>>).
...
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glVertex.xml">external</a> documentation.
vertex3s(X,Y,Z) ->
  wxe_util:cast(5287, <<X:?GLshort,Y:?GLshort,Z:?GLshort>>).
...
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glVertex.xml">external</a> documentation.
vertex4d(X,Y,Z,W) ->
  wxe_util:cast(5288, <<X:?GLdouble,Y:?GLdouble,Z:?GLdouble,W:?GLdouble>>).
...
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glVertex.xml">external</a> documentation.
vertex4f(X,Y,Z,W) ->
  wxe_util:cast(5289, <<X:?GLfloat,Y:?GLfloat,Z:?GLfloat,W:?GLfloat>>).
...
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glVertex.xml">external</a> documentation.
vertex4i(X,Y,Z,W) ->
  wxe_util:cast(5290, <<X:?GLint,Y:?GLint,Z:?GLint,W:?GLint>>).
...
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glVertex.xml">external</a> documentation.
vertex4s(X,Y,Z,W) ->
  wxe_util:cast(5291, <<X:?GLshort,Y:?GLshort,Z:?GLshort,W:?GLshort>>).
...
drawRangeElements(Mode,Start,End,Count,Type,Indices) when  is_integer(Indices) ->
  wxe_util:cast(5297, <<Mode:?GLenum,Start:?GLuint,End:?GLuint,Count:?GLsizei,Type:?GLenum,Indices:?GLuint>>);
drawRangeElements(Mode,Start,End,Count,Type,Indices) ->
  wxe_util:send_bin(Indices),
  wxe_util:cast(5298, <<Mode:?GLenum,Start:?GLuint,End:?GLuint,Count:?GLsizei,Type:?GLenum>>).
...
colorTable(Target,Internalformat,Width,Format,Type,Table) when  is_integer(Table) ->
  wxe_util:cast(5299, <<Target:?GLenum,Internalformat:?GLenum,Width:?GLsizei,Format:?GLenum,Type:?GLenum,Table:?GLuint>>);
colorTable(Target,Internalformat,Width,Format,Type,Table) ->
  wxe_util:send_bin(Table),
  wxe_util:cast(5300, <<Target:?GLenum,Internalformat:?GLenum,Width:?GLsizei,Format:?GLenum,Type:?GLenum>>).
...
colorTableParameterfv(Target,Pname,{P1,P2,P3,P4}) ->
  wxe_util:cast(5301, <<Target:?GLenum,Pname:?GLenum,P1:?GLfloat,P2:?GLfloat,P3:?GLfloat,P4:?GLfloat>>).

%% @spec (Target::enum(),Pname::enum(),Params::{integer()}) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glColorTableParameter.xml">external</a> documentation.
colorTableParameteriv(Target,Pname,{P1,P2,P3,P4}) ->
  wxe_util:cast(5302, <<Target:?GLenum,Pname:?GLenum,P1:?GLint,P2:?GLint,P3:?GLint,P4:?GLint>>).
...
copyColorTable(Target,Internalformat,X,Y,Width) ->
  wxe_util:cast(5303, <<Target:?GLenum,Internalformat:?GLenum,X:?GLint,Y:?GLint,Width:?GLsizei>>).
...
getColorTable(Target,Format,Type,Table) ->
  ...
  wxe_util:call(5304, <<Target:?GLenum,Format:?GLenum,Type:?GLenum>>).
...
getColorTableParameterfv(Target,Pname) ->
  wxe_util:call(5305, <<Target:?GLenum,Pname:?GLenum>>).

%% @spec (Target::enum(),Pname::enum()) -> {integer()}
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glGetColorTableParameter.xml">external</a> documentation.
getColorTableParameteriv(Target,Pname) ->
  wxe_util:call(5306, <<Target:?GLenum,Pname:?GLenum>>).
...
colorSubTable(Target,Start,Count,Format,Type,Data) when  is_integer(Data) ->
  wxe_util:cast(5307, <<Target:?GLenum,Start:?GLsizei,Count:?GLsizei,Format:?GLenum,Type:?GLenum,Data:?GLuint>>);
colorSubTable(Target,Start,Count,Format,Type,Data) ->
  wxe_util:send_bin(Data),
  wxe_util:cast(5308, <<Target:?GLenum,Start:?GLsizei,Count:?GLsizei,Format:?GLenum,Type:?GLenum>>).
...
copyColorSubTable(Target,Start,X,Y,Width) ->
  wxe_util:cast(5309, <<Target:?GLenum,Start:?GLsizei,X:?GLint,Y:?GLint,Width:?GLsizei>>).
...
convolutionFilter1D(Target,Internalformat,Width,Format,Type,Image) when  is_integer(Image) ->
  wxe_util:cast(5310, <<Target:?GLenum,Internalformat:?GLenum,Width:?GLsizei,Format:?GLenum,Type:?GLenum,Image:?GLuint>>);
convolutionFilter1D(Target,Internalformat,Width,Format,Type,Image) ->
  wxe_util:send_bin(Image),
  wxe_util:cast(5311, <<Target:?GLenum,Internalformat:?GLenum,Width:?GLsizei,Format:?GLenum,Type:?GLenum>>).
...
convolutionFilter2D(Target,Internalformat,Width,Height,Format,Type,Image) when  is_integer(Image) ->
  wxe_util:cast(5312, <<Target:?GLenum,Internalformat:?GLenum,Width:?GLsizei,Height:?GLsizei,Format:?GLenum,Type:?GLenum,Image:?GLuint>>);
convolutionFilter2D(Target,Internalformat,Width,Height,Format,Type,Image) ->
  wxe_util:send_bin(Image),
  wxe_util:cast(5313, <<Target:?GLenum,Internalformat:?GLenum,Width:?GLsizei,Height:?GLsizei,Format:?GLenum,Type:?GLenum>>).

%% @spec (Target::enum(),Pname::enum(),Params::{float()}) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glConvolutionParameter.xml">external</a> documentation.
convolutionParameterf(Target,Pname,Params) ->
  wxe_util:cast(5314, <<Target:?GLenum,Pname:?GLenum,(size(Params)):?GLuint,
      (<< <<C:?GLfloat>> ||C <- tuple_to_list(Params)>>)/binary,0:(((1+size(Params)) rem 2)*32)>>).
...
convolutionParameteri(Target,Pname,Params) ->
  wxe_util:cast(5315, <<Target:?GLenum,Pname:?GLenum,(size(Params)):?GLuint,
      (<< <<C:?GLint>> ||C <- tuple_to_list(Params)>>)/binary,0:(((1+size(Params)) rem 2)*32)>>).
...
copyConvolutionFilter1D(Target,Internalformat,X,Y,Width) ->
  wxe_util:cast(5316, <<Target:?GLenum,Internalformat:?GLenum,X:?GLint,Y:?GLint,Width:?GLsizei>>).
...
copyConvolutionFilter2D(Target,Internalformat,X,Y,Width,Height) ->
  wxe_util:cast(5317, <<Target:?GLenum,Internalformat:?GLenum,X:?GLint,Y:?GLint,Width:?GLsizei,Height:?GLsizei>>).
...
getConvolutionFilter(Target,Format,Type,Image) ->
  ...
  wxe_util:call(5318, <<Target:?GLenum,Format:?GLenum,Type:?GLenum>>).
...
getConvolutionParameterfv(Target,Pname) ->
  wxe_util:call(5319, <<Target:?GLenum,Pname:?GLenum>>).

%% @spec (Target::enum(),Pname::enum()) -> {integer()}
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glGetConvolutionParameter.xml">external</a> documentation.
getConvolutionParameteriv(Target,Pname) ->
  wxe_util:call(5320, <<Target:?GLenum,Pname:?GLenum>>).
...
separableFilter2D(Target,Internalformat,Width,Height,Format,Type,Row,Column) when  is_integer(Row), is_integer(Column) ->
  wxe_util:cast(5321, <<Target:?GLenum,Internalformat:?GLenum,Width:?GLsizei,Height:?GLsizei,Format:?GLenum,Type:?GLenum,Row:?GLuint,Column:?GLuint>>);
separableFilter2D(Target,Internalformat,Width,Height,Format,Type,Row,Column) ->
  wxe_util:send_bin(Row),
  wxe_util:send_bin(Column),
  wxe_util:cast(5322, <<Target:?GLenum,Internalformat:?GLenum,Width:?GLsizei,Height:?GLsizei,Format:?GLenum,Type:?GLenum>>).
...
getHistogram(Target,Reset,Format,Type,Values) ->
  wxe_util:send_bin(Values#wx_mem.bin),
  wxe_util:call(5323, <<Target:?GLenum,Reset:?GLboolean,0:24,Format:?GLenum,Type:?GLenum>>).
...
getHistogramParameterfv(Target,Pname) ->
  wxe_util:call(5324, <<Target:?GLenum,Pname:?GLenum>>).

%% @spec (Target::enum(),Pname::enum()) -> {integer()}
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glGetHistogramParameter.xml">external</a> documentation.
getHistogramParameteriv(Target,Pname) ->
  wxe_util:call(5325, <<Target:?GLenum,Pname:?GLenum>>).
...
getMinmax(Target,Reset,Format,Type,Values) ->
  wxe_util:send_bin(Values#wx_mem.bin),
  wxe_util:call(5326, <<Target:?GLenum,Reset:?GLboolean,0:24,Format:?GLenum,Type:?GLenum>>).
...
getMinmaxParameterfv(Target,Pname) ->
  wxe_util:call(5327, <<Target:?GLenum,Pname:?GLenum>>).

%% @spec (Target::enum(),Pname::enum()) -> {integer()}
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glGetMinmaxParameter.xml">external</a> documentation.
getMinmaxParameteriv(Target,Pname) ->
  wxe_util:call(5328, <<Target:?GLenum,Pname:?GLenum>>).
...
histogram(Target,Width,Internalformat,Sink) ->
  wxe_util:cast(5329, <<Target:?GLenum,Width:?GLsizei,Internalformat:?GLenum,Sink:?GLboolean>>).
...
texImage3D(Target,Level,Internalformat,Width,Height,Depth,Border,Format,Type,Pixels) when  is_integer(Pixels) ->
  wxe_util:cast(5333, <<Target:?GLenum,Level:?GLint,Internalformat:?GLint,Width:?GLsizei,Height:?GLsizei,Depth:?GLsizei,Border:?GLint,Format:?GLenum,Type:?GLenum,Pixels:?GLuint>>);
texImage3D(Target,Level,Internalformat,Width,Height,Depth,Border,Format,Type,Pixels) ->
  wxe_util:send_bin(Pixels),
  wxe_util:cast(5334, <<Target:?GLenum,Level:?GLint,Internalformat:?GLint,Width:?GLsizei,Height:?GLsizei,Depth:?GLsizei,Border:?GLint,Format:?GLenum,Type:?GLenum>>).
...
texSubImage3D(Target,Level,Xoffset,Yoffset,Zoffset,Width,Height,Depth,Format,Type,Pixels) when  is_integer(Pixels) ->
  wxe_util:cast(5335, <<Target:?GLenum,Level:?GLint,Xoffset:?GLint,Yoffset:?GLint,Zoffset:?GLint,Width:?GLsizei,Height:?GLsizei,Depth:?GLsizei,Format:?GLenum,Type:?GLenum,Pixels:?GLuint>>);
texSubImage3D(Target,Level,Xoffset,Yoffset,Zoffset,Width,Height,Depth,Format,Type,Pixels) ->
  wxe_util:send_bin(Pixels),
  wxe_util:cast(5336, <<Target:?GLenum,Level:?GLint,Xoffset:?GLint,Yoffset:?GLint,Zoffset:?GLint,Width:?GLsizei,Height:?GLsizei,Depth:?GLsizei,Format:?GLenum,Type:?GLenum>>).
...
copyTexSubImage3D(Target,Level,Xoffset,Yoffset,Zoffset,X,Y,Width,Height) ->
  wxe_util:cast(5337, <<Target:?GLenum,Level:?GLint,Xoffset:?GLint,Yoffset:?GLint,Zoffset:?GLint,X:?GLint,Y:?GLint,Width:?GLsizei,Height:?GLsizei>>).
...
multiTexCoord1d(Target,S) ->
  wxe_util:cast(5340, <<Target:?GLenum,0:32,S:?GLdouble>>).
...
multiTexCoord1f(Target,S) ->
  wxe_util:cast(5341, <<Target:?GLenum,S:?GLfloat>>).
...
multiTexCoord1i(Target,S) ->
  wxe_util:cast(5342, <<Target:?GLenum,S:?GLint>>).
...
multiTexCoord1s(Target,S) ->
  wxe_util:cast(5343, <<Target:?GLenum,S:?GLshort>>).
...
multiTexCoord2d(Target,S,T) ->
  wxe_util:cast(5344, <<Target:?GLenum,0:32,S:?GLdouble,T:?GLdouble>>).
...
multiTexCoord2f(Target,S,T) ->
  wxe_util:cast(5345, <<Target:?GLenum,S:?GLfloat,T:?GLfloat>>).
...
multiTexCoord2i(Target,S,T) ->
  wxe_util:cast(5346, <<Target:?GLenum,S:?GLint,T:?GLint>>).
...
multiTexCoord2s(Target,S,T) ->
  wxe_util:cast(5347, <<Target:?GLenum,S:?GLshort,T:?GLshort>>).
...
multiTexCoord3d(Target,S,T,R) ->
  wxe_util:cast(5348, <<Target:?GLenum,0:32,S:?GLdouble,T:?GLdouble,R:?GLdouble>>).
...
multiTexCoord3f(Target,S,T,R) ->
  wxe_util:cast(5349, <<Target:?GLenum,S:?GLfloat,T:?GLfloat,R:?GLfloat>>).
...
multiTexCoord3i(Target,S,T,R) ->
  wxe_util:cast(5350, <<Target:?GLenum,S:?GLint,T:?GLint,R:?GLint>>).
...
multiTexCoord3s(Target,S,T,R) ->
  wxe_util:cast(5351, <<Target:?GLenum,S:?GLshort,T:?GLshort,R:?GLshort>>).
...
multiTexCoord4d(Target,S,T,R,Q) ->
  wxe_util:cast(5352, <<Target:?GLenum,0:32,S:?GLdouble,T:?GLdouble,R:?GLdouble,Q:?GLdouble>>).
...
multiTexCoord4f(Target,S,T,R,Q) ->
  wxe_util:cast(5353, <<Target:?GLenum,S:?GLfloat,T:?GLfloat,R:?GLfloat,Q:?GLfloat>>).
...
multiTexCoord4i(Target,S,T,R,Q) ->
  wxe_util:cast(5354, <<Target:?GLenum,S:?GLint,T:?GLint,R:?GLint,Q:?GLint>>).
...
multiTexCoord4s(Target,S,T,R,Q) ->
  wxe_util:cast(5355, <<Target:?GLenum,S:?GLshort,T:?GLshort,R:?GLshort,Q:?GLshort>>).
...
loadTransposeMatrixf({M1,M2,M3,M4,M5,M6,M7,M8,M9,M10,M11,M12,M13,M14,M15,M16}) ->
  wxe_util:cast(5356, <<M1:?GLfloat,M2:?GLfloat,M3:?GLfloat,M4:?GLfloat,M5:?GLfloat,M6:?GLfloat,M7:?GLfloat,M8:?GLfloat,M9:?GLfloat,M10:?GLfloat,M11:?GLfloat,M12:?GLfloat,M13:?GLfloat,M14:?GLfloat,M15:?GLfloat,M16:?GLfloat>>).

%% @spec (M::{float()}) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glLoadTransposeMatrix.xml">external</a> documentation.
loadTransposeMatrixd({M1,M2,M3,M4,M5,M6,M7,M8,M9,M10,M11,M12,M13,M14,M15,M16}) ->
  wxe_util:cast(5357, <<M1:?GLdouble,M2:?GLdouble,M3:?GLdouble,M4:?GLdouble,M5:?GLdouble,M6:?GLdouble,M7:?GLdouble,M8:?GLdouble,M9:?GLdouble,M10:?GLdouble,M11:?GLdouble,M12:?GLdouble,M13:?GLdouble,M14:?GLdouble,M15:?GLdouble,M16:?GLdouble>>).
...
multTransposeMatrixf({M1,M2,M3,M4,M5,M6,M7,M8,M9,M10,M11,M12,M13,M14,M15,M16}) ->
  wxe_util:cast(5358, <<M1:?GLfloat,M2:?GLfloat,M3:?GLfloat,M4:?GLfloat,M5:?GLfloat,M6:?GLfloat,M7:?GLfloat,M8:?GLfloat,M9:?GLfloat,M10:?GLfloat,M11:?GLfloat,M12:?GLfloat,M13:?GLfloat,M14:?GLfloat,M15:?GLfloat,M16:?GLfloat>>).

%% @spec (M::{float()}) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glMultTransposeMatrix.xml">external</a> documentation.
multTransposeMatrixd({M1,M2,M3,M4,M5,M6,M7,M8,M9,M10,M11,M12,M13,M14,M15,M16}) ->
  wxe_util:cast(5359, <<M1:?GLdouble,M2:?GLdouble,M3:?GLdouble,M4:?GLdouble,M5:?GLdouble,M6:?GLdouble,M7:?GLdouble,M8:?GLdouble,M9:?GLdouble,M10:?GLdouble,M11:?GLdouble,M12:?GLdouble,M13:?GLdouble,M14:?GLdouble,M15:?GLdouble,M16:?GLdouble>>).
...
sampleCoverage(Value,Invert) ->
  wxe_util:cast(5360, <<Value:?GLclampf,Invert:?GLboolean>>).
...
compressedTexImage3D(Target,Level,Internalformat,Width,Height,Depth,Border,ImageSize,Data) when  is_integer(Data) ->
  wxe_util:cast(5361, <<Target:?GLenum,Level:?GLint,Internalformat:?GLenum,Width:?GLsizei,Height:?GLsizei,Depth:?GLsizei,Border:?GLint,ImageSize:?GLsizei,Data:?GLuint>>);
compressedTexImage3D(Target,Level,Internalformat,Width,Height,Depth,Border,ImageSize,Data) ->
  wxe_util:send_bin(Data),
  wxe_util:cast(5362, <<Target:?GLenum,Level:?GLint,Internalformat:?GLenum,Width:?GLsizei,Height:?GLsizei,Depth:?GLsizei,Border:?GLint,ImageSize:?GLsizei>>).
...
compressedTexImage2D(Target,Level,Internalformat,Width,Height,Border,ImageSize,Data) when  is_integer(Data) ->
  wxe_util:cast(5363, <<Target:?GLenum,Level:?GLint,Internalformat:?GLenum,Width:?GLsizei,Height:?GLsizei,Border:?GLint,ImageSize:?GLsizei,Data:?GLuint>>);
compressedTexImage2D(Target,Level,Internalformat,Width,Height,Border,ImageSize,Data) ->
  wxe_util:send_bin(Data),
  wxe_util:cast(5364, <<Target:?GLenum,Level:?GLint,Internalformat:?GLenum,Width:?GLsizei,Height:?GLsizei,Border:?GLint,ImageSize:?GLsizei>>).
...
compressedTexImage1D(Target,Level,Internalformat,Width,Border,ImageSize,Data) when  is_integer(Data) ->
  wxe_util:cast(5365, <<Target:?GLenum,Level:?GLint,Internalformat:?GLenum,Width:?GLsizei,Border:?GLint,ImageSize:?GLsizei,Data:?GLuint>>);
compressedTexImage1D(Target,Level,Internalformat,Width,Border,ImageSize,Data) ->
  wxe_util:send_bin(Data),
  wxe_util:cast(5366, <<Target:?GLenum,Level:?GLint,Internalformat:?GLenum,Width:?GLsizei,Border:?GLint,ImageSize:?GLsizei>>).
...
compressedTexSubImage3D(Target,Level,Xoffset,Yoffset,Zoffset,Width,Height,Depth,Format,ImageSize,Data) when  is_integer(Data) ->
  wxe_util:cast(5367, <<Target:?GLenum,Level:?GLint,Xoffset:?GLint,Yoffset:?GLint,Zoffset:?GLint,Width:?GLsizei,Height:?GLsizei,Depth:?GLsizei,Format:?GLenum,ImageSize:?GLsizei,Data:?GLuint>>);
compressedTexSubImage3D(Target,Level,Xoffset,Yoffset,Zoffset,Width,Height,Depth,Format,ImageSize,Data) ->
  wxe_util:send_bin(Data),
  wxe_util:cast(5368, <<Target:?GLenum,Level:?GLint,Xoffset:?GLint,Yoffset:?GLint,Zoffset:?GLint,Width:?GLsizei,Height:?GLsizei,Depth:?GLsizei,Format:?GLenum,ImageSize:?GLsizei>>).
...
compressedTexSubImage2D(Target,Level,Xoffset,Yoffset,Width,Height,Format,ImageSize,Data) when  is_integer(Data) ->
  wxe_util:cast(5369, <<Target:?GLenum,Level:?GLint,Xoffset:?GLint,Yoffset:?GLint,Width:?GLsizei,Height:?GLsizei,Format:?GLenum,ImageSize:?GLsizei,Data:?GLuint>>);
compressedTexSubImage2D(Target,Level,Xoffset,Yoffset,Width,Height,Format,ImageSize,Data) ->
  wxe_util:send_bin(Data),
  wxe_util:cast(5370, <<Target:?GLenum,Level:?GLint,Xoffset:?GLint,Yoffset:?GLint,Width:?GLsizei,Height:?GLsizei,Format:?GLenum,ImageSize:?GLsizei>>).
...
compressedTexSubImage1D(Target,Level,Xoffset,Width,Format,ImageSize,Data) when  is_integer(Data) ->
  wxe_util:cast(5371, <<Target:?GLenum,Level:?GLint,Xoffset:?GLint,Width:?GLsizei,Format:?GLenum,ImageSize:?GLsizei,Data:?GLuint>>);
compressedTexSubImage1D(Target,Level,Xoffset,Width,Format,ImageSize,Data) ->
  wxe_util:send_bin(Data),
  wxe_util:cast(5372, <<Target:?GLenum,Level:?GLint,Xoffset:?GLint,Width:?GLsizei,Format:?GLenum,ImageSize:?GLsizei>>).
...
getCompressedTexImage(Target,Level,Img) ->
  ...
  wxe_util:call(5373, <<Target:?GLenum,Level:?GLint>>).
...
blendFuncSeparate(SfactorRGB,DfactorRGB,SfactorAlpha,DfactorAlpha) ->
  wxe_util:cast(5374, <<SfactorRGB:?GLenum,DfactorRGB:?GLenum,SfactorAlpha:?GLenum,DfactorAlpha:?GLenum>>).

%% @spec (Coord::float()) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glFogCoord.xml">external</a> documentation.
fogCoordf(Coord) ->
  wxe_util:cast(5375, <<Coord:?GLfloat>>).
...
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glFogCoord.xml">external</a> documentation.
fogCoordd(Coord) ->
  wxe_util:cast(5376, <<Coord:?GLdouble>>).
...
fogCoordPointer(Type,Stride,Pointer) when  is_integer(Pointer) ->
  wxe_util:cast(5377, <<Type:?GLenum,Stride:?GLsizei,Pointer:?GLuint>>);
fogCoordPointer(Type,Stride,Pointer) ->
  wxe_util:send_bin(Pointer),
  wxe_util:cast(5378, <<Type:?GLenum,Stride:?GLsizei>>).
...
multiDrawArrays(Mode,First,Count) ->
  wxe_util:cast(5379, <<Mode:?GLenum,(length(First)):?GLuint,
...
pointParameterf(Pname,Param) ->
  wxe_util:cast(5380, <<Pname:?GLenum,Param:?GLfloat>>).

%% @spec (Pname::enum(),Params::{float()}) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glPointParameter.xml">external</a> documentation.
pointParameterfv(Pname,Params) ->
  wxe_util:cast(5381, <<Pname:?GLenum,(size(Params)):?GLuint,
      (<< <<C:?GLfloat>> ||C <- tuple_to_list(Params)>>)/binary,0:(((0+size(Params)) rem 2)*32)>>).

%% @spec (Pname::enum(),Param::integer()) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glPointParameter.xml">external</a> documentation.
pointParameteri(Pname,Param) ->
  wxe_util:cast(5382, <<Pname:?GLenum,Param:?GLint>>).

%% @spec (Pname::enum(),Params::{integer()}) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glPointParameter.xml">external</a> documentation.
pointParameteriv(Pname,Params) ->
  wxe_util:cast(5383, <<Pname:?GLenum,(size(Params)):?GLuint,
      (<< <<C:?GLint>> ||C <- tuple_to_list(Params)>>)/binary,0:(((0+size(Params)) rem 2)*32)>>).
...
secondaryColor3b(Red,Green,Blue) ->
  wxe_util:cast(5384, <<Red:?GLbyte,Green:?GLbyte,Blue:?GLbyte>>).
...
secondaryColor3d(Red,Green,Blue) ->
  wxe_util:cast(5385, <<Red:?GLdouble,Green:?GLdouble,Blue:?GLdouble>>).
...
secondaryColor3f(Red,Green,Blue) ->
  wxe_util:cast(5386, <<Red:?GLfloat,Green:?GLfloat,Blue:?GLfloat>>).
...
secondaryColor3i(Red,Green,Blue) ->
  wxe_util:cast(5387, <<Red:?GLint,Green:?GLint,Blue:?GLint>>).
...
secondaryColor3s(Red,Green,Blue) ->
  wxe_util:cast(5388, <<Red:?GLshort,Green:?GLshort,Blue:?GLshort>>).
...
secondaryColor3ub(Red,Green,Blue) ->
  wxe_util:cast(5389, <<Red:?GLubyte,Green:?GLubyte,Blue:?GLubyte>>).
...
secondaryColor3ui(Red,Green,Blue) ->
  wxe_util:cast(5390, <<Red:?GLuint,Green:?GLuint,Blue:?GLuint>>).
...
secondaryColor3us(Red,Green,Blue) ->
  wxe_util:cast(5391, <<Red:?GLushort,Green:?GLushort,Blue:?GLushort>>).
...
secondaryColorPointer(Size,Type,Stride,Pointer) when  is_integer(Pointer) ->
  wxe_util:cast(5392, <<Size:?GLint,Type:?GLenum,Stride:?GLsizei,Pointer:?GLuint>>);
secondaryColorPointer(Size,Type,Stride,Pointer) ->
  wxe_util:send_bin(Pointer),
  wxe_util:cast(5393, <<Size:?GLint,Type:?GLenum,Stride:?GLsizei>>).

%% @spec (X::float(),Y::float()) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glWindowPos.xml">external</a> documentation.
windowPos2d(X,Y) ->
  wxe_util:cast(5394, <<X:?GLdouble,Y:?GLdouble>>).
...
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glWindowPos.xml">external</a> documentation.
windowPos2f(X,Y) ->
  wxe_util:cast(5395, <<X:?GLfloat,Y:?GLfloat>>).
...
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glWindowPos.xml">external</a> documentation.
windowPos2i(X,Y) ->
  wxe_util:cast(5396, <<X:?GLint,Y:?GLint>>).
...
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glWindowPos.xml">external</a> documentation.
windowPos2s(X,Y) ->
  wxe_util:cast(5397, <<X:?GLshort,Y:?GLshort>>).
...
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glWindowPos.xml">external</a> documentation.
windowPos3d(X,Y,Z) ->
  wxe_util:cast(5398, <<X:?GLdouble,Y:?GLdouble,Z:?GLdouble>>).
...
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glWindowPos.xml">external</a> documentation.
windowPos3f(X,Y,Z) ->
  wxe_util:cast(5399, <<X:?GLfloat,Y:?GLfloat,Z:?GLfloat>>).
...
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glWindowPos.xml">external</a> documentation.
windowPos3i(X,Y,Z) ->
  wxe_util:cast(5400, <<X:?GLint,Y:?GLint,Z:?GLint>>).
...
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glWindowPos.xml">external</a> documentation.
windowPos3s(X,Y,Z) ->
  wxe_util:cast(5401, <<X:?GLshort,Y:?GLshort,Z:?GLshort>>).
...
getQueryObjectiv(Id,Pname) ->
  wxe_util:call(5408, <<Id:?GLuint,Pname:?GLenum>>).

%% @spec (Id::integer(),Pname::enum()) -> integer()
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glGetQueryObject.xml">external</a> documentation.
getQueryObjectuiv(Id,Pname) ->
  wxe_util:call(5409, <<Id:?GLuint,Pname:?GLenum>>).
...
bindBuffer(Target,Buffer) ->
  wxe_util:cast(5410, <<Target:?GLenum,Buffer:?GLuint>>).
...
deleteBuffers(Buffers) ->
  wxe_util:cast(5411, <<(length(Buffers)):?GLuint,
...
bufferData(Target,Size,Data,Usage) when  is_integer(Data) ->
  wxe_util:cast(5414, <<Target:?GLenum,0:32,Size:?GLsizeiptr,Data:?GLuint,Usage:?GLenum>>);
bufferData(Target,Size,Data,Usage) ->
  wxe_util:send_bin(Data),
  wxe_util:cast(5415, <<Target:?GLenum,0:32,Size:?GLsizeiptr,Usage:?GLenum>>).
...
bufferSubData(Target,Offset,Size,Data) when  is_integer(Data) ->
  wxe_util:cast(5416, <<Target:?GLenum,0:32,Offset:?GLintptr,Size:?GLsizeiptr,Data:?GLuint>>);
bufferSubData(Target,Offset,Size,Data) ->
  wxe_util:send_bin(Data),
  wxe_util:cast(5417, <<Target:?GLenum,0:32,Offset:?GLintptr,Size:?GLsizeiptr>>).
...
getBufferSubData(Target,Offset,Size,Data) ->
  ...
  wxe_util:call(5418, <<Target:?GLenum,0:32,Offset:?GLintptr,Size:?GLsizeiptr>>).
...
getBufferParameteriv(Target,Pname) ->
  wxe_util:call(5419, <<Target:?GLenum,Pname:?GLenum>>).
...
stencilOpSeparate(Face,Sfail,Dpfail,Dppass) ->
  wxe_util:cast(5422, <<Face:?GLenum,Sfail:?GLenum,Dpfail:?GLenum,Dppass:?GLenum>>).
...
stencilFuncSeparate(Frontfunc,Backfunc,Ref,Mask) ->
  wxe_util:cast(5423, <<Frontfunc:?GLenum,Backfunc:?GLenum,Ref:?GLint,Mask:?GLuint>>).
...
stencilMaskSeparate(Face,Mask) ->
  wxe_util:cast(5424, <<Face:?GLenum,Mask:?GLuint>>).
...
attachShader(Program,Shader) ->
  wxe_util:cast(5425, <<Program:?GLuint,Shader:?GLuint>>).
...
bindAttribLocation(Program,Index,Name) ->
  wxe_util:cast(5426, <<Program:?GLuint,Index:?GLuint,(list_to_binary([Name|[0]]))/binary,0:((8-((length(Name)+ 1) rem 8)) rem 8)>>).
...
compileShader(Shader) ->
  wxe_util:cast(5427, <<Shader:?GLuint>>).
...
createShader(Type) ->
  wxe_util:call(5429, <<Type:?GLenum>>).
...
getActiveAttrib(Program,Index,BufSize) ->
  wxe_util:call(5435, <<Program:?GLuint,Index:?GLuint,BufSize:?GLsizei>>).
...
getActiveUniform(Program,Index,BufSize) ->
  wxe_util:call(5436, <<Program:?GLuint,Index:?GLuint,BufSize:?GLsizei>>).
...
getAttachedShaders(Program,MaxCount) ->
  wxe_util:call(5437, <<Program:?GLuint,MaxCount:?GLsizei>>).
...
getAttribLocation(Program,Name) ->
  wxe_util:call(5438, <<Program:?GLuint,(list_to_binary([Name|[0]]))/binary,0:((8-((length(Name)+ 5) rem 8)) rem 8)>>).
...
getProgramiv(Program,Pname) ->
  wxe_util:call(5439, <<Program:?GLuint,Pname:?GLenum>>).
...
getProgramInfoLog(Program,BufSize) ->
  wxe_util:call(5440, <<Program:?GLuint,BufSize:?GLsizei>>).
...
getShaderiv(Shader,Pname) ->
  wxe_util:call(5441, <<Shader:?GLuint,Pname:?GLenum>>).
...
getShaderInfoLog(Shader,BufSize) ->
  wxe_util:call(5442, <<Shader:?GLuint,BufSize:?GLsizei>>).
...
getShaderSource(Shader,BufSize) ->
  wxe_util:call(5443, <<Shader:?GLuint,BufSize:?GLsizei>>).

%% @spec (Program::integer(),Name::string()) -> integer()
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glGetUniformLocation.xml">external</a> documentation.
getUniformLocation(Program,Name) ->
  wxe_util:call(5444, <<Program:?GLuint,(list_to_binary([Name|[0]]))/binary,0:((8-((length(Name)+ 5) rem 8)) rem 8)>>).
...
getUniformfv(Program,Location) ->
  wxe_util:call(5445, <<Program:?GLuint,Location:?GLint>>).

%% @spec (Program::integer(),Location::integer()) -> {integer()}
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glGetUniform.xml">external</a> documentation.
getUniformiv(Program,Location) ->
  wxe_util:call(5446, <<Program:?GLuint,Location:?GLint>>).
...
shaderSource(Shader,String) ->
 StringTemp = list_to_binary([[Str|[0]] || Str <- String ]),
  wxe_util:cast(5453, <<Shader:?GLuint,(length(String)):?GLuint,(size(StringTemp)):?GLuint,(StringTemp)/binary,0:((8-((size(StringTemp)+0) rem 8)) rem 8)>>).

%% @spec (Program::integer()) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glUseProgram.xml">external</a> documentation.
useProgram(Program) ->
  wxe_util:cast(5454, <<Program:?GLuint>>).
...
uniform1f(Location,V0) ->
  wxe_util:cast(5455, <<Location:?GLint,V0:?GLfloat>>).

%% @spec (Location::integer(),V0::float(),V1::float()) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glUniform.xml">external</a> documentation.
uniform2f(Location,V0,V1) ->
  wxe_util:cast(5456, <<Location:?GLint,V0:?GLfloat,V1:?GLfloat>>).

%% @spec (Location::integer(),V0::float(),V1::float(),V2::float()) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glUniform.xml">external</a> documentation.
uniform3f(Location,V0,V1,V2) ->
  wxe_util:cast(5457, <<Location:?GLint,V0:?GLfloat,V1:?GLfloat,V2:?GLfloat>>).

%% @spec (Location::integer(),V0::float(),V1::float(),V2::float(),V3::float()) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glUniform.xml">external</a> documentation.
uniform4f(Location,V0,V1,V2,V3) ->
  wxe_util:cast(5458, <<Location:?GLint,V0:?GLfloat,V1:?GLfloat,V2:?GLfloat,V3:?GLfloat>>).

%% @spec (Location::integer(),V0::integer()) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glUniform.xml">external</a> documentation.
uniform1i(Location,V0) ->
  wxe_util:cast(5459, <<Location:?GLint,V0:?GLint>>).

%% @spec (Location::integer(),V0::integer(),V1::integer()) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glUniform.xml">external</a> documentation.
uniform2i(Location,V0,V1) ->
  wxe_util:cast(5460, <<Location:?GLint,V0:?GLint,V1:?GLint>>).

%% @spec (Location::integer(),V0::integer(),V1::integer(),V2::integer()) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glUniform.xml">external</a> documentation.
uniform3i(Location,V0,V1,V2) ->
  wxe_util:cast(5461, <<Location:?GLint,V0:?GLint,V1:?GLint,V2:?GLint>>).

%% @spec (Location::integer(),V0::integer(),V1::integer(),V2::integer(),V3::integer()) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glUniform.xml">external</a> documentation.
uniform4i(Location,V0,V1,V2,V3) ->
  wxe_util:cast(5462, <<Location:?GLint,V0:?GLint,V1:?GLint,V2:?GLint,V3:?GLint>>).

%% @spec (Location::integer(),Value::[float()]) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glUniform.xml">external</a> documentation.
uniform1fv(Location,Value) ->
  wxe_util:cast(5463, <<Location:?GLint,(length(Value)):?GLuint,
        (<< <<C:?GLfloat>> || C <- Value>>)/binary,0:(((length(Value)) rem 2)*32)>>).

%% @spec (Location::integer(),Value::[{float()}]) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glUniform.xml">external</a> documentation.
uniform2fv(Location,Value) ->
  wxe_util:cast(5464, <<Location:?GLint,(length(Value)):?GLuint,
        (<< <<V1:?GLfloat,V2:?GLfloat>> || {V1,V2} <- Value>>)/binary>>).

%% @spec (Location::integer(),Value::[{float()}]) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glUniform.xml">external</a> documentation.
uniform3fv(Location,Value) ->
  wxe_util:cast(5465, <<Location:?GLint,(length(Value)):?GLuint,
        (<< <<V1:?GLfloat,V2:?GLfloat,V3:?GLfloat>> || {V1,V2,V3} <- Value>>)/binary>>).

%% @spec (Location::integer(),Value::[{float()}]) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glUniform.xml">external</a> documentation.
uniform4fv(Location,Value) ->
  wxe_util:cast(5466, <<Location:?GLint,(length(Value)):?GLuint,
        (<< <<V1:?GLfloat,V2:?GLfloat,V3:?GLfloat,V4:?GLfloat>> || {V1,V2,V3,V4} <- Value>>)/binary>>).

%% @spec (Location::integer(),Value::[integer()]) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glUniform.xml">external</a> documentation.
uniform1iv(Location,Value) ->
  wxe_util:cast(5467, <<Location:?GLint,(length(Value)):?GLuint,
        (<< <<C:?GLint>> || C <- Value>>)/binary,0:(((length(Value)) rem 2)*32)>>).

%% @spec (Location::integer(),Value::[{integer()}]) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glUniform.xml">external</a> documentation.
uniform2iv(Location,Value) ->
  wxe_util:cast(5468, <<Location:?GLint,(length(Value)):?GLuint,
        (<< <<V1:?GLint,V2:?GLint>> || {V1,V2} <- Value>>)/binary>>).

%% @spec (Location::integer(),Value::[{integer()}]) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glUniform.xml">external</a> documentation.
uniform3iv(Location,Value) ->
  wxe_util:cast(5469, <<Location:?GLint,(length(Value)):?GLuint,
        (<< <<V1:?GLint,V2:?GLint,V3:?GLint>> || {V1,V2,V3} <- Value>>)/binary>>).

%% @spec (Location::integer(),Value::[{integer()}]) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glUniform.xml">external</a> documentation.
uniform4iv(Location,Value) ->
  wxe_util:cast(5470, <<Location:?GLint,(length(Value)):?GLuint,
...
uniformMatrix2fv(Location,Transpose,Value) ->
  wxe_util:cast(5471, <<Location:?GLint,Transpose:?GLboolean,0:24,(length(Value)):?GLuint,
        (<< <<V1:?GLfloat,V2:?GLfloat,V3:?GLfloat,V4:?GLfloat>> || {V1,V2,V3,V4} <- Value>>)/binary>>).

%% @spec (Location::integer(),Transpose::0|1,Value::[{float()}]) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glUniformMatrix.xml">external</a> documentation.
uniformMatrix3fv(Location,Transpose,Value) ->
  wxe_util:cast(5472, <<Location:?GLint,Transpose:?GLboolean,0:24,(length(Value)):?GLuint,
...
uniformMatrix4fv(Location,Transpose,Value) ->
  wxe_util:cast(5473, <<Location:?GLint,Transpose:?GLboolean,0:24,(length(Value)):?GLuint,
...
vertexAttrib1d(Index,X) ->
  wxe_util:cast(5475, <<Index:?GLuint,0:32,X:?GLdouble>>).
...
vertexAttrib1f(Index,X) ->
  wxe_util:cast(5476, <<Index:?GLuint,X:?GLfloat>>).
...
vertexAttrib1s(Index,X) ->
  wxe_util:cast(5477, <<Index:?GLuint,X:?GLshort>>).
...
vertexAttrib2d(Index,X,Y) ->
  wxe_util:cast(5478, <<Index:?GLuint,0:32,X:?GLdouble,Y:?GLdouble>>).
...
vertexAttrib2f(Index,X,Y) ->
  wxe_util:cast(5479, <<Index:?GLuint,X:?GLfloat,Y:?GLfloat>>).
...
vertexAttrib2s(Index,X,Y) ->
  wxe_util:cast(5480, <<Index:?GLuint,X:?GLshort,Y:?GLshort>>).
...
vertexAttrib3d(Index,X,Y,Z) ->
  wxe_util:cast(5481, <<Index:?GLuint,0:32,X:?GLdouble,Y:?GLdouble,Z:?GLdouble>>).
...
vertexAttrib3f(Index,X,Y,Z) ->
  wxe_util:cast(5482, <<Index:?GLuint,X:?GLfloat,Y:?GLfloat,Z:?GLfloat>>).
...
vertexAttrib3s(Index,X,Y,Z) ->
  wxe_util:cast(5483, <<Index:?GLuint,X:?GLshort,Y:?GLshort,Z:?GLshort>>).
...
vertexAttrib4Nbv(Index,{V1,V2,V3,V4}) ->
  wxe_util:cast(5484, <<Index:?GLuint,V1:?GLbyte,V2:?GLbyte,V3:?GLbyte,V4:?GLbyte>>).

%% @spec (Index::integer(),V::{integer()}) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glVertexAttrib.xml">external</a> documentation.
vertexAttrib4Niv(Index,{V1,V2,V3,V4}) ->
  wxe_util:cast(5485, <<Index:?GLuint,V1:?GLint,V2:?GLint,V3:?GLint,V4:?GLint>>).

%% @spec (Index::integer(),V::{integer()}) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glVertexAttrib.xml">external</a> documentation.
vertexAttrib4Nsv(Index,{V1,V2,V3,V4}) ->
  wxe_util:cast(5486, <<Index:?GLuint,V1:?GLshort,V2:?GLshort,V3:?GLshort,V4:?GLshort>>).

%% @spec (Index::integer(),X::integer(),Y::integer(),Z::integer(),W::integer()) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glVertexAttrib.xml">external</a> documentation.
vertexAttrib4Nub(Index,X,Y,Z,W) ->
  wxe_util:cast(5487, <<Index:?GLuint,X:?GLubyte,Y:?GLubyte,Z:?GLubyte,W:?GLubyte>>).
...
vertexAttrib4Nuiv(Index,{V1,V2,V3,V4}) ->
  wxe_util:cast(5488, <<Index:?GLuint,V1:?GLuint,V2:?GLuint,V3:?GLuint,V4:?GLuint>>).

%% @spec (Index::integer(),V::{integer()}) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glVertexAttrib.xml">external</a> documentation.
vertexAttrib4Nusv(Index,{V1,V2,V3,V4}) ->
  wxe_util:cast(5489, <<Index:?GLuint,V1:?GLushort,V2:?GLushort,V3:?GLushort,V4:?GLushort>>).

%% @spec (Index::integer(),V::{integer()}) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glVertexAttrib.xml">external</a> documentation.
vertexAttrib4bv(Index,{V1,V2,V3,V4}) ->
  wxe_util:cast(5490, <<Index:?GLuint,V1:?GLbyte,V2:?GLbyte,V3:?GLbyte,V4:?GLbyte>>).

%% @spec (Index::integer(),X::float(),Y::float(),Z::float(),W::float()) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glVertexAttrib.xml">external</a> documentation.
vertexAttrib4d(Index,X,Y,Z,W) ->
  wxe_util:cast(5491, <<Index:?GLuint,0:32,X:?GLdouble,Y:?GLdouble,Z:?GLdouble,W:?GLdouble>>).
...
vertexAttrib4f(Index,X,Y,Z,W) ->
  wxe_util:cast(5492, <<Index:?GLuint,X:?GLfloat,Y:?GLfloat,Z:?GLfloat,W:?GLfloat>>).
...
vertexAttrib4iv(Index,{V1,V2,V3,V4}) ->
  wxe_util:cast(5493, <<Index:?GLuint,V1:?GLint,V2:?GLint,V3:?GLint,V4:?GLint>>).

%% @spec (Index::integer(),X::integer(),Y::integer(),Z::integer(),W::integer()) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glVertexAttrib.xml">external</a> documentation.
vertexAttrib4s(Index,X,Y,Z,W) ->
  wxe_util:cast(5494, <<Index:?GLuint,X:?GLshort,Y:?GLshort,Z:?GLshort,W:?GLshort>>).
...
vertexAttrib4ubv(Index,{V1,V2,V3,V4}) ->
  wxe_util:cast(5495, <<Index:?GLuint,V1:?GLubyte,V2:?GLubyte,V3:?GLubyte,V4:?GLubyte>>).

%% @spec (Index::integer(),V::{integer()}) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glVertexAttrib.xml">external</a> documentation.
vertexAttrib4uiv(Index,{V1,V2,V3,V4}) ->
  wxe_util:cast(5496, <<Index:?GLuint,V1:?GLuint,V2:?GLuint,V3:?GLuint,V4:?GLuint>>).

%% @spec (Index::integer(),V::{integer()}) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glVertexAttrib.xml">external</a> documentation.
vertexAttrib4usv(Index,{V1,V2,V3,V4}) ->
  wxe_util:cast(5497, <<Index:?GLuint,V1:?GLushort,V2:?GLushort,V3:?GLushort,V4:?GLushort>>).
...
vertexAttribPointer(Index,Size,Type,Normalized,Stride,Pointer) when  is_integer(Pointer) ->
  wxe_util:cast(5498, <<Index:?GLuint,Size:?GLint,Type:?GLenum,Normalized:?GLboolean,0:24,Stride:?GLsizei,Pointer:?GLuint>>);
vertexAttribPointer(Index,Size,Type,Normalized,Stride,Pointer) ->
  wxe_util:send_bin(Pointer),
  wxe_util:cast(5499, <<Index:?GLuint,Size:?GLint,Type:?GLenum,Normalized:?GLboolean,0:24,Stride:?GLsizei>>).
...
uniformMatrix2x3fv(Location,Transpose,Value) ->
  wxe_util:cast(5500, <<Location:?GLint,Transpose:?GLboolean,0:24,(length(Value)):?GLuint,
...
uniformMatrix3x2fv(Location,Transpose,Value) ->
  wxe_util:cast(5501, <<Location:?GLint,Transpose:?GLboolean,0:24,(length(Value)):?GLuint,
        (<< <<V1:?GLfloat,V2:?GLfloat,V3:?GLfloat,V4:?GLfloat,V5:?GLfloat,V6:?GLfloat>> || {V1,V2,V3,V4,V5,V6} <- Value>>)/binary>>).

%% @spec (Location::integer(),Transpose::0|1,Value::[{float()}]) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glUniformMatrix2x.xml">external</a> documentation.
uniformMatrix2x4fv(Location,Transpose,Value) ->
  wxe_util:cast(5502, <<Location:?GLint,Transpose:?GLboolean,0:24,(length(Value)):?GLuint,
...
uniformMatrix4x2fv(Location,Transpose,Value) ->
  wxe_util:cast(5503, <<Location:?GLint,Transpose:?GLboolean,0:24,(length(Value)):?GLuint,
        (<< <<V1:?GLfloat,V2:?GLfloat,V3:?GLfloat,V4:?GLfloat,V5:?GLfloat,V6:?GLfloat,V7:?GLfloat,V8:?GLfloat>> || {V1,V2,V3,V4,V5,V6,V7,V8} <- Value>>)/binary>>).

%% @spec (Location::integer(),Transpose::0|1,Value::[{float()}]) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glUniformMatrix3x.xml">external</a> documentation.
uniformMatrix3x4fv(Location,Transpose,Value) ->
  wxe_util:cast(5504, <<Location:?GLint,Transpose:?GLboolean,0:24,(length(Value)):?GLuint,
...
uniformMatrix4x3fv(Location,Transpose,Value) ->
  wxe_util:cast(5505, <<Location:?GLint,Transpose:?GLboolean,0:24,(length(Value)):?GLuint,
        (<< <<V1:?GLfloat,V2:?GLfloat,V3:?GLfloat,V4:?GLfloat,V5:?GLfloat,V6:?GLfloat,V7:?GLfloat,V8:?GLfloat,V9:?GLfloat,V10:?GLfloat,V11:?GLfloat,V12:?GLfloat>> || {V1,V2,V3,V4,V5,V6,V7,V8,V9,V10,V11,V12} <- Value>>)/binary>>).
...
colorMaski(Index,R,G,B,A) ->
  wxe_util:cast(5506, <<Index:?GLuint,R:?GLboolean,G:?GLboolean,B:?GLboolean,A:?GLboolean>>).
...
getBooleani_v(Target,Index) ->
  wxe_util:call(5507, <<Target:?GLenum,Index:?GLuint>>).
...
getIntegeri_v(Target,Index) ->
  wxe_util:call(5508, <<Target:?GLenum,Index:?GLuint>>).

%% @spec (Target::enum(),Index::integer()) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glEnable.xml">external</a> documentation.
enablei(Target,Index) ->
  wxe_util:cast(5509, <<Target:?GLenum,Index:?GLuint>>).

%% @spec (Target::enum(),Index::integer()) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glDisable.xml">external</a> documentation.
disablei(Target,Index) ->
  wxe_util:cast(5510, <<Target:?GLenum,Index:?GLuint>>).

%% @spec (Target::enum(),Index::integer()) -> 0|1
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glIsEnabledi.xml">external</a> documentation.
isEnabledi(Target,Index) ->
  wxe_util:call(5511, <<Target:?GLenum,Index:?GLuint>>).
...
beginTransformFeedback(PrimitiveMode) ->
  wxe_util:cast(5512, <<PrimitiveMode:?GLenum>>).
...
bindBufferRange(Target,Index,Buffer,Offset,Size) ->
  wxe_util:cast(5514, <<Target:?GLenum,Index:?GLuint,Buffer:?GLuint,0:32,Offset:?GLintptr,Size:?GLsizeiptr>>).
...
bindBufferBase(Target,Index,Buffer) ->
  wxe_util:cast(5515, <<Target:?GLenum,Index:?GLuint,Buffer:?GLuint>>).
...
clampColor(Target,Clamp) ->
  wxe_util:cast(5516, <<Target:?GLenum,Clamp:?GLenum>>).
...
beginConditionalRender(Id,Mode) ->
  wxe_util:cast(5517, <<Id:?GLuint,Mode:?GLenum>>).
...
vertexAttribI1i(Index,X) ->
  wxe_util:cast(5519, <<Index:?GLuint,X:?GLint>>).

%% @spec (Index::integer(),X::integer(),Y::integer()) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glVertexAttribI.xml">external</a> documentation.
vertexAttribI2i(Index,X,Y) ->
  wxe_util:cast(5520, <<Index:?GLuint,X:?GLint,Y:?GLint>>).

%% @spec (Index::integer(),X::integer(),Y::integer(),Z::integer()) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glVertexAttribI.xml">external</a> documentation.
vertexAttribI3i(Index,X,Y,Z) ->
  wxe_util:cast(5521, <<Index:?GLuint,X:?GLint,Y:?GLint,Z:?GLint>>).

%% @spec (Index::integer(),X::integer(),Y::integer(),Z::integer(),W::integer()) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glVertexAttribI.xml">external</a> documentation.
vertexAttribI4i(Index,X,Y,Z,W) ->
  wxe_util:cast(5522, <<Index:?GLuint,X:?GLint,Y:?GLint,Z:?GLint,W:?GLint>>).

%% @spec (Index::integer(),X::integer()) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glVertexAttribI.xml">external</a> documentation.
vertexAttribI1ui(Index,X) ->
  wxe_util:cast(5523, <<Index:?GLuint,X:?GLuint>>).

%% @spec (Index::integer(),X::integer(),Y::integer()) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glVertexAttribI.xml">external</a> documentation.
vertexAttribI2ui(Index,X,Y) ->
  wxe_util:cast(5524, <<Index:?GLuint,X:?GLuint,Y:?GLuint>>).

%% @spec (Index::integer(),X::integer(),Y::integer(),Z::integer()) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glVertexAttribI.xml">external</a> documentation.
vertexAttribI3ui(Index,X,Y,Z) ->
  wxe_util:cast(5525, <<Index:?GLuint,X:?GLuint,Y:?GLuint,Z:?GLuint>>).

%% @spec (Index::integer(),X::integer(),Y::integer(),Z::integer(),W::integer()) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glVertexAttribI.xml">external</a> documentation.
vertexAttribI4ui(Index,X,Y,Z,W) ->
  wxe_util:cast(5526, <<Index:?GLuint,X:?GLuint,Y:?GLuint,Z:?GLuint,W:?GLuint>>).
...
vertexAttribI4bv(Index,{V1,V2,V3,V4}) ->
  wxe_util:cast(5527, <<Index:?GLuint,V1:?GLbyte,V2:?GLbyte,V3:?GLbyte,V4:?GLbyte>>).

%% @spec (Index::integer(),V::{integer()}) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glVertexAttribI.xml">external</a> documentation.
vertexAttribI4sv(Index,{V1,V2,V3,V4}) ->
  wxe_util:cast(5528, <<Index:?GLuint,V1:?GLshort,V2:?GLshort,V3:?GLshort,V4:?GLshort>>).

%% @spec (Index::integer(),V::{integer()}) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glVertexAttribI.xml">external</a> documentation.
vertexAttribI4ubv(Index,{V1,V2,V3,V4}) ->
  wxe_util:cast(5529, <<Index:?GLuint,V1:?GLubyte,V2:?GLubyte,V3:?GLubyte,V4:?GLubyte>>).

%% @spec (Index::integer(),V::{integer()}) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glVertexAttribI.xml">external</a> documentation.
vertexAttribI4usv(Index,{V1,V2,V3,V4}) ->
  wxe_util:cast(5530, <<Index:?GLuint,V1:?GLushort,V2:?GLushort,V3:?GLushort,V4:?GLushort>>).
...
vertexAttribIPointer(Index,Size,Type,Stride,Pointer) when  is_integer(Pointer) ->
  wxe_util:cast(5531, <<Index:?GLuint,Size:?GLint,Type:?GLenum,Stride:?GLsizei,Pointer:?GLuint>>);
vertexAttribIPointer(Index,Size,Type,Stride,Pointer) ->
  wxe_util:send_bin(Pointer),
  wxe_util:cast(5532, <<Index:?GLuint,Size:?GLint,Type:?GLenum,Stride:?GLsizei>>).
...
getVertexAttribIiv(Index,Pname) ->
  wxe_util:call(5533, <<Index:?GLuint,Pname:?GLenum>>).

%% @spec (Index::integer(),Pname::enum()) -> {integer()}
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glGetVertexAttribI.xml">external</a> documentation.
getVertexAttribIuiv(Index,Pname) ->
  wxe_util:call(5534, <<Index:?GLuint,Pname:?GLenum>>).

%% @spec (Program::integer(),Location::integer()) -> {integer()}
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glGetUniform.xml">external</a> documentation.
getUniformuiv(Program,Location) ->
  wxe_util:call(5535, <<Program:?GLuint,Location:?GLint>>).
...
bindFragDataLocation(Program,Color,Name) ->
  wxe_util:cast(5536, <<Program:?GLuint,Color:?GLuint,(list_to_binary([Name|[0]]))/binary,0:((8-((length(Name)+ 1) rem 8)) rem 8)>>).

%% @spec (Program::integer(),Name::string()) -> integer()
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glGetFragDataLocation.xml">external</a> documentation.
getFragDataLocation(Program,Name) ->
  wxe_util:call(5537, <<Program:?GLuint,(list_to_binary([Name|[0]]))/binary,0:((8-((length(Name)+ 5) rem 8)) rem 8)>>).

%% @spec (Location::integer(),V0::integer()) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glUniform.xml">external</a> documentation.
uniform1ui(Location,V0) ->
  wxe_util:cast(5538, <<Location:?GLint,V0:?GLuint>>).

%% @spec (Location::integer(),V0::integer(),V1::integer()) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glUniform.xml">external</a> documentation.
uniform2ui(Location,V0,V1) ->
  wxe_util:cast(5539, <<Location:?GLint,V0:?GLuint,V1:?GLuint>>).

%% @spec (Location::integer(),V0::integer(),V1::integer(),V2::integer()) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glUniform.xml">external</a> documentation.
uniform3ui(Location,V0,V1,V2) ->
  wxe_util:cast(5540, <<Location:?GLint,V0:?GLuint,V1:?GLuint,V2:?GLuint>>).

%% @spec (Location::integer(),V0::integer(),V1::integer(),V2::integer(),V3::integer()) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glUniform.xml">external</a> documentation.
uniform4ui(Location,V0,V1,V2,V3) ->
  wxe_util:cast(5541, <<Location:?GLint,V0:?GLuint,V1:?GLuint,V2:?GLuint,V3:?GLuint>>).

%% @spec (Location::integer(),Value::[integer()]) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glUniform.xml">external</a> documentation.
uniform1uiv(Location,Value) ->
  wxe_util:cast(5542, <<Location:?GLint,(length(Value)):?GLuint,
        (<< <<C:?GLuint>> || C <- Value>>)/binary,0:(((length(Value)) rem 2)*32)>>).

%% @spec (Location::integer(),Value::[{integer()}]) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glUniform.xml">external</a> documentation.
uniform2uiv(Location,Value) ->
  wxe_util:cast(5543, <<Location:?GLint,(length(Value)):?GLuint,
        (<< <<V1:?GLuint,V2:?GLuint>> || {V1,V2} <- Value>>)/binary>>).

%% @spec (Location::integer(),Value::[{integer()}]) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glUniform.xml">external</a> documentation.
uniform3uiv(Location,Value) ->
  wxe_util:cast(5544, <<Location:?GLint,(length(Value)):?GLuint,
        (<< <<V1:?GLuint,V2:?GLuint,V3:?GLuint>> || {V1,V2,V3} <- Value>>)/binary>>).

%% @spec (Location::integer(),Value::[{integer()}]) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glUniform.xml">external</a> documentation.
uniform4uiv(Location,Value) ->
  wxe_util:cast(5545, <<Location:?GLint,(length(Value)):?GLuint,
...
texParameterIiv(Target,Pname,Params) ->
  wxe_util:cast(5546, <<Target:?GLenum,Pname:?GLenum,(size(Params)):?GLuint,
      (<< <<C:?GLint>> ||C <- tuple_to_list(Params)>>)/binary,0:(((1+size(Params)) rem 2)*32)>>).

%% @spec (Target::enum(),Pname::enum(),Params::{integer()}) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glTexParameterI.xml">external</a> documentation.
texParameterIuiv(Target,Pname,Params) ->
  wxe_util:cast(5547, <<Target:?GLenum,Pname:?GLenum,(size(Params)):?GLuint,
...
getTexParameterIiv(Target,Pname) ->
  wxe_util:call(5548, <<Target:?GLenum,Pname:?GLenum>>).

%% @spec (Target::enum(),Pname::enum()) -> {integer()}
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glGetTexParameterI.xml">external</a> documentation.
getTexParameterIuiv(Target,Pname) ->
  wxe_util:call(5549, <<Target:?GLenum,Pname:?GLenum>>).
...
clearBufferiv(Buffer,Drawbuffer,Value) ->
  wxe_util:cast(5550, <<Buffer:?GLenum,Drawbuffer:?GLint,(size(Value)):?GLuint,
      (<< <<C:?GLint>> ||C <- tuple_to_list(Value)>>)/binary,0:(((1+size(Value)) rem 2)*32)>>).

%% @spec (Buffer::enum(),Drawbuffer::integer(),Value::{integer()}) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glClearBuffer.xml">external</a> documentation.
clearBufferuiv(Buffer,Drawbuffer,Value) ->
  wxe_util:cast(5551, <<Buffer:?GLenum,Drawbuffer:?GLint,(size(Value)):?GLuint,
      (<< <<C:?GLuint>> ||C <- tuple_to_list(Value)>>)/binary,0:(((1+size(Value)) rem 2)*32)>>).

%% @spec (Buffer::enum(),Drawbuffer::integer(),Value::{float()}) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glClearBuffer.xml">external</a> documentation.
clearBufferfv(Buffer,Drawbuffer,Value) ->
  wxe_util:cast(5552, <<Buffer:?GLenum,Drawbuffer:?GLint,(size(Value)):?GLuint,
...
vertexBlendARB(Count) ->
  wxe_util:cast(5563, <<Count:?GLint>>).
...
currentPaletteMatrixARB(Index) ->
  wxe_util:cast(5564, <<Index:?GLint>>).
...
programStringARB(Target,Format,String) ->
  wxe_util:cast(5568, <<Target:?GLenum,Format:?GLenum,(list_to_binary([String|[0]]))/binary,0:((8-((length(String)+ 1) rem 8)) rem 8)>>).
...
bindProgramARB(Target,Program) ->
  wxe_util:cast(5569, <<Target:?GLenum,Program:?GLuint>>).
...
deleteProgramsARB(Programs) ->
  wxe_util:cast(5570, <<(length(Programs)):?GLuint,
...
programEnvParameter4dARB(Target,Index,X,Y,Z,W) ->
  wxe_util:cast(5572, <<Target:?GLenum,Index:?GLuint,X:?GLdouble,Y:?GLdouble,Z:?GLdouble,W:?GLdouble>>).

%% @spec (Target::enum(),Index::integer(),Params::{float()}) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glProgramEnvParameterARB.xml">external</a> documentation.
programEnvParameter4dvARB(Target,Index,{P1,P2,P3,P4}) ->
  wxe_util:cast(5573, <<Target:?GLenum,Index:?GLuint,P1:?GLdouble,P2:?GLdouble,P3:?GLdouble,P4:?GLdouble>>).

%% @spec (Target::enum(),Index::integer(),X::float(),Y::float(),Z::float(),W::float()) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glProgramEnvParameterARB.xml">external</a> documentation.
programEnvParameter4fARB(Target,Index,X,Y,Z,W) ->
  wxe_util:cast(5574, <<Target:?GLenum,Index:?GLuint,X:?GLfloat,Y:?GLfloat,Z:?GLfloat,W:?GLfloat>>).

%% @spec (Target::enum(),Index::integer(),Params::{float()}) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glProgramEnvParameterARB.xml">external</a> documentation.
programEnvParameter4fvARB(Target,Index,{P1,P2,P3,P4}) ->
  wxe_util:cast(5575, <<Target:?GLenum,Index:?GLuint,P1:?GLfloat,P2:?GLfloat,P3:?GLfloat,P4:?GLfloat>>).
...
programLocalParameter4dARB(Target,Index,X,Y,Z,W) ->
  wxe_util:cast(5576, <<Target:?GLenum,Index:?GLuint,X:?GLdouble,Y:?GLdouble,Z:?GLdouble,W:?GLdouble>>).

%% @spec (Target::enum(),Index::integer(),Params::{float()}) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glProgramLocalParameterARB.xml">external</a> documentation.
programLocalParameter4dvARB(Target,Index,{P1,P2,P3,P4}) ->
  wxe_util:cast(5577, <<Target:?GLenum,Index:?GLuint,P1:?GLdouble,P2:?GLdouble,P3:?GLdouble,P4:?GLdouble>>).

%% @spec (Target::enum(),Index::integer(),X::float(),Y::float(),Z::float(),W::float()) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glProgramLocalParameterARB.xml">external</a> documentation.
programLocalParameter4fARB(Target,Index,X,Y,Z,W) ->
  wxe_util:cast(5578, <<Target:?GLenum,Index:?GLuint,X:?GLfloat,Y:?GLfloat,Z:?GLfloat,W:?GLfloat>>).

%% @spec (Target::enum(),Index::integer(),Params::{float()}) -> ok
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glProgramLocalParameterARB.xml">external</a> documentation.
programLocalParameter4fvARB(Target,Index,{P1,P2,P3,P4}) ->
  wxe_util:cast(5579, <<Target:?GLenum,Index:?GLuint,P1:?GLfloat,P2:?GLfloat,P3:?GLfloat,P4:?GLfloat>>).
...
getProgramEnvParameterdvARB(Target,Index) ->
  wxe_util:call(5580, <<Target:?GLenum,Index:?GLuint>>).

%% @spec (Target::enum(),Index::integer()) -> {float()}
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glGetProgramEnvParameterARB.xml">external</a> documentation.
getProgramEnvParameterfvARB(Target,Index) ->
  wxe_util:call(5581, <<Target:?GLenum,Index:?GLuint>>).
...
getProgramLocalParameterdvARB(Target,Index) ->
  wxe_util:call(5582, <<Target:?GLenum,Index:?GLuint>>).

%% @spec (Target::enum(),Index::integer()) -> {float()}
%% @doc See <a href="http://www.opengl.org/sdk/docs/man/xhtml/glGetProgramLocalParameterARB.xml">external</a> documentation.
getProgramLocalParameterfvARB(Target,Index) ->
  wxe_util:call(5583, <<Target:?GLenum,Index:?GLuint>>).
...
detachObjectARB(ContainerObj,AttachedObj) ->
  wxe_util:cast(5587, <<ContainerObj:?GLhandleARB,AttachedObj:?GLhandleARB>>).
