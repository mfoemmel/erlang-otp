...
%% 
%% Created by Igor 2008-11-05, 12:46:22.
%% 
...
-export(['ansi-X9-62'/0, anyExtendedKeyUsage/0,
	 ...
	 dec_Curve/2, dec_DHPublicKey/2, dec_DSAPrivateKey/2,
	 ...
	 enc_Curve/2, enc_DHPublicKey/2, enc_DSAPrivateKey/2,
...
%% Generated by the Erlang ASN.1 BER_V2-compiler version, utilizing bit-syntax:1.6.2
...
%%<<< -asn1_info([{vsn, '1.6.2'}, {module, 'OTP-PUB-KEY'},
%%<<<             {options,
%%<<<              [ber_bin_v2, report_errors,
%%<<<               {cwd,
%%<<<                "/ldisk/daily_build/otp_prebuild_r12b.2008-11-"
%%<<<                "05_12/otp_src_R12B-5/lib/public_key/asn1"},
%%<<<               {outdir,
%%<<<                "/ldisk/daily_build/otp_prebuild_r12b.2008-11-"
%%<<<                "05_12/otp_src_R12B-5/lib/public_key/asn1"},
...
enc_ObjectDigestInfo(Val, TagIn) ->
    ...
    %%-------------------------------------------------
    {EncBytes1, EncLen1} = case case Cindex1 of
				  {_, _} -> element(2, Cindex1);
				  _ -> Cindex1
				end
			       of
...
decode_primitive_incomplete([[default, TagNo,
    ...
    case decode_tlv(Bin) of
      {{Form, TagNo, Len, V}, Rest} ->
	  decode_incomplete2(Form, TagNo, Len, V, Directives,
			     Rest);
      _ ->
	  %{asn1_DEFAULT,Bin}
	  asn1_NOVALUE
...
decode_primitive_incomplete([[alt, TagNo] | RestAlts],
			    Bin) ->
    case decode_tlv(Bin) of
      {{_Form, TagNo, _Len, V}, Rest} -> {{TagNo, V}, Rest};
      _ -> decode_primitive_incomplete(RestAlts, Bin)
    end;
...
decode_incomplete2(1, TagNo, indefinite, V, TagMatch,
		   _) ->
...
decode_incomplete2(1, TagNo, _Len, V, TagMatch, Rest) ->
    {{TagNo, decode_constructed_incomplete(TagMatch, V)},
     Rest};
decode_incomplete2(0, TagNo, _Len, V, _TagMatch,
		   Rest) ->
    {{TagNo, V}, Rest}.
