 ...
 *
 * Usage:
 * Compile his program in the same context as the ODBC c-program
...
main(int argc, char** argv)
{
  ...
  fprintf(fd, "%% This file is generated from convert_macros! %%%%\n\n");
  ...
  fprintf(fd, "-define(SQL_INTERVAL_YEAR_TO_MONTH, %ld).\n",
  ...
  fprintf(fd, "-define(SQL_INTERVAL_DAY_TO_HOUR, %ld).\n",
	  (long) SQL_INTERVAL_DAY_TO_HOUR);
  fprintf(fd, "-define(SQL_INTERVAL_DAY_TO_MINUTE, %ld).\n",
	  (long) SQL_INTERVAL_DAY_TO_MINUTE);
  fprintf(fd, "-define(SQL_INTERVAL_DAY_TO_SECOND, %ld).\n",
	  (long) SQL_INTERVAL_DAY_TO_SECOND);
  fprintf(fd, "-define(SQL_INTERVAL_HOUR_TO_MINUTE, %ld).\n",
	  (long) SQL_INTERVAL_HOUR_TO_MINUTE);
  fprintf(fd,"-define(SQL_INTERVAL_HOUR_TO_SECOND, %ld).\n",
	  (long) SQL_INTERVAL_HOUR_TO_SECOND);
  fprintf(fd, "-define(SQL_INTERVAL_MINUTE_TO_SECOND, %ld).\n",
  ...
  fprintf(fd, "-define(SQL_ATTR_ODBC_VERSION, %ld).\n",
  ...
  fprintf(fd, "-define(SQL_ATTR_ODBC_CURSORS, %ld).\n",
	  (long) SQL_ATTR_ODBC_CURSORS);
  fprintf(fd, "-define(SQL_CUR_USE_IF_NEEDED, %ld).\n",
  ...
  fprintf(fd,"-define(SQL_ATTR_TRANSLATE_LIB, %ld).\n",
	  (long) SQL_ATTR_TRANSLATE_LIB);
  fprintf(fd, "-define(SQL_ATTR_TRANSLATE_OPTION, %ld).\n",
  ...
  fprintf(fd, "-define(SQL_API_ODBC3_ALL_FUNCTIONS, %ld).\n",
	  (long) SQL_API_ODBC3_ALL_FUNCTIONS);
  fprintf(fd, "-define(SQL_API_ODBC3_ALL_FUNCTIONS_SIZE, %ld).\n",
	  (long) SQL_API_ODBC3_ALL_FUNCTIONS_SIZE);
  fprintf(fd, "-define(SQL_API_SQLALLOCHANDLE, %ld).\n",
  ...
  fprintf(fd, "-define(SQL_API_SQLCLOSECURSOR, %ld).\n",
	  (long) SQL_API_SQLCLOSECURSOR);
  fprintf(fd, "-define(SQL_API_SQLCOLATTRIBUTE, %ld).\n",
	  (long) SQL_API_SQLCOLATTRIBUTE);
  fprintf(fd, "-define(SQL_API_SQLCONNECT, %ld).\n", 
	  (long) SQL_API_SQLCONNECT);
  fprintf(fd, "-define(SQL_API_SQLDATASOURCES, %ld).\n",
	  (long) SQL_API_SQLDATASOURCES);
  fprintf(fd, "-define(SQL_API_SQLDESCRIBECOL, %ld).\n",
	  (long) SQL_API_SQLDESCRIBECOL);
  fprintf(fd, "-define(SQL_API_SQLDISCONNECT, %ld).\n",
  ...
  fprintf(fd, "-define(SQL_API_SQLGETDIAGREC, %ld).\n",
	  (long) SQL_API_SQLGETDIAGREC);
  fprintf(fd, "-define(SQL_API_SQLGETENVATTR, %ld).\n",
	  (long) SQL_API_SQLGETENVATTR);
  fprintf(fd, "-define(SQL_API_SQLGETFUNCTIONS, %ld).\n",
	  (long) SQL_API_SQLGETFUNCTIONS);
  fprintf(fd, "-define(SQL_API_SQLGETINFO, %ld).\n", 
	  (long) SQL_API_SQLGETINFO);
  fprintf(fd, "-define(SQL_API_SQLGETSTMTATTR, %ld).\n",
	  (long) SQL_API_SQLGETSTMTATTR);
  fprintf(fd, "-define(SQL_API_SQLGETTYPEINFO, %ld).\n",
	  (long) SQL_API_SQLGETTYPEINFO);
  fprintf(fd, "-define(SQL_API_SQLNUMRESULTCOLS, %ld).\n",
  ...
  fprintf(fd, "-define(SQL_API_SQLEXECDIRECT, %ld).\n",
  ...
  fprintf(fd, "-define(SQL_API_SQLFREEHANDLE, %ld).\n",
	  (long) SQL_API_SQLFREEHANDLE);
  fprintf(fd, "-define(SQL_API_SQLFREESTMT, %ld).\n", 
	  (long) SQL_API_SQLFREESTMT);
  fprintf(fd, "-define(SQL_API_SQLGETCONNECTATTR, %ld).\n",
	  (long) SQL_API_SQLGETCONNECTATTR);
  fprintf(fd, "-define(SQL_API_SQLGETCURSORNAME, %ld).\n",
	  (long) SQL_API_SQLGETCURSORNAME);
  fprintf(fd, "-define(SQL_API_SQLGETDATA, %ld).\n",
  ...
  fprintf(fd, "-define(SQL_API_SQLSETCONNECTATTR, %ld).\n",
	  (long) SQL_API_SQLSETCONNECTATTR);
  fprintf(fd, "-define(SQL_API_SQLSETCURSORNAME, %ld).\n",
	  (long) SQL_API_SQLSETCURSORNAME);
  fprintf(fd, "-define(SQL_API_SQLSETENVATTR, %ld).\n",
	  (long) SQL_API_SQLSETENVATTR);
  fprintf(fd, "-define(SQL_API_SQLSETSTMTATTR, %ld).\n",
	  (long) SQL_API_SQLSETSTMTATTR);
  fprintf(fd, "-define(SQL_API_SQLCOLUMNS, %ld).\n",
	  (long) SQL_API_SQLCOLUMNS);
  fprintf(fd, "-define(SQL_API_SQLSPECIALCOLUMNS, %ld).\n",
	  (long) SQL_API_SQLSPECIALCOLUMNS);
  fprintf(fd, "-define(SQL_API_SQLSTATISTICS, %ld).\n",
	  (long) SQL_API_SQLSTATISTICS);
  fprintf(fd, "-define(SQL_API_SQLTABLES, %ld).\n", (long) SQL_API_SQLTABLES);
  fprintf(fd, "-define(SQL_API_SQLBINDPARAMETER, %ld).\n",
	  (long) SQL_API_SQLBINDPARAMETER);
  fprintf(fd, "-define(SQL_API_SQLDRIVERCONNECT, %ld).\n",
  ...
  fprintf(fd, "-define(SQL_ACCESSIBLE_PROCEDURES, %ld).\n",
	  (long) SQL_ACCESSIBLE_PROCEDURES);

  fprintf(fd, "-define(SQL_ACCESSIBLE_TABLES, %ld).\n",
	  (long) SQL_ACCESSIBLE_TABLES);

  fprintf(fd, "-define(SQL_ACTIVE_ENVIRONMENTS, %ld).\n",
	  (long) SQL_ACTIVE_ENVIRONMENTS);

  fprintf(fd, "-define(SQL_AGGREGATE_FUNCTIONS, %ld).\n",
  ...
  fprintf(fd, "-define(SQL_AD_ADD_DOMAIN_CONSTRAINT, %ld).\n",
	  (long) SQL_AD_ADD_DOMAIN_CONSTRAINT);
  fprintf(fd, "-define(SQL_AD_ADD_DOMAIN_DEFAULT, %ld).\n",
	  (long) SQL_AD_ADD_DOMAIN_DEFAULT);
  fprintf(fd, "-define(SQL_AD_CONSTRAINT_NAME_DEFINITION, %ld).\n",
	  (long) SQL_AD_CONSTRAINT_NAME_DEFINITION);
  fprintf(fd, "-define(SQL_AD_DROP_DOMAIN_CONSTRAINT, %ld).\n",
	  (long) SQL_AD_DROP_DOMAIN_CONSTRAINT);
  fprintf(fd, "-define(SQL_AD_DROP_DOMAIN_DEFAULT, %ld).\n",
	  (long) SQL_AD_DROP_DOMAIN_DEFAULT);
  fprintf(fd, "-define(SQL_AD_ADD_CONSTRAINT_DEFERRABLE, %ld).\n",
	  (long) SQL_AD_ADD_CONSTRAINT_DEFERRABLE);
  fprintf(fd, "-define(SQL_AD_ADD_CONSTRAINT_NON_DEFERRABLE, %ld).\n",
	  (long) SQL_AD_ADD_CONSTRAINT_NON_DEFERRABLE);
  fprintf(fd, "-define(SQL_AD_ADD_CONSTRAINT_INITIALLY_DEFERRED, %ld).\n",
	  (long) SQL_AD_ADD_CONSTRAINT_INITIALLY_DEFERRED);
  fprintf(fd, "-define(SQL_AD_ADD_CONSTRAINT_INITIALLY_IMMEDIATE, %ld).\n",
	  (long) SQL_AD_ADD_CONSTRAINT_INITIALLY_IMMEDIATE);

  fprintf(fd, "-define(SQL_ALTER_TABLE, %ld).\n", (long) SQL_ALTER_TABLE);
  fprintf(fd, "-define(SQL_AT_ADD_COLUMN_COLLATION, %ld).\n",
	  (long) SQL_AT_ADD_COLUMN_COLLATION);
  fprintf(fd, "-define(SQL_AT_ADD_COLUMN_DEFAULT, %ld).\n",
	  (long) SQL_AT_ADD_COLUMN_DEFAULT);
  fprintf(fd, "-define(SQL_AT_ADD_COLUMN_SINGLE, %ld).\n",
	  (long) SQL_AT_ADD_COLUMN_SINGLE);
  fprintf(fd, "-define(SQL_AT_ADD_CONSTRAINT, %ld).\n",
	  (long) SQL_AT_ADD_CONSTRAINT);
  fprintf(fd, "-define(SQL_AT_ADD_TABLE_CONSTRAINT, %ld).\n",
	  (long) SQL_AT_ADD_TABLE_CONSTRAINT);
  fprintf(fd, "-define(SQL_AT_CONSTRAINT_NAME_DEFINITION, %ld).\n",
  ...
  fprintf(fd, "-define(SQL_BS_SELECT_EXPLICIT, %ld).\n",
	  (long) SQL_BS_SELECT_EXPLICIT);
  fprintf(fd, "-define(SQL_BS_ROW_COUNT_EXPLICIT, %ld).\n",
	  (long) SQL_BS_ROW_COUNT_EXPLICIT);
  fprintf(fd, "-define(SQL_BS_SELECT_PROC, %ld).\n",
	  (long) SQL_BS_SELECT_PROC);
  fprintf(fd, "-define(SQL_BS_ROW_COUNT_PROC, %ld).\n",
	  (long) SQL_BS_ROW_COUNT_PROC);

  fprintf(fd, "-define(SQL_BOOKMARK_PERSISTENCE, %ld).\n",
  ...
  fprintf(fd, "-define(SQL_CATALOG_NAME_SEPARATOR, %ld).\n",
  ...
  fprintf(fd, "-define(SQL_CU_DML_STATEMENTS, %ld).\n",
	  (long) SQL_CU_DML_STATEMENTS);
  fprintf(fd, "-define(SQL_CU_PROCEDURE_INVOCATION, %ld).\n",
	  (long) SQL_CU_PROCEDURE_INVOCATION);
  fprintf(fd, "-define(SQL_CU_TABLE_DEFINITION, %ld).\n",
	  (long) SQL_CU_TABLE_DEFINITION);
  fprintf(fd, "-define(SQL_CU_INDEX_DEFINITION, %ld).\n",
	  (long) SQL_CU_INDEX_DEFINITION);
  fprintf(fd, "-define(SQL_CU_PRIVILEGE_DEFINITION, %ld).\n",
  ...
  fprintf(fd, "-define(SQL_CONCAT_NULL_BEHAVIOR, %ld).\n",
  ...
  fprintf(fd, "-define(SQL_CONVERT_INTERVAL_YEAR_MONTH, %ld).\n",
	  (long) SQL_CONVERT_INTERVAL_YEAR_MONTH);
  fprintf(fd, "-define(SQL_CONVERT_INTERVAL_DAY_TIME, %ld).\n",
	  (long) SQL_CONVERT_INTERVAL_DAY_TIME);
  fprintf(fd, "-define(SQL_CONVERT_LONGVARBINARY, %ld).\n",
	  (long) SQL_CONVERT_LONGVARBINARY);
  fprintf(fd, "-define(SQL_CONVERT_LONGVARCHAR, %ld).\n",
  ...
  fprintf(fd, "-define(SQL_CVT_INTERVAL_YEAR_MONTH, %ld).\n",
	  (long) SQL_CVT_INTERVAL_YEAR_MONTH);
  fprintf(fd, "-define(SQL_CVT_INTERVAL_DAY_TIME, %ld).\n",
	  (long) SQL_CVT_INTERVAL_DAY_TIME);
  fprintf(fd, "-define(SQL_CVT_LONGVARBINARY, %ld).\n",
  ...
  fprintf(fd, "-define(SQL_CONVERT_FUNCTIONS, %ld).\n",
  ...
  fprintf(fd, "-define(SQL_CA_CREATE_ASSERTION, %ld).\n",
	  (long) SQL_CA_CREATE_ASSERTION);
  fprintf(fd, "-define(SQL_CA_CONSTRAINT_INITIALLY_DEFERRED, %ld).\n",
	  (long) SQL_CA_CONSTRAINT_INITIALLY_DEFERRED);
  fprintf(fd, "-define(SQL_CA_CONSTRAINT_INITIALLY_IMMEDIATE, %ld).\n",
	  (long) SQL_CA_CONSTRAINT_INITIALLY_IMMEDIATE);
  fprintf(fd, "-define(SQL_CA_CONSTRAINT_DEFERRABLE, %ld).\n",
	  (long) SQL_CA_CONSTRAINT_DEFERRABLE);
  fprintf(fd, "-define(SQL_CA_CONSTRAINT_NON_DEFERRABLE, %ld).\n",
	  (long) SQL_CA_CONSTRAINT_NON_DEFERRABLE);

  fprintf(fd, "-define(SQL_CREATE_CHARACTER_SET, %ld).\n",
	  (long) SQL_CREATE_CHARACTER_SET);
  fprintf(fd, "-define(SQL_CCS_CREATE_CHARACTER_SET, %ld).\n",
	  (long) SQL_CCS_CREATE_CHARACTER_SET);
  fprintf(fd, "-define(SQL_CCS_COLLATE_CLAUSE, %ld).\n",
	  (long) SQL_CCS_COLLATE_CLAUSE);
  fprintf(fd, "-define(SQL_CCS_LIMITED_COLLATION, %ld).\n",
	  (long) SQL_CCS_LIMITED_COLLATION);

  fprintf(fd, "-define(SQL_CREATE_COLLATION, %ld).\n", 
	  (long) SQL_CREATE_COLLATION);
  fprintf(fd, "-define(SQL_CCOL_CREATE_COLLATION, %ld).\n",
	  (long) SQL_CCOL_CREATE_COLLATION);

  fprintf(fd, "-define(SQL_CREATE_DOMAIN, %ld).\n", (long) SQL_CREATE_DOMAIN);
  fprintf(fd, "-define(SQL_CDO_CREATE_DOMAIN, %ld).\n",
	  (long) SQL_CDO_CREATE_DOMAIN);
  fprintf(fd, "-define(SQL_CDO_CONSTRAINT_NAME_DEFINITION, %ld).\n",
  ...
  fprintf(fd, "-define(SQL_CDO_CONSTRAINT_INITIALLY_DEFERRED, %ld).\n",
	  (long) SQL_CDO_CONSTRAINT_INITIALLY_DEFERRED);
  fprintf(fd, "-define(SQL_CDO_CONSTRAINT_INITIALLY_IMMEDIATE, %ld).\n",
	  (long) SQL_CDO_CONSTRAINT_INITIALLY_IMMEDIATE);
  fprintf(fd, "-define(SQL_CDO_CONSTRAINT_DEFERRABLE, %ld).\n",
	  (long) SQL_CDO_CONSTRAINT_DEFERRABLE);
  fprintf(fd, "-define(SQL_CDO_CONSTRAINT_NON_DEFERRABLE, %ld).\n",
  ...
  fprintf(fd,"-define(SQL_CS_DEFAULT_CHARACTER_SET, %ld).\n",
  ...
  fprintf(fd, "-define(SQL_CT_TABLE_CONSTRAINT, %ld).\n",
	  (long) SQL_CT_TABLE_CONSTRAINT);
  fprintf(fd, "-define(SQL_CT_CONSTRAINT_NAME_DEFINITION, %ld).\n",
	  (long) SQL_CT_CONSTRAINT_NAME_DEFINITION);
  fprintf(fd, "-define(SQL_CT_COMMIT_PRESERVE, %ld).\n",
	  (long) SQL_CT_COMMIT_PRESERVE);
  fprintf(fd, "-define(SQL_CT_COMMIT_DELETE, %ld).\n", 
	  (long) SQL_CT_COMMIT_DELETE);
  fprintf(fd, "-define(SQL_CT_GLOBAL_TEMPORARY, %ld).\n",
	  (long) SQL_CT_GLOBAL_TEMPORARY);
  fprintf(fd, "-define(SQL_CT_LOCAL_TEMPORARY, %ld).\n",
	  (long) SQL_CT_LOCAL_TEMPORARY);
  fprintf(fd, "-define(SQL_CT_COLUMN_CONSTRAINT, %ld).\n",
	  (long) SQL_CT_COLUMN_CONSTRAINT);
  fprintf(fd, "-define(SQL_CT_COLUMN_DEFAULT, %ld).\n",
	  (long) SQL_CT_COLUMN_DEFAULT);
  fprintf(fd, "-define(SQL_CT_COLUMN_COLLATION, %ld).\n",
	  (long) SQL_CT_COLUMN_COLLATION);
  fprintf(fd, "-define(SQL_CT_CONSTRAINT_INITIALLY_DEFERRED, %ld).\n",
	  (long) SQL_CT_CONSTRAINT_INITIALLY_DEFERRED);
  fprintf(fd, "-define(SQL_CT_CONSTRAINT_INITIALLY_IMMEDIATE, %ld).\n",
	  (long) SQL_CT_CONSTRAINT_INITIALLY_IMMEDIATE);
  fprintf(fd, "-define(SQL_CT_CONSTRAINT_DEFERRABLE, %ld).\n",
	  (long) SQL_CT_CONSTRAINT_DEFERRABLE);
  fprintf(fd, "-define(SQL_CT_CONSTRAINT_NON_DEFERRABLE, %ld).\n",
	  (long) SQL_CT_CONSTRAINT_NON_DEFERRABLE);

  fprintf(fd, "-define(SQL_CREATE_TRANSLATION, %ld).\n",
	  (long) SQL_CREATE_TRANSLATION);
  fprintf(fd, "-define(SQL_CTR_CREATE_TRANSLATION, %ld).\n",
  ...
  fprintf(fd, "-define(SQL_CURSOR_COMMIT_BEHAVIOR, %ld).\n",
	  (long) SQL_CURSOR_COMMIT_BEHAVIOR);
  fprintf(fd, "-define(SQL_CURSOR_ROLLBACK_BEHAVIOR, %ld).\n",
  ...
  fprintf(fd, "-define(SQL_CURSOR_SENSITIVITY, %ld).\n",
  ...
  fprintf(fd, "-define(SQL_DATA_SOURCE_READ_ONLY, %ld).\n",
	  (long) SQL_DATA_SOURCE_READ_ONLY);

  fprintf(fd, "-define(SQL_DATABASE_NAME, %ld).\n", (long) SQL_DATABASE_NAME);

  fprintf(fd, "-define(SQL_DATETIME_LITERALS, %ld).\n",
	  (long) SQL_DATETIME_LITERALS);
  fprintf(fd, "-define(SQL_DL_SQL92_TIME, %ld).\n",
	  (long) SQL_DL_SQL92_TIME);
  fprintf(fd, "-define(SQL_DL_SQL92_TIMESTAMP, %ld).\n",
	  (long) SQL_DL_SQL92_TIMESTAMP);
  fprintf(fd, "-define(SQL_DL_SQL92_INTERVAL_YEAR, %ld).\n",
	  (long) SQL_DL_SQL92_INTERVAL_YEAR);
  fprintf(fd, "-define(SQL_DL_SQL92_INTERVAL_MONTH, %ld).\n",
	  (long) SQL_DL_SQL92_INTERVAL_MONTH);
  fprintf(fd, "-define(SQL_DL_SQL92_INTERVAL_DAY, %ld).\n",
	  (long) SQL_DL_SQL92_INTERVAL_DAY);
  fprintf(fd, "-define(SQL_DL_SQL92_INTERVAL_HOUR, %ld).\n",
	  (long) SQL_DL_SQL92_INTERVAL_HOUR);
  fprintf(fd, "-define(SQL_DL_SQL92_INTERVAL_MINUTE, %ld).\n",
	  (long) SQL_DL_SQL92_INTERVAL_MINUTE);
  fprintf(fd, "-define(SQL_DL_SQL92_INTERVAL_SECOND, %ld).\n",
	  (long) SQL_DL_SQL92_INTERVAL_SECOND);
  fprintf(fd, "-define(SQL_DL_SQL92_INTERVAL_YEAR_TO_MONTH, %ld).\n",
	  (long) SQL_DL_SQL92_INTERVAL_YEAR_TO_MONTH);
  fprintf(fd, "-define(SQL_DL_SQL92_INTERVAL_DAY_TO_HOUR, %ld).\n",
	  (long) SQL_DL_SQL92_INTERVAL_DAY_TO_HOUR);
  fprintf(fd, "-define(SQL_DL_SQL92_INTERVAL_DAY_TO_MINUTE, %ld).\n",
	  (long) SQL_DL_SQL92_INTERVAL_DAY_TO_MINUTE);
  fprintf(fd, "-define(SQL_DL_SQL92_INTERVAL_DAY_TO_SECOND, %ld).\n",
	  (long) SQL_DL_SQL92_INTERVAL_DAY_TO_SECOND);
  fprintf(fd, "-define(SQL_DL_SQL92_INTERVAL_HOUR_TO_MINUTE, %ld).\n",
	  (long) SQL_DL_SQL92_INTERVAL_HOUR_TO_MINUTE);
  fprintf(fd, "-define(SQL_DL_SQL92_INTERVAL_HOUR_TO_SECOND, %ld).\n",
	  (long) SQL_DL_SQL92_INTERVAL_HOUR_TO_SECOND);
  fprintf(fd, "-define(SQL_DL_SQL92_INTERVAL_MINUTE_TO_SECOND, %ld).\n",
  ...
  fprintf(fd, "-define(SQL_DEFAULT_TXN_ISOLATION, %ld).\n",
	  (long) SQL_DEFAULT_TXN_ISOLATION);
  fprintf(fd, "-define(SQL_TXN_ISOLATION_OPTION, %ld).\n",
	  (long) SQL_TXN_ISOLATION_OPTION);
  fprintf(fd, "-define(SQL_TXN_READ_UNCOMMITTED, %ld).\n",
	  (long) SQL_TXN_READ_UNCOMMITTED);
  fprintf(fd, "-define(SQL_TXN_READ_COMMITTED, %ld).\n",
	  (long) SQL_TXN_READ_COMMITTED);
  fprintf(fd, "-define(SQL_TXN_REPEATABLE_READ, %ld).\n",
	  (long) SQL_TXN_REPEATABLE_READ);
  fprintf(fd, "-define(SQL_TXN_SERIALIZABLE, %ld).\n", 
	  (long) SQL_TXN_SERIALIZABLE);

  fprintf(fd, "-define(SQL_DESCRIBE_PARAMETER, %ld).\n",
  ...
  fprintf(fd, "-define(SQL_DA_DROP_ASSERTION, %ld).\n",
	  (long) SQL_DA_DROP_ASSERTION);

  fprintf(fd, "-define(SQL_DROP_CHARACTER_SET, %ld).\n",
	  (long) SQL_DROP_CHARACTER_SET);
  fprintf(fd, "-define(SQL_DCS_DROP_CHARACTER_SET, %ld).\n",
	  (long) SQL_DCS_DROP_CHARACTER_SET);

  fprintf(fd, "-define(SQL_DROP_COLLATION, %ld).\n", 
	  (long) SQL_DROP_COLLATION);
  fprintf(fd, "-define(SQL_DC_DROP_COLLATION, %ld).\n",
  ...
  fprintf(fd, "-define(SQL_DTR_DROP_TRANSLATION, %ld).\n",
  ...
  fprintf(fd, "-define(SQL_DYNAMIC_CURSOR_ATTRIBUTES1, %ld).\n",
	  (long) SQL_DYNAMIC_CURSOR_ATTRIBUTES1);
  fprintf(fd, "-define(SQL_FORWARD_ONLY_CURSOR_ATTRIBUTES1, %ld).\n",
	  (long) SQL_FORWARD_ONLY_CURSOR_ATTRIBUTES1);
  fprintf(fd, "-define(SQL_KEYSET_CURSOR_ATTRIBUTES1, %ld).\n",
	  (long) SQL_KEYSET_CURSOR_ATTRIBUTES1);
  fprintf(fd, "-define(SQL_STATIC_CURSOR_ATTRIBUTES1, %ld).\n",
  ...
  fprintf(fd, "-define(SQL_CA1_LOCK_EXCLUSIVE, %ld).\n",
	  (long) SQL_CA1_LOCK_EXCLUSIVE);
  fprintf(fd, "-define(SQL_CA1_LOCK_NO_CHANGE, %ld).\n",
  ...
  fprintf(fd, "-define(SQL_CA1_POSITIONED_UPDATE, %ld).\n", 
	  (long) SQL_CA1_POSITIONED_UPDATE);
  fprintf(fd, "-define(SQL_CA1_POSITIONED_DELETE, %ld).\n",
	  (long) SQL_CA1_POSITIONED_DELETE);
  fprintf(fd, "-define(SQL_CA1_SELECT_FOR_UPDATE, %ld).\n",
	  (long) SQL_CA1_SELECT_FOR_UPDATE);
  fprintf(fd, "-define(SQL_CA1_BULK_ADD, %ld).\n", (long) SQL_CA1_BULK_ADD);
  fprintf(fd, "-define(SQL_CA1_BULK_UPDATE_BY_BOOKMARK, %ld).\n",
	  (long) SQL_CA1_BULK_UPDATE_BY_BOOKMARK);
  fprintf(fd, "-define(SQL_CA1_BULK_DELETE_BY_BOOKMARK, %ld).\n",
	  (long) SQL_CA1_BULK_DELETE_BY_BOOKMARK);
  fprintf(fd, "-define(SQL_CA1_BULK_FETCH_BY_BOOKMARK, %ld).\n",
	  (long) SQL_CA1_BULK_FETCH_BY_BOOKMARK);

  fprintf(fd, "-define(SQL_DYNAMIC_CURSOR_ATTRIBUTES2, %ld).\n",
	  (long) SQL_DYNAMIC_CURSOR_ATTRIBUTES2);
  fprintf(fd, "-define(SQL_FORWARD_ONLY_CURSOR_ATTRIBUTES2, %ld).\n",
	  (long) SQL_FORWARD_ONLY_CURSOR_ATTRIBUTES2);
  fprintf(fd, "-define(SQL_KEYSET_CURSOR_ATTRIBUTES2, %ld).\n",
	  (long) SQL_KEYSET_CURSOR_ATTRIBUTES2);
  fprintf(fd, "-define(SQL_STATIC_CURSOR_ATTRIBUTES2, %ld).\n",
	  (long) SQL_STATIC_CURSOR_ATTRIBUTES2);
  fprintf(fd, "-define(SQL_CA2_READ_ONLY_CONCURRENCY, %ld).\n",
	  (long) SQL_CA2_READ_ONLY_CONCURRENCY);
  fprintf(fd, "-define(SQL_CA2_LOCK_CONCURRENCY, %ld).\n",
	  (long) SQL_CA2_LOCK_CONCURRENCY);
  fprintf(fd, "-define(SQL_CA2_OPT_ROWVER_CONCURRENCY, %ld).\n",
	  (long) SQL_CA2_OPT_ROWVER_CONCURRENCY);
  fprintf(fd, "-define(SQL_CA2_OPT_VALUES_CONCURRENCY, %ld).\n",
	  (long) SQL_CA2_OPT_VALUES_CONCURRENCY);
  fprintf(fd, "-define(SQL_CA2_SENSITIVITY_ADDITIONS, %ld).\n",
	  (long) SQL_CA2_SENSITIVITY_ADDITIONS);
  fprintf(fd, "-define(SQL_CA2_SENSITIVITY_DELETIONS, %ld).\n",
	  (long) SQL_CA2_SENSITIVITY_DELETIONS);
  fprintf(fd,"-define(SQL_CA2_SENSITIVITY_UPDATES, %ld).\n",
	  (long) SQL_CA2_SENSITIVITY_UPDATES);
  fprintf(fd, "-define(SQL_CA2_MAX_ROWS_SELECT, %ld).\n",
	  (long) SQL_CA2_MAX_ROWS_SELECT);
  fprintf(fd, "-define(SQL_CA2_MAX_ROWS_INSERT, %ld).\n",
	  (long) SQL_CA2_MAX_ROWS_INSERT);
  fprintf(fd, "-define(SQL_CA2_MAX_ROWS_DELETE, %ld).\n",
	  (long) SQL_CA2_MAX_ROWS_DELETE);
  fprintf(fd, "-define(SQL_CA2_MAX_ROWS_UPDATE, %ld).\n",
	  (long) SQL_CA2_MAX_ROWS_UPDATE);
  fprintf(fd, "-define(SQL_CA2_MAX_ROWS_CATALOG, %ld).\n",
	  (long) SQL_CA2_MAX_ROWS_CATALOG);
  fprintf(fd, "-define(SQL_CA2_MAX_ROWS_AFFECTS_ALL, %ld).\n",
	  (long) SQL_CA2_MAX_ROWS_AFFECTS_ALL);
  fprintf(fd, "-define(SQL_CA2_CRC_EXACT, %ld).\n", (long) SQL_CA2_CRC_EXACT);
  fprintf(fd, "-define(SQL_CA2_CRC_APPROXIMATE, %ld).\n",
	  (long) SQL_CA2_CRC_APPROXIMATE);
  fprintf(fd, "-define(SQL_CA2_SIMULATE_NON_UNIQUE, %ld).\n",
	  (long) SQL_CA2_SIMULATE_NON_UNIQUE);
  fprintf(fd, "-define(SQL_CA2_SIMULATE_TRY_UNIQUE, %ld).\n",
	  (long) SQL_CA2_SIMULATE_TRY_UNIQUE);
  fprintf(fd, "-define(SQL_CA2_SIMULATE_UNIQUE, %ld).\n",
	  (long) SQL_CA2_SIMULATE_UNIQUE);

  fprintf(fd, "-define(SQL_EXPRESSIONS_IN_ORDERBY, %ld).\n",
	  (long) SQL_EXPRESSIONS_IN_ORDERBY);

  fprintf(fd, "-define(SQL_FILE_USAGE, %ld).\n", (long) SQL_FILE_USAGE);
  fprintf(fd, "-define(SQL_FILE_NOT_SUPPORTED, %ld).\n",
	  (long) SQL_FILE_NOT_SUPPORTED);
  fprintf(fd, "-define(SQL_FILE_TABLE, %ld).\n", (long) SQL_FILE_TABLE);
  fprintf(fd, "-define(SQL_FILE_CATALOG, %ld).\n", (long) SQL_FILE_CATALOG);

  fprintf(fd, "-define(SQL_GETDATA_EXTENSIONS, %ld).\n",
  ...
  fprintf(fd, "-define(SQL_GB_GROUP_BY_EQUALS_SELECT, %ld).\n",
	  (long) SQL_GB_GROUP_BY_EQUALS_SELECT);
  fprintf(fd, "-define(SQL_GB_GROUP_BY_CONTAINS_SELECT, %ld).\n",
  ...
  fprintf(fd, "-define(SQL_QUOTED_IDENTIFIER_CASE, %ld).\n",
  ...
  fprintf(fd, "-define(SQL_IDENTIFIER_QUOTE_CHAR, %ld).\n",
  ...
  fprintf(fd, "-define(SQL_IS_INSERT_LITERALS, %ld).\n",
	  (long) SQL_IS_INSERT_LITERALS);
  fprintf(fd, "-define(SQL_IS_INSERT_SEARCHED, %ld).\n",
  ...
  fprintf(fd, "-define(SQL_LIKE_ESCAPE_CLAUSE, %ld).\n",
	  (long) SQL_LIKE_ESCAPE_CLAUSE);

  fprintf(fd, "-define(SQL_MAX_ASYNC_CONCURRENT_STATEMENTS, %ld).\n",
	  (long) SQL_MAX_ASYNC_CONCURRENT_STATEMENTS);

  fprintf(fd, "-define(SQL_MAX_BINARY_LITERAL_LEN, %ld).\n",
	  (long) SQL_MAX_BINARY_LITERAL_LEN);

  fprintf(fd, "-define(SQL_MAX_CATALOG_NAME_LEN, %ld).\n",
	  (long) SQL_MAX_CATALOG_NAME_LEN);

  fprintf(fd, "-define(SQL_MAX_CHAR_LITERAL_LEN, %ld).\n",
	  (long) SQL_MAX_CHAR_LITERAL_LEN);

  fprintf(fd, "-define(SQL_MAX_COLUMN_NAME_LEN, %ld).\n",
	  (long) SQL_MAX_COLUMN_NAME_LEN);

  fprintf(fd, "-define(SQL_MAX_COLUMNS_IN_GROUP_BY, %ld).\n",
	  (long) SQL_MAX_COLUMNS_IN_GROUP_BY);

  fprintf(fd, "-define(SQL_MAX_COLUMNS_IN_INDEX, %ld).\n",
	  (long) SQL_MAX_COLUMNS_IN_INDEX);

  fprintf(fd, "-define(SQL_MAX_COLUMNS_IN_ORDER_BY, %ld).\n",
	  (long) SQL_MAX_COLUMNS_IN_ORDER_BY);

  fprintf(fd, "-define(SQL_MAX_COLUMNS_IN_SELECT, %ld).\n",
	  (long) SQL_MAX_COLUMNS_IN_SELECT);

  fprintf(fd, "-define(SQL_MAX_COLUMNS_IN_TABLE, %ld).\n",
	  (long) SQL_MAX_COLUMNS_IN_TABLE);

  fprintf(fd, "-define(SQL_MAX_CONCURRENT_ACTIVITIES, %ld).\n",
	  (long) SQL_MAX_CONCURRENT_ACTIVITIES);

  fprintf(fd, "-define(SQL_MAX_CURSOR_NAME_LEN, %ld).\n",
	  (long) SQL_MAX_CURSOR_NAME_LEN);

  fprintf(fd, "-define(SQL_MAX_DRIVER_CONNECTIONS, %ld).\n",
	  (long) SQL_MAX_DRIVER_CONNECTIONS);

  fprintf(fd, "-define(SQL_MAX_IDENTIFIER_LEN, %ld).\n",
	  (long) SQL_MAX_IDENTIFIER_LEN);

  fprintf(fd, "-define(SQL_MAX_INDEX_SIZE, %ld).\n", 
	  (long) SQL_MAX_INDEX_SIZE);
  fprintf(fd, "-define(SQL_MAX_PROCEDURE_NAME_LEN, %ld).\n",
	  (long) SQL_MAX_PROCEDURE_NAME_LEN);

  fprintf(fd, "-define(SQL_MAX_ROW_SIZE, %ld).\n", (long) SQL_MAX_ROW_SIZE);
  fprintf(fd, "-define(SQL_MAX_ROW_SIZE_INCLUDES_LONG, %ld).\n",
	  (long) SQL_MAX_ROW_SIZE_INCLUDES_LONG);

  fprintf(fd, "-define(SQL_MAX_SCHEMA_NAME_LEN, %ld).\n",
	  (long) SQL_MAX_SCHEMA_NAME_LEN);

  fprintf(fd, "-define(SQL_MAX_STATEMENT_LEN, %ld).\n",
	  (long) SQL_MAX_STATEMENT_LEN);

  fprintf(fd, "-define(SQL_MAX_TABLE_NAME_LEN, %ld).\n",
	  (long) SQL_MAX_TABLE_NAME_LEN);

  fprintf(fd, "-define(SQL_MAX_TABLES_IN_SELECT, %ld).\n",
	  (long) SQL_MAX_TABLES_IN_SELECT);

  fprintf(fd, "-define(SQL_MAX_USER_NAME_LEN, %ld).\n",
	  (long) SQL_MAX_USER_NAME_LEN);

  fprintf(fd, "-define(SQL_MULT_RESULT_SETS, %ld).\n", 
	  (long) SQL_MULT_RESULT_SETS);

  fprintf(fd, "-define(SQL_MULTIPLE_ACTIVE_TXN, %ld).\n",
	  (long) SQL_MULTIPLE_ACTIVE_TXN);

  fprintf(fd, "-define(SQL_NEED_LONG_DATA_LEN, %ld).\n",
	  (long) SQL_NEED_LONG_DATA_LEN);

  fprintf(fd, "-define(SQL_NON_NULLABLE_COLUMNS, %ld).\n",
  ...
  fprintf(fd, "-define(SQL_NUMERIC_FUNCTIONS, %ld).\n",
  ...
  fprintf(fd, "-define(SQL_ODBC_INTERFACE_CONFORMANCE, %ld).\n",
  ...
  fprintf(fd, "-define(SQL_OJ_ALL_COMPARISON_OPS, %ld).\n",
	  (long) SQL_OJ_ALL_COMPARISON_OPS);

  fprintf(fd, "-define(SQL_ORDER_BY_COLUMNS_IN_SELECT, %ld).\n",
	  (long) SQL_ORDER_BY_COLUMNS_IN_SELECT);

  fprintf(fd, "-define(SQL_OUTER_JOINS, %ld).\n", (long) SQL_OUTER_JOINS);

  fprintf(fd, "-define(SQL_PARAM_ARRAY_ROW_COUNTS, %ld).\n",
  ...
  fprintf(fd, "-define(SQL_PARAM_ARRAY_SELECTS, %ld).\n",
  ...
  fprintf(fd, "-define(SQL_SU_DML_STATEMENTS, %ld).\n",
	  (long) SQL_SU_DML_STATEMENTS);
  fprintf(fd, "-define(SQL_SU_PROCEDURE_INVOCATION, %ld).\n",
	  (long) SQL_SU_PROCEDURE_INVOCATION);
  fprintf(fd, "-define(SQL_SU_TABLE_DEFINITION, %ld).\n",
	  (long) SQL_SU_TABLE_DEFINITION);
  fprintf(fd, "-define(SQL_SU_INDEX_DEFINITION, %ld).\n",
	  (long) SQL_SU_INDEX_DEFINITION);
  fprintf(fd, "-define(SQL_SU_PRIVILEGE_DEFINITION, %ld).\n",
  ...
  fprintf(fd, "-define(SQL_SEARCH_PATTERN_ESCAPE, %ld).\n",
	  (long) SQL_SEARCH_PATTERN_ESCAPE);

  fprintf(fd, "-define(SQL_SERVER_NAME, %ld).\n", (long) SQL_SERVER_NAME);

  fprintf(fd, "-define(SQL_SPECIAL_CHARACTERS, %ld).\n",
  ...
  fprintf(fd, "-define(SQL_SC_FIPS127_2_TRANSITIONAL, %ld).\n",
	  (long) SQL_SC_FIPS127_2_TRANSITIONAL);
  fprintf(fd, "-define(SQL_SC_SQL92_FULL, %ld).\n", (long) SQL_SC_SQL92_FULL);
  fprintf(fd, "-define(SQL_SC_SQL92_INTERMEDIATE, %ld).\n",
	  (long) SQL_SC_SQL92_INTERMEDIATE);
  fprintf(fd, "-define(SQL_SQL92_DATETIME_FUNCTIONS, %ld).\n",
  ...
  fprintf(fd, "-define(SQL_SDF_CURRENT_TIMESTAMP, %ld).\n",
	  (long) SQL_SDF_CURRENT_TIMESTAMP);

  fprintf(fd, "-define(SQL_SQL92_FOREIGN_KEY_DELETE_RULE, %ld).\n",
  ...
  fprintf(fd, "-define(SQL_SQL92_FOREIGN_KEY_UPDATE_RULE, %ld).\n",
  ...
  fprintf(fd, "-define(SQL_SG_REFERENCES_TABLE, %ld).\n",
	  (long) SQL_SG_REFERENCES_TABLE);
  fprintf(fd, "-define(SQL_SG_REFERENCES_COLUMN, %ld).\n",
  ...
  fprintf(fd, "-define(SQL_SG_USAGE_ON_DOMAIN, %ld).\n",
	  (long) SQL_SG_USAGE_ON_DOMAIN);
  fprintf(fd, "-define(SQL_SG_USAGE_ON_CHARACTER_SET, %ld).\n",
	  (long) SQL_SG_USAGE_ON_CHARACTER_SET);
  fprintf(fd, "-define(SQL_SG_USAGE_ON_COLLATION, %ld).\n",
	  (long) SQL_SG_USAGE_ON_COLLATION);
  fprintf(fd, "-define(SQL_SG_USAGE_ON_TRANSLATION, %ld).\n",
	  (long) SQL_SG_USAGE_ON_TRANSLATION);
  fprintf(fd, "-define(SQL_SG_WITH_GRANT_OPTION, %ld).\n",
	  (long) SQL_SG_WITH_GRANT_OPTION);

  fprintf(fd, "-define(SQL_SQL92_NUMERIC_VALUE_FUNCTIONS, %ld).\n",
  ...
  fprintf(fd, "-define(SQL_SNVF_CHARACTER_LENGTH, %ld).\n",
	  (long) SQL_SNVF_CHARACTER_LENGTH);
  fprintf(fd, "-define(SQL_SNVF_EXTRACT, %ld).\n", (long) SQL_SNVF_EXTRACT);
  fprintf(fd, "-define(SQL_SNVF_OCTET_LENGTH, %ld).\n",
  ...
  fprintf(fd, "-define(SQL_SP_MATCH_UNIQUE_FULL, %ld).\n",
	  (long) SQL_SP_MATCH_UNIQUE_FULL);
  fprintf(fd, "-define(SQL_SP_MATCH_UNIQUE_PARTIAL, %ld).\n",
	  (long) SQL_SP_MATCH_UNIQUE_PARTIAL);
  fprintf(fd, "-define(SQL_SP_OVERLAPS, %ld).\n", (long) SQL_SP_OVERLAPS);
  fprintf(fd, "-define(SQL_SP_QUANTIFIED_COMPARISON, %ld).\n",
	  (long) SQL_SP_QUANTIFIED_COMPARISON);
  fprintf(fd, "-define(SQL_SP_UNIQUE, %ld).\n", (long) SQL_SP_UNIQUE);

  fprintf(fd, "-define(SQL_SQL92_RELATIONAL_JOIN_OPERATORS, %ld).\n",
	  (long) SQL_SQL92_RELATIONAL_JOIN_OPERATORS);
  fprintf(fd, "-define(SQL_SRJO_CORRESPONDING_CLAUSE, %ld).\n",
  ...
  fprintf(fd, "-define(SQL_SRJO_FULL_OUTER_JOIN, %ld).\n",
	  (long) SQL_SRJO_FULL_OUTER_JOIN);
  fprintf(fd, "-define(SQL_SRJO_INNER_JOIN, %ld).\n", 
	  (long) SQL_SRJO_INNER_JOIN);
  fprintf(fd, "-define(SQL_SRJO_INTERSECT_JOIN, %ld).\n",
	  (long) SQL_SRJO_INTERSECT_JOIN);
  fprintf(fd, "-define(SQL_SRJO_LEFT_OUTER_JOIN, %ld).\n",
	  (long) SQL_SRJO_LEFT_OUTER_JOIN);
  fprintf(fd, "-define(SQL_SRJO_NATURAL_JOIN, %ld).\n",
	  (long) SQL_SRJO_NATURAL_JOIN);
  fprintf(fd, "-define(SQL_SRJO_RIGHT_OUTER_JOIN, %ld).\n",
  ...
  fprintf(fd, "-define(SQL_SR_GRANT_OPTION_FOR, %ld).\n",
  ...
  fprintf(fd, "-define(SQL_SR_REFERENCES_COLUMN, %ld).\n",
	  (long) SQL_SR_REFERENCES_COLUMN);
  fprintf(fd, "-define(SQL_SR_REFERENCES_TABLE, %ld).\n",
  ...
  fprintf(fd, "-define(SQL_SR_USAGE_ON_DOMAIN, %ld).\n",
	  (long) SQL_SR_USAGE_ON_DOMAIN);
  fprintf(fd, "-define(SQL_SR_USAGE_ON_CHARACTER_SET, %ld).\n",
	  (long) SQL_SR_USAGE_ON_CHARACTER_SET);
  fprintf(fd, "-define(SQL_SR_USAGE_ON_COLLATION, %ld).\n",
	  (long) SQL_SR_USAGE_ON_COLLATION);
  fprintf(fd, "-define(SQL_SR_USAGE_ON_TRANSLATION, %ld).\n",
	  (long) SQL_SR_USAGE_ON_TRANSLATION);

  fprintf(fd, "-define(SQL_SQL92_ROW_VALUE_CONSTRUCTOR, %ld).\n",
	  (long) SQL_SQL92_ROW_VALUE_CONSTRUCTOR);
  fprintf(fd, "-define(SQL_SRVC_VALUE_EXPRESSION, %ld).\n",
  ...
  fprintf(fd, "-define(SQL_SRVC_ROW_SUBQUERY, %ld).\n",
	  (long) SQL_SRVC_ROW_SUBQUERY);

  fprintf(fd, "-define(SQL_SQL92_STRING_FUNCTIONS, %ld).\n",
  ...
  fprintf(fd, "-define(SQL_SSF_TRIM_TRAILING, %ld).\n",
	  (long) SQL_SSF_TRIM_TRAILING);

  fprintf(fd, "-define(SQL_SQL92_VALUE_EXPRESSIONS, %ld).\n",
  ...
  fprintf(fd, "-define(SQL_STANDARD_CLI_CONFORMANCE, %ld).\n",
	  (long) SQL_STANDARD_CLI_CONFORMANCE);
  fprintf(fd, "-define(SQL_SCC_XOPEN_CLI_VERSION1, %ld).\n",
	  (long) SQL_SCC_XOPEN_CLI_VERSION1);
  fprintf(fd, "-define(SQL_SCC_ISO92_CLI, %ld).\n",
  ...
  fprintf(fd, "-define(SQL_FN_STR_OCTET_LENGTH, %ld).\n",
  ...
  fprintf(fd, "-define(SQL_SQ_CORRELATED_SUBQUERIES, %ld).\n",
  ...
  fprintf(fd, "-define(SQL_TIMEDATE_ADD_INTERVALS, %ld).\n",
	  (long) SQL_TIMEDATE_ADD_INTERVALS);
  fprintf(fd, "-define(SQL_TIMEDATE_DIFF_INTERVALS, %ld).\n",
	  (long) SQL_TIMEDATE_DIFF_INTERVALS);
  fprintf(fd,  "-define(SQL_FN_TSI_FRAC_SECOND, %ld).\n",
  ...
  fprintf(fd, "-define(SQL_TIMEDATE_FUNCTIONS, %ld).\n",
	  (long) SQL_TIMEDATE_FUNCTIONS);
  fprintf(fd, "-define(SQL_FN_TD_CURRENT_DATE, %ld).\n",
	  (long) SQL_FN_TD_CURRENT_DATE);
  fprintf(fd, "-define(SQL_FN_TD_CURRENT_TIME, %ld).\n",
	  (long) SQL_FN_TD_CURRENT_TIME);
  fprintf(fd, "-define(SQL_FN_TD_CURRENT_TIMESTAMP, %ld).\n",
  ...
  fprintf(fd, "-define(SQL_FN_TD_TIMESTAMPADD, %ld).\n",
	  (long) SQL_FN_TD_TIMESTAMPADD);
  fprintf(fd, "-define(SQL_FN_TD_TIMESTAMPDIFF, %ld).\n",
  ...
  fprintf(fd, "-define(SQL_FETCH_FIRST_SYSTEM, %ld).\n",
  ...
  fprintf(fd, "-define(SQL_SCOPE_TRANSACTION, %ld).\n",
