...
__declspec(dllexport) int __cdecl CoverageIsRunning(void) { return 0; }
__declspec(dllexport) int __cdecl CoverageDisableRecordingData(void) { return 0; }
__declspec(dllexport) int __cdecl CoverageStartRecordingData(void) { return 0; }
__declspec(dllexport) int __cdecl CoverageStopRecordingData(void) { return 0; }
__declspec(dllexport) int __cdecl CoverageClearData(void) { return 0; }
__declspec(dllexport) int __cdecl CoverageIsRecordingData(void) { return 0; }
__declspec(dllexport) int __cdecl CoverageAddAnnotation(char *str) { return 0; }
__declspec(dllexport) int __cdecl CoverageSaveData(void) { return 0; }
